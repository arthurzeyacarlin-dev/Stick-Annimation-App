...
D-0094 creates [`SPEC-0009 — Animation Export`](specs/0009-animation-export.md) as a separate **Proposed** three-phase local product plan: Choose and Watch; Create and Save Video; Social Destinations and Final Testing. GIT-074 publishes that exact planning package in `30f6f85e5c483c9df15946e7a451bf2a31374f2e`. It protects the accepted saved-project/V2 owner, preserves complete animation content/timing/audio, defaults to no-crop complete-animation framing, writes locally through a Finder flow, and adds no AI/provider/social-account behavior. No SPEC-0009 implementation phase is approved or authorized.
...
- review Proposed SPEC-0009 independently; do not implement even its first phase without Arthur's explicit approval and separate authorization
