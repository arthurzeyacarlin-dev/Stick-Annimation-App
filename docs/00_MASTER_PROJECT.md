...
D-0074 rewrites [`SPEC-0007 — Drawing-Only Manual Editor Completion and AI-Ready Tools`](specs/0007-manual-editor-completion-and-ai-ready-tools.md) as **Approved and active**. GIT-062 closes corrected Phase 1, GIT-063 closes Phase 2 Draw Rig, and D-0079/D-0080/GIT-064 close Phase 3 Safe Legacy Rig Retirement and Migration. D-0081 records Arthur's acceptance and technical verification of Phase 4 Assets Stabilization from unchanged GIT-064 base; control-plane propagation is complete while separate publication/integration, proof preservation and D-0054 cleanup remain pending. Phase 5 remains unauthorized.
