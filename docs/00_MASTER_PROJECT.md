...
D-0137 creates [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](specs/0014-in-app-notification-center.md) from canonical `main`. Arthur subsequently established PM V5, authorized Phase 1 and accepted the fresh two-bell correction under D-0138. D-0139/GIT-099 fully publish, synchronize, preserve and clean up the exact 19-path Phase 1 result in 33-path commit `06365eacffe493ea3550de71b3baff0f57bf03b2`, with immutable manifest SHA-256 `b1c082c2508b3039fdeacdd65f99ded4a9d49ed7cec99eb9aaff8352be143669`. Home owns the all-event bell, Assistant owns an Assistant-reply-only bell, and no other screen has one. D-0140 records Arthur's acceptance of the corrected Phase 2 Assistant/Terra observer and unread-only navigation result; its 21-path technical proof is bound to manifest SHA-256 `77bc08b62c472d9ed0f75a2cd6b7d9b4b84d3f9b2e75d89645738567904ae8e7`. GIT-100 fully publishes, synchronizes, proof-preserves and cleans up Phase 2 in exact 36-path commit `318566d6d20acec672c3d8c6a0e5620ad70c7d66`. D-0141 records Arthur's later rejection of the separate Phase 3 Export notification review copy as low-value; its technical PASS is not acceptance and no rejected runtime enters main. The two shipped bells and Assistant/Terra notifications stay. Phase 4 offline/reliability is the next candidate after D-0141 publication, rejected-copy cleanup and separate authorization; low-usage and updater notices remain dormant future work.
...
- preserve D-0138/D-0139/GIT-099's fully closed SPEC-0014 Phase 1 two-bell foundation and D-0140/GIT-100's fully published, synchronized, proof-preserved and cleaned Phase 2 correction; honor D-0141's Phase 3 Export rejection and do not start Phase 4 before its separate gates
