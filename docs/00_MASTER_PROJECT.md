...
D-0120 creates [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md) from Arthur's accepted product direction. GIT-089 `f2bda338…` publishes that plan; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125/D-0126/GIT-092 close Phase 4 hosted search and corrupt-row recovery. D-0127–D-0128/GIT-093 close the terminal/source correction. D-0129 accepts the final citation-recovery/reply-reveal correction: provider-consulted source metadata recovers a clean cited answer when native annotations are absent, while every newly completed answer uses the existing fast typewriter/blue-gradient reveal without replaying saved history. GIT-094 publication is authorized and pending. Phase 5 remains Unauthorized/Not started. Dictation, public beta and deployment remain gated.
