...
D-0137 creates [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](specs/0014-in-app-notification-center.md) from canonical `main`. Arthur subsequently established PM V5, authorized Phase 1 and accepted the fresh two-bell correction under D-0138. The exact 19-path Phase 1 result from base `a5ca805b220357b5e8128bb6b76ea408e30fa790` is technically Verified at immutable manifest SHA-256 `b1c082c2508b3039fdeacdd65f99ded4a9d49ed7cec99eb9aaff8352be143669`; control-plane propagation and GIT-099 publication are distinct pending closeout. Home owns the all-event bell, Assistant owns an Assistant-reply-only bell, and no other screen has one. This is a store/UI foundation with no connected production producer; actual Assistant/Terra alerts are Phase 2, Export Phase 3, and offline/reliability Phase 4. Phases 2–4 remain Unauthorized/Not started.
...
- preserve D-0138's accepted SPEC-0014 Phase 1 two-bell foundation, close GIT-099 only under exact checked publication/proof/cleanup conditions, and do not begin Phase 2 without a separate Arthur authorization from the synchronized Phase 1 main SHA
