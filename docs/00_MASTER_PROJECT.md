...
D-0102 defines [`SPEC-0010 — Project Safety and Recovery`](specs/0010-project-safety-and-recovery.md) as the next beta-readiness foundation: Save and Exit; one separate local latest emergency recovery draft; and startup Recover Work / Discard Draft with final fault/regression proof. GIT-080 publishes the plan. D-0105/GIT-081 `44cdafc534d7ef096cd2e283532a956c4eaa91f6` close Phase 1. D-0106/D-0107/GIT-082 `7e7063eaab3c486278355559c490611e3ca590ea` close Phase 2. D-0108 accepts and technically verifies Phase 3's startup gate, exact-generation single-winner recovery, detached-copy protection, confirmed discard and final regression proof; publication/integration is the authorized next closeout step.
...
- preserve closed SPEC-0010 Phases 1–2 through D-0107/GIT-082 and the accepted, technically Verified Phase 3 result under D-0108 while its authorized publication/integration closeout completes
