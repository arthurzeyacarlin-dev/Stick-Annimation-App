...
D-0120 creates [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md) from Arthur's accepted product direction. GIT-089 `f2bda338…` publishes that plan; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124 accepts combined Phase 2 after Arthur/PM moved first fixed-Terra local-catalog guidance forward from planned Phase 3: bounded local sessions, dedicated local-only route/job/provider, fixed `gpt-5.6-terra`, four reasoning levels, 50-chat/no-eviction storage, truthful activity/typewriter/cancel/recovery and hard zero project mutation are technically Verified. Arthur's final correction removes cumulative local daily/monthly Assistant reservations and their ledger/lock stop while retaining the `$0.15` per-request estimate and all token, timeout, concurrency, identity, cancel, usage, local-only, no-tools and `store:false` safeguards. Publication remains separate; search, dictation, deployment and Phases 4–6 remain gated.
...
- preserve SPEC-0012 planning/GIT-089 and fully closed Phase 1/D-0121–D-0123/GIT-090; preserve D-0124's accepted combined Phase 2/absorbed Phase 3 scope without publication overclaim; do not begin hosted search, transcription, deployment or Phase 4+ without separate authorization
