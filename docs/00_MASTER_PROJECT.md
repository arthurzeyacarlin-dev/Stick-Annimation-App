...
D-0137 creates approved planning-only [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](specs/0014-in-app-notification-center.md) from clean canonical `main` `acc3204d6c5aa08f1d0d714dcd5a64e8746dcb8d`. Its four separately gated phases cover the real local center and event store; Assistant/Terra completion and failure after navigation; Export completion and failure after navigation; and offline/reliability/concurrency/accessibility closure plus inactive future contracts. No phase is authorized. Before Phase 1, Arthur must create Project Manager Version 5 and the current PM must transition to AI Animator/Dad support.
...
- review and separately publish D-0137/SPEC-0014's docs-only four-phase notification plan; do not begin Phase 1 until Arthur creates Project Manager Version 5, the current PM transitions to AI Animator/Dad support, and Arthur separately authorizes Phase 1 from the published planning SHA
