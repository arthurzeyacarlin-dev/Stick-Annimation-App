...
D-0102 defines [`SPEC-0010 — Project Safety and Recovery`](specs/0010-project-safety-and-recovery.md) as the next beta-readiness foundation: Save and Exit; one separate local latest emergency recovery draft; and startup Recover Work / Discard Draft with final fault/regression proof. GIT-080 `cb80f2baf92f812c97ce758067f6ea28b3c6c187` publishes the plan. D-0104 accepts Phase 1 and D-0105 records its GIT-081 publication at `44cdafc534d7ef096cd2e283532a956c4eaa91f6`, proof preservation, cleanup and Arthur's later Phase 2 authorization. D-0106 accepts and technically verifies Phase 2's exact eleven-path emergency-recovery result; publication/integration/proof preservation/cleanup are authorized and pending. Phase 3 remains Unauthorized/Not started.
...
- preserve closed SPEC-0010 Phase 1 through D-0105/GIT-081; publish/close accepted Phase 2 under D-0106; keep Phase 3 unauthorized
