...
D-0120 creates [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md) from Arthur's accepted product direction. GIT-089 `f2bda338…` publishes that plan; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125–D-0130/GIT-092–094 close Phase 4 and its corrections. D-0131/GIT-095 `6de47a9d…` close Phase 5 microphone dictation. D-0133 accepts and technically verifies Phase 6 local/private-beta offline/recovery hardening; GIT-096 publication, proof preservation, cleanup and terminal SPEC-0012 closure remain pending. Public beta and deployment remain separately gated.
...
- preserve SPEC-0012 planning/GIT-089, fully closed Phase 1/D-0121–D-0123/GIT-090, combined Phase 2/D-0124/GIT-091, Phase 4 through D-0130/GIT-094, published Phase 5/D-0131/GIT-095, and accepted technically Verified Phase 6/D-0133 pending GIT-096 terminal closeout; do not deploy or expose a public beta without separate authority
