...
- preserve SPEC-0012 planning/GIT-089, fully closed Phase 1/D-0121–D-0123/GIT-090 and fully closed combined Phase 2/D-0124/GIT-091; preserve D-0125's accepted, technically Verified, control-plane-propagated Phase 4 result without publication overclaim; do not publish Phase 4, begin Phase 5 dictation, deploy, or expose a public beta without separate authority
