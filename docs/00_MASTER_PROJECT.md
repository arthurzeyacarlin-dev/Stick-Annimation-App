...
D-0102 defines [`SPEC-0010 — Project Safety and Recovery`](specs/0010-project-safety-and-recovery.md) as the next beta-readiness foundation: Save and Exit; one separate local latest emergency recovery draft; and startup Recover Work / Discard Draft with final fault/regression proof. GIT-080 publishes the plan. D-0105/GIT-081 `44cdafc534d7ef096cd2e283532a956c4eaa91f6` close Phase 1. D-0106 accepts Phase 2 and D-0107/GIT-082 `7e7063eaab3c486278355559c490611e3ca590ea` close its exact eleven-path emergency-recovery result with proof preservation and cleanup. Phase 3 is entry-ready but remains Unauthorized/Not started pending Arthur's separate authorization.
...
- preserve closed SPEC-0010 Phases 1–2 through D-0107/GIT-082; keep Phase 3 entry-ready but unauthorized
