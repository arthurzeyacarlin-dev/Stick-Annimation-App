...
D-0085 creates [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](specs/0008-conversational-ai-animator.md), and D-0086/GIT-067 publishes its exact planning-only package at `ba5ecd694df78414240ce83a9140c5196334ebdc`. D-0087 records Arthur's explicit approval of the complete six-phase specification and GIT-068 publishes its Phase 1-only authorization. Arthur rejected the first Phase 1 app after `hello` produced a generic animation failure without gradient Thinking. D-0088 preserves and cleans that non-reusable result, authorizes one fresh Phase 1 correction executor, and separately permits at most six short text-only live Terra requests with a hard $0.50 aggregate ceiling. Its bounded V1 sequence remains Terra conversation/intent/jobs → provider-neutral reference video → deterministic frame slicing → isolated editable drawing reconstruction → registered-command conversational edits → beta/export closeout. Phases 2–6, video providers, deployment and implementation publication remain unauthorized.
...
- execute Approved SPEC-0008 only through its separately authorized, accepted, recorded, published/integrated and cleaned phase lifecycle; Phase 1 alone is currently authorized
