...
D-0120 creates [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md) from Arthur's accepted six-phase product direction. GIT-089 `f2bda338…` publishes that plan. D-0121/D-0122 record Arthur's separately authorized and accepted Phase 1: the Home card now opens a dedicated responsive guidance shell with official branding, focus-restoring Back, bounded accessible desktop sidebar resize, compact layout and preview-only composer controls. The Assistant still has no animation/project mutation ownership and shares no AI Animator route/job/storage contract. Real sessions/guidance, hosted search, dictation, deployment and Phases 2–6 remain separately gated.
