...
D-0094 creates [`SPEC-0009 — Animation Export`](specs/0009-animation-export.md) as a separate three-phase local product plan: Choose and Watch; Create and Save Video; Social Destinations and Final Testing. GIT-074 publishes that planning package in `30f6f85e5c483c9df15946e7a451bf2a31374f2e`. D-0096 records Arthur's later approval, Phase 1 authorization and acceptance of the corrected Choose and Watch app copy. GIT-076 publishes and integrates the exact 12-path Phase 1 result plus reviewed records at `548063b9247708106c7c8c8a11978563d07d6597`; proof preservation and D-0054 cleanup are complete. D-0097 authorizes Phase 2 Create and Save Video with a project-owned background defaulting to white and local MP4/H.264/AAC assembly through Mediabunny. Phase 2 is Authorized/Not started; Phase 3 remains Unauthorized/Not started.
...
- preserve closed SPEC-0009 Phase 1 and execute only the separately authorized Phase 2 boundary from the synchronized authorization commit; Phase 3 remains separately gated
