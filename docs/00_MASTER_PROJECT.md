...
D-0120 creates [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md) from Arthur's accepted product direction. GIT-089 `f2bda338…` publishes that plan; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124 accepts combined Phase 2 after Arthur/PM moved fixed-Terra local-catalog guidance forward from planned Phase 3, and GIT-091 `fa2ef6c526d04de9c77b356b53b4768890c46e1f` publishes/integrates its exact 34 technical plus 15 reviewed record/tree paths. Its proof is preserved and its old review server/worktree are closed/removed. D-0125 accepts and technically verifies Phase 4 hosted search plus the corrupt-row recovery correction: deterministic local-catalog precedence, eligible current/external `web_search`, truthful Searching/Finalizing events, validated accessible citations, fixed limits/cost receipts, and hard zero project mutation. D-0126/GIT-092 `23816164592743a59d4cc3b83ffd0ac39844d654` publish/integrate the exact 42-path result, preserve proof, close the review server/worktree/branch, and activate the fresh provider in canonical main. Phase 5 is entry-ready but remains Unauthorized/Not started. Dictation, public beta and deployment remain gated.
...
- preserve SPEC-0012 planning/GIT-089, fully closed Phase 1/D-0121–D-0123/GIT-090, fully closed combined Phase 2/D-0124/GIT-091, and fully closed Phase 4/D-0125–D-0126/GIT-092; do not begin Phase 5 dictation, deploy, or expose a public beta without separate authority
