...
- preserve closed SPEC-0009 Phase 1 and the accepted/technically Verified unpublished Phase 2 result; publish/integrate/clean it only through the required later lifecycle, and keep Phase 3 separately gated
