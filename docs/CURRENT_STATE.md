...
Last verified: 2026-08-18 from exact clean canonical-main Phase 3 activation `45504214dffb528e930194b93fc2ab78dc730ebc`. The original SPEC-0001 Phase 2 bytes remain historically published/integrated in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, but Arthur rejected their visible product result. The accepted §10.5A correction is **Verified, published, and integrated** at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 remains the exact Phase 3 Stick onion-skin contract, D-0019 marks Phase 3 **Authorized; Not started**, and D-0020 accepts the exact tester-registration/Creator-preservation correction. This accepted record must be published/integrated before a replacement executor. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected; SPEC-0003 remains separate, Proposed, inactive, and untouched.
Current Git basis: exact clean canonical-main commit `45504214dffb528e930194b93fc2ab78dc730ebc`, message `Authorize SPEC-0001 Phase 3`, on `main`/`origin/main` at correction start. The accepted §10.5A product/proof bytes remain in its parent history at exact 29-path commit `edfb3dea023119b91336e6e5da645d4982a9f068`. This task changes accepted documentation/control-plane records only and makes no runtime/test/proof/Git publication change.
...
The stopped Phase 3 Spec Executor completed the required boot/live trace and changed no file. It proved that the permanent tester's catalog has only `phase-1.5-compatibility-synthetic/v1` and `phase-2/v1`; the closed schemas, typed contract, runner, recorder, and validator cannot register, dispatch, record, or validate Phase 3. D-0020 accepts corrected §10.6's exactly nine shared tester paths for a versioned additive `phase-3/v1` registration while preserving older entries/modes. The same accepted correction records Arthur's exact outcome: Phase 3 adds only Undo/Redo, local Save/Open, and D-0018 onion to §10.5A; Creator remains usable before/after operations; no lock field/copy, automatic figure/wave/twelve cells, redesign, or Drawing edit is allowed.
...
| Stick Figure Workspace | Canonical `main` contains the published §10.5A compact one-blank-cell/empty-canvas shell, editable Drawing-style Stick timeline, restored controls, and usable Creator path. Stick history, Save/Open, and Stick onion rendering remain unimplemented; D-0020 accepts their exact Phase 3 boundary and tester extension pending publication. | §10.5A Verified/published/integrated; Phase 3 Authorized/Not started |
...
- Active SPEC-0001 status: the original Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, while their visible result is owner-rejected. The D-0017 §10.5A correction is **Verified, published, and integrated** at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 specifies the exact Phase 3 onion contract; D-0019 marks Phase 3 **Authorized; Not started**; D-0020 accepts the exact tester-registration/Creator-preservation correction pending publication. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched.
