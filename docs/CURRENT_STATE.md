...
Last verified: 2026-08-18 from exact current-main `d809f733a7fb90037627f3d9df359be95b9dac49`. The original SPEC-0001 Phase 2 bytes remain historically published/integrated in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, but Arthur has rejected their visible product result. SPEC-0001 §10.5A is the sole correction and is **Approved; Authorized; Not started** through D-0017. Phase 3 remains Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate, Proposed, inactive, and untouched.
Current Git basis: this approval-recording task verified the exact seven-file Spec Architect proposal in a dedicated detached worktree at expected current-main `d809f733a7fb90037627f3d9df359be95b9dac49`, then added the D-0017 decision record. The implementation base remains unset until this activation record is separately published; this task performs no fetch, pull, remote mutation, or publication.
...
The Stick Figure Workspace and separate Stick Figure Creator are early functional scaffolds. The published Phase 2 runtime stores independent bounded-wave poses, but its visible workspace/timeline is owner-rejected and does not provide the required general editable-frame experience. Stick projects still cannot be saved/opened, and Creator Save remains disabled.

SPEC-0001 Phase 1 added hidden V1 Stick contracts and deterministic offline proof: one fixed 11-joint/10-segment humanoid, strict project/manual-action/AI-command formats, canonical WebCrypto hashing, a derived horizontal line head, identical manual/AI animation-content goldens, rejection fixtures, and a receipt/closeout proof harness. The published Phase 2 runtime later connected a bounded subset to the Workspace; §10.5A now proposes replacing that rejected visible realization without rewriting the Phase 1 contracts or history.
...
The published SPEC-0001 Phase 2 runtime is not the accepted visible destination. Fresh isolated browser inspection reproduces Arthur's report: a 150px timeline with twelve large cells, an automatic built-in figure, reduced/reordered right-panel tools, changed top-bar presentation, restricted frame actions, disabled layer operations, and Creator that locks after editing. Exact historical render/source at `68338d54542bbfd3fb1f0fab06548f0424871f80` shows the required compact one-cell empty workspace, original menus/fonts/layout, four original right-panel tabs/tools/order, canvas/toolbar behavior, and Creator access. Approved §10.5A restores that shell and adds only current-Drawing-style applicable timeline behavior with independently editable Stick keyframes. No correction runtime or proof exists yet.
...
| SPEC-0001 Phase 2 UI correction research | Isolated current and exact `68338d…` historical Home → New → Stick renders reproduce the rejected result and required restoration baseline; current Drawing timeline source/handlers were traced. | Approval evidence only; §10.5A Approved/Authorized/Not started; corrected behavior unimplemented/unverified |
...
| Stick Figure Workspace | Published runtime currently shows the owner-rejected large twelve-cell/automatic-figure workspace and a bounded independent-pose wave editor. The required `68338d…` shell restoration plus general editable Drawing-style Stick timeline is specified in §10.5A but not implemented. | Historical bytes published; visible acceptance rejected; correction Approved/Authorized/Not started |
...
- Active correction status: the original SPEC-0001 Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, while their visible result is owner-rejected. D-0017 records §10.5A as **Approved; Authorized; Not started**; its implementation base will be the future activation-publication commit. SPEC-0002 remains complete/protected; Phases 3–7 remain Unauthorized/Not started; SPEC-0003 remains separate Proposed/inactive and untouched.
