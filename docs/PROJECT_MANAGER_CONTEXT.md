...
The latest product direction, updated through 2026-09-18, is:
...
- D-0085 creates SPEC-0008 as Proposed, decision-complete and review-ready without implementation authority. D-0086/GIT-067 publishes the exact planning-only package at `ba5ecd694df78414240ce83a9140c5196334ebdc`. Its six-phase V1 is fixed Terra conversation/jobs → provider-neutral reference video → deterministic frame bundle → ordinary editable reconstruction → registered-command edits → beta/export closeout. It preserves the manual registry/atomicity laws, makes Sora 2/Videos deprecation a provider-neutrality constraint, and names all later cost/privacy/security gates. Phase 1 still awaits Arthur's separate proposal approval and Phase 1 authorization.
...
4. D-0085 resolves the SPEC-0008 V1 slice: no authored auto-apply; every reconstruction/edit uses isolated Preview/Cancel and explicit atomic Apply. The broader post-V1 product policy remains open.
...
8. D-0085 resolves the first AI-led vertical-slice sequence and command/transaction boundary in Proposed SPEC-0008; implementation approval remains separate.
9. All seven SPEC-0006 phases are published/integrated through GIT-061 and cleaned up under D-0070. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066 `c193b8ba89fa55ead02d84ea10bb81f71b960f8a`. SPEC-0008 is Proposed/review-ready; no implementation phase is authorized.
