...
- SPEC-0005 Phases 1 and 2 are published/integrated; GIT-043 published the exact accepted 21-path Phase 2 package at `e52454354c39b962ac2710a8602a5306ffd62ad5`. Its 17,520-byte correction manifest SHA-256 remains `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874`; the 17,826-byte `ea7ab9c5…` manifest remains historical non-acceptance evidence. The result is planner-independent and adds no new visible motion; Arthur's ordinary app review remains smoke-only. D-0049 authorizes Phase 3's existing grounded non-locomotion whole-body pose contract, but implementation is Not started and blocked until GIT-044 establishes its fresh executor base. Phases 4–8 remain Unauthorized/Not started.
