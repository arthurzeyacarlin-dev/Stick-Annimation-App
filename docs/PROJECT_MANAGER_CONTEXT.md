...
- The dirty `/3cd3/` Phase 1 result remains Rejected, unpublished, unaccepted, and non-reusable historical evidence. Its verified recovery/cleanup preceded the fresh accepted `/f5c0/` implementation; no rejected byte was resumed or copied. Preserve `/f5c0/`, PID 45075, port 56875 and accepted proof through GIT-062 publication/synchronization, then complete D-0054 cleanup.
...
9. All seven SPEC-0006 phases are published/integrated through GIT-061 `185f58752c4f8dd4f5bfea0befe48998e5cd0f04` and cleaned up under D-0070. Drawing-only SPEC-0007 is Approved/active under D-0074; D-0075 accepts and technically verifies corrected Phase 1. GIT-062 publication/integration and D-0054 cleanup remain pending; Phases 2–5 remain unauthorized. SPEC-0008 remains a future separate decision.
