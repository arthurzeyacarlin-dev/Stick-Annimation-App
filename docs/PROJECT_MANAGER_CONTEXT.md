...
- D-0050 preserves exactly eight phases and authorizes one formal Phase 2 v2 correction pending GIT-045. Phase 2 v2 adds performer-facing/body-local projection, allowed limb planes, joint guides, safe flexion bands, tightly controlled projected-sign transitions, backward-bend/sudden-flip rejection, forbidden-extra-movement rules, final rounded validation, and fail-closed no Preview. Corrected Phase 3 is decision-complete but unauthorized until the correction is accepted and separately published.
- Corrected Phase 3 accepts semantic no-coordinate goals, enumerates bounded whole-body candidates, applies hard safety first, and deterministically ranks safe complete sequences by prompt match, comfort, line of action, balance, silhouette, continuity, and minimum unrequested movement. Its independent human-authored quality/mutation suite has named cases and thresholds; sparse landmarks/guides do not create stops. Phases 4–8 retain mechanics, paths/timing, gait, recipes, and the only planner-door ownership. Manual behavior and independent editable keyframes remain unchanged.
