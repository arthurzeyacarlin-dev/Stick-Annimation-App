...
- D-0085 creates SPEC-0008 and D-0086/GIT-067 publishes the exact planning-only package at `ba5ecd694df78414240ce83a9140c5196334ebdc`. D-0087 records Arthur's explicit approval of the full specification and separately authorizes Phase 1 only. Its six-phase V1 remains fixed Terra conversation/jobs → provider-neutral reference video → deterministic frame bundle → ordinary editable reconstruction → registered-command edits → beta/export closeout. One fresh Plan-mode Phase 1 Spec Executor is next; Phases 2–6 and all live/paid provider activity remain unauthorized behind their named gates.
...
9. All seven SPEC-0006 phases are published/integrated through GIT-061 and cleaned up under D-0070. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066 `c193b8ba89fa55ead02d84ea10bb81f71b960f8a`. SPEC-0008 is Approved/active; Phase 1 is Authorized/Not started and Phases 2–6 remain unauthorized.
