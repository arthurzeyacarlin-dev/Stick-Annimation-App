...
- GIT-045 published D-0050's first Phase 2 v2/Phase 3 correction in exact 13-document commit `a4589664b6857eb10a828189e177e0e7d47e3f69`. D-0051 makes one final pre-execution correction: `stick.movement-goal/v1` is a bounded ordered semantic sequence, not one whole-goal facing/support/limb state. It binds the exact starting pose, per-landmark facing/support/foot-hand-pelvis contacts/four-limb obligations/active parts, adjacent transitions, and exact return/hold/continuation. Phase 2 v2 is Approved but not implementation-authorized until GIT-046; corrected Phase 3 remains unauthorized until Phase 2 is accepted and separately published.
