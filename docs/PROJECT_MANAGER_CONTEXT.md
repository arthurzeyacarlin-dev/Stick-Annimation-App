...
- D-0041 accepts Phase 2.5 as done for its narrow shared timing/spacing purpose. The exact seven-path result at base/HEAD `f131e75aafccec0d1b8ecb717e2d95b518355d39` passed a 250-check independent validation; its 14,601-byte manifest SHA-256 is `783e6396cf994ce48fb9d7c94dc58674594dd545f888a9c25fe3c1f654a788d1`. The old wave/jump/bow/dodge review samples remain rejected as natural-action evidence: jump inherited a wave hand and floated, bow was over-compressed, and dodge reversed with sliding feet. Phase 2.6 is the one final shared natural-action/weight/contact/intent foundation, is Approved/Authorized/Not started, and has no Phase 2.7. GIT-037 publication/integration is its remaining entry gate.
