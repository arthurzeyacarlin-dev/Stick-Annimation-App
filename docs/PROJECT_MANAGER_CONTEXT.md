...
- The SPEC-0005 docs-only activation is published/integrated at `2b4f00e7a122c196b2c0600144cd638b461bbb2f`. D-0044 records Arthur's acceptance of the exact six-path Phase 1 proof-only result, and GIT-039 published/integrated it within exact 20-path commit `2436a9414221e8ee7ef40151284cb8f4e069e828`. The older wave is protected as a readability floor by real `0 → … → 11 → 0` playback, independent mutation/reference evidence, and ordinary-app human review; Phase 1 changes no runtime motion. GIT-040 published D-0045's former Phase 2 authorization; that executor's visible result was rejected/removed. GIT-041 then published D-0046's eight-phase restructure at `46b97556ec4e9c9249a1ff354c546f7b1c32ea4d`. A distinct body-safety executor implemented exactly eight paths in stopped `/7dfc/`; its 17,826-byte manifest SHA-256 is `ea7ab9c5a142843b109ad49924f4709660347265099740312a666eca07972cd4`, but publication is blocked and the result is not accepted/Verified/published. D-0047 corrects selection-before-bake and Phase 4's airborne ceiling at specification level only. The exact Phase 2 path/proof ceiling, ordinary smoke-only process, no-new-motion claim, and Phase 3 first-new-motion-review boundary remain. Phases 3–8 remain Unauthorized/Not started.
- The durable safety rule is planner- and direction-independent: Pretend AI and future Terra receive the same checked-selection/final-completion gate; no action/fixture/materializer/trust/skip/airborne flag bypass exists. The current built-in humanoid has no hyperextension/reversed-bend override. A future separate unusual-body contract must define performer-versus-viewer/facing left/right semantics and permitted anatomy. Current manual post-Apply freedom and independent editable frames remain unchanged, and later phases must keep rerunning bend/continuity checks.
