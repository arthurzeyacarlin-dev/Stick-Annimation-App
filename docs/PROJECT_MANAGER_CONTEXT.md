...
- D-0056 records Arthur's intended one-workspace outcome. SPEC-0006 is **Approved and active** under D-0057. GIT-051 published and integrated the accepted Phase 1 contract/read-only migration at `804ff39dc73c88d4799570cce2ef18987745a0be`; GIT-052 published and integrated the corrected exact 15-path Phase 2 shell/New/Open result at `d2096109900cc50a0a4dae2f603bd74b7b4a3427`. New is direct, Open is one combined collection in the inherited Projects presentation, and one compatibility editor mounts through `AnimationWorkspace`; the editor internals and write owners remain separate. D-0060 records Arthur's 2026-09-10 explicit authorization of **Phase 3 stage/compositing only** from exact runtime base `d2096109900cc50a0a4dae2f603bd74b7b4a3427`; Phase 3 is Authorized/Not started. **Phases 4–7 remain Unauthorized/Not started.** Future SPEC-0007/0008 remain absent and unauthorized.
...
## Current SPEC-0006 result — Phase 2 published; Phase 3 authorized

GIT-051 is complete at `804ff39dc73c88d4799570cce2ef18987745a0be`, parent `3b784cc6a68ff6f10fa390d96b81376b46e54b44`, message `Implement SPEC-0006 Phase 1 unified contract`, exactly 27 paths. GIT-052 is complete at `d2096109900cc50a0a4dae2f603bd74b7b4a3427`, parent `804ff39dc73c88d4799570cce2ef18987745a0be`, message `Implement SPEC-0006 Phase 2 unified shell`, exactly 29 paths: the accepted 15 technical paths plus 14 reviewed control-plane/tree paths. Canonical `main`, local `origin/main`, and live GitHub `main` were freshly verified equal at `d2096109900cc50a0a4dae2f603bd74b7b4a3427` with `0/0` synchronization before this records-only reconciliation.

Arthur accepted the corrected Phase 2 result from exact base `804ff39dc73c88d4799570cce2ef18987745a0be`; those exact 15 technical paths are now committed in GIT-052. The 16,649-byte manifest at `output/spec-0006/phase-2/proof-manifest.json` has SHA-256 `ebfeb699c0d9bcedd5b6b7c90d5cb4b71a3fe3ea89326a2820b86882e2c27cb7`; CPA revalidation passed all 15 source bindings, 19 receipts, 38 artifacts, and 18 negative mutation cases. The obsolete review process is stopped, port `56362` is closed, and the accepted executor worktree is no longer registered.

The published visible behavior is narrow: New opens **Untitled Project** directly; Open keeps the established dark Projects layout and card treatment while combining Drawing V1/V2 and Stick V1/V2 entries, removing only the type selector and omitting type badges or new wrapper chrome; invalid entries are disabled; one inherited compatibility editor begins at the top of the viewport. Desktop/compact proof passed 40 operations and 13 screenshots with zero source writes, real API requests, external requests, console errors, or page errors. Mixed compositing, one timeline/tool/history/persistence owner, and canonical Save remain unimplemented. D-0060 authorizes one new dedicated Plan-mode Phase 3 Spec Executor for the existing §12 stage/compositing scope from exact runtime base `d2096109900cc50a0a4dae2f603bd74b7b4a3427`; the executor must bind the later authorization-record commit/spec bytes and satisfy the Phase 3 entry gate before editing. Phases 4–7 remain Unauthorized/Not started.
...
9. SPEC-0006's seven-phase preservation/migration design is approved under D-0057. Phase 1 is published/integrated at GIT-051 and Phase 2 at GIT-052 `d2096109900cc50a0a4dae2f603bd74b7b4a3427`. D-0060 authorizes Phase 3 only from that exact runtime base; resolve bounded mechanics inside the authorized phase without inventing a helper spec. Phases 4–7 remain separately gated and unauthorized.
