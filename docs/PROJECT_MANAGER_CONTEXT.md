...
- D-0094 preserves the standalone [`SPEC-0009 — Animation Export`](specs/0009-animation-export.md) three-phase plan, published in GIT-074 `30f6f85e5c483c9df15946e7a451bf2a31374f2e`. D-0096 records Arthur's approval and acceptance of corrected Phase 1 Choose and Watch. GIT-076 publishes/integrates its exact 12 technical paths plus reviewed records at `548063b9247708106c7c8c8a11978563d07d6597`; the seven-file/159,644-byte proof bundle is preserved at aggregate SHA-256 `7137a1de4ad8a0be73c17b45699592a98ed876b4858e18df6a36cf8d4b509fbb`, port 57200 is closed and the obsolete review worktree/publication branch are removed. D-0097 records Arthur's explicit Phase 2 authorization: persist a project-owned background with white default, encode locally in the supported Mac/browser path, target MP4 with H.264 video and AAC audio, and use Mediabunny for assembly without AI/provider calls or per-export charges. Phase 2 is Authorized/Not started; Phase 3 remains Unauthorized/Not started.
...
9. All seven SPEC-0006 phases are published/integrated through GIT-061 and cleaned up under D-0070. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066 `c193b8ba89fa55ead02d84ea10bb81f71b960f8a`. SPEC-0008 Phase 1 is accepted, Verified, published/integrated in GIT-070 `76708645c96b3b0ea95c524f162bb6152d539fcf`, proof-preserved and cleaned up under D-0090. D-0091/GIT-072 and D-0092/GIT-073 are preserved planning history; D-0093 makes Phases 2–6 Paused/Unauthorized/Not started/not rejected. D-0094 adds SPEC-0009; D-0096 accepts Phase 1; GIT-076 `548063b9247708106c7c8c8a11978563d07d6597` publishes/integrates/preserves/cleans it up; D-0097 authorizes Phase 2 as Authorized/Not started while Phase 3 stays Unauthorized/Not started.
