...
- Phase 2.5 is the next planned shared Action Timing and Spacing milestone for both future free recipes and future Terra plans. Its separate activation is still unpublished; GIT-036 must reconcile and publish that docs-only activation before any Phase 2.5 app code starts.
