...
The latest product direction, updated through 2026-09-20, is:
...
- Arthur selected Project Safety and Recovery as the next beta-readiness priority. D-0102 and [`SPEC-0010`](specs/0010-project-safety-and-recovery.md) define exactly three phases. GIT-080 publishes the plan, D-0103 authorizes Phase 1, and D-0104 accepts/technically verifies its exact ten-path Save-and-Exit result with propagation/publication authorized. The ignored Terra environment correction changed no tracked AI source. Phases 2–3, recovery storage and startup recovery remain unauthorized.
