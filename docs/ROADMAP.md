...
- D-0129/D-0130/GIT-094 fully close the final Phase 4 citation/reveal correction. Phase 5 is entry-ready but still requires separate authorization and does not begin automatically.
...
The target is Tuesday, September 29, 2026 and 85–90% local/private-beta readiness only if no major phase rejection occurs. GIT-089 published the plan; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125/D-0126/GIT-092 close Phase 4's hosted-search/citation/activity result plus corrupt-row recovery. D-0127 accepts the final terminal/source correction; D-0128/GIT-093 publishes, activates, preserves and cleans it up. Phase 5 dictation is entry-ready but remains Unauthorized/Not started until Arthur separately authorizes it; Phase 6 beta hardening, public exposure and deployment remain unauthorized. The accepted AI Animator remains separate; paused SPEC-0008 Phases 2–6 do not resume.
