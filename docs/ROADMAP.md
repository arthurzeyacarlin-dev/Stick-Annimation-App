...
## Current owner sequence — 2026-09-25 (SPEC-0014 Phase 1 closed; Phase 2 awaits authorization)
...
4. Only after a separate Arthur authorization may a fresh Plan-mode Phase 2 Spec Executor from synchronized canonical `main` wire actual Assistant/Terra completion across navigation. Phase 3 Export and Phase 4 offline/reliability stay separately gated.
