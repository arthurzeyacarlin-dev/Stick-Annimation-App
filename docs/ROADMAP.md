...
## Current owner sequence — 2026-09-18 (D-0085–D-0087; SPEC-0008 approved, Phase 1 authorized)
...
The delivery target is one phase/day plus one correction/publication buffer day. It does not bypass the per-phase Spec Executor → Arthur/PM acceptance → CPA → separate publication/integration → cleanup lifecycle. Phase 1 is now ready for one fresh Plan-mode Spec Executor after the authorization record is published and synchronized; Phases 2–6 remain gated and unauthorized.
