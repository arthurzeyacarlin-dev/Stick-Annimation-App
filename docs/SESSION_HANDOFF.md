...
Spec registry: completed SPEC-0001–0003 remain protected; completed SPEC-0004/0005 phases remain published history and unfinished phases remain superseded/inactive under D-0055. SPEC-0006 is **Approved and active**. GIT-050 published Phase 1 activation at `3b784cc6a68ff6f10fa390d96b81376b46e54b44`; D-0058 records the accepted exact 11-path Phase 1 result as technically Verified pending GIT-051 publication/integration. **Phases 2–7 remain Unauthorized; Not started.** Current ordinary runtime remains split.
...
SPEC-0005 status: SPEC-0005 Phase 1 and Phase 2 v1/v2 remain accepted, Verified, published, and integrated; v2 is complete at GIT-048 `05faa59195c6d5f2d8a11ebcc9ab77fe1b6fdf14`. GIT-049 published the later Phase 3 authorization at `de54aed275c2f6da6e7c3f4a7f65091e8d5370c0`. A Phase 3 executor then ran, but Arthur rejected its visible result: it is unpublished, unaccepted, non-reusable, and not completed. D-0055 supersedes Phase 3 and unfinished Phases 4–8 by future SPEC-0008; they are inactive with no implementation authority.
Current result: accepted Phase 1 worktree `/Users/arthurcarlin/.codex/worktrees/ac2f/stick-animation-app` is detached at exact GIT-050 base/HEAD `3b784cc6a68ff6f10fa390d96b81376b46e54b44` with an empty index and exactly 11 new technical paths. Canonical `main` and local `origin/main` match that SHA at local `0/0`. Manifest `output/spec-0006/phase-1/proof-manifest.json` is 9,257 bytes at SHA-256 `83614635c02f22d81205c441c46de3bff3a75f1c948661a1670a36eca75dbb29`. The accepted result is technically Verified but uncommitted/unpublished; GIT-051 is pending. The prior rejected SPEC-0005 Phase 3 worktree/evidence remains protected, rejected, and untouched.
Current roadmap phase: Phase 0 — Preserve and Stabilize

## Accepted SPEC-0006 Phase 1 — publication pending

[`SPEC-0006 — Unified Animation Workspace`](specs/0006-unified-animation-workspace.md) retains the exact seven-phase typed-data/lossless-migration/one-root design. GIT-050 published the activation; the stopped executor added only the hidden contract, migration, fixtures, and technical proof. Arthur accepted the unchanged-app human review, and the Project Manager accepted the technical result and transferred exclusive ownership. D-0058 records **Phase 1: technically Verified; publication pending**. **Phases 2–7 remain Unauthorized; Not started.** SPEC-0006 remains the sole unification owner.

Exact technical evidence: 11 new paths inside the 18-path ceiling; zero existing runtime-file modifications; 160 manifest checks; 56 valid and 124 invalid cases; 1,000 repeats; 3,516 assertions; Drawing V1/V2 and Stick V1/V2; stable failures; source-bound deterministic candidates; independent oracle; zero source writes; TypeScript; focused lint; inherited Drawing/Stick validators; exact hashes/scope/diff/index; and established full-lint baseline 5 errors/72 warnings with zero Phase 1 finding. Bound ordinary-app evidence covers 10 operations/five screenshots, four deterministic availability requests, zero real API/external requests, zero console/page errors, and no review-only UI. Port `56261` is closed. Accepted technical bytes remain unchanged during CPA propagation.

SPEC-0007 and SPEC-0008 are not created or implemented. No new AI capability, provider/model/prompt, motion video, tracking, paid call, external request, dependency, cloud/auth, deployment, or legacy deletion is authorized.
...
Next step: after review of this CPA packet, a later exact GIT-051 publication instruction may stage only the accepted 11 technical paths and reviewed control-plane/tree allowlist, commit on the accepted worktree, fast-forward only unchanged clean canonical `main`, push normally, verify clean `0/0`, and then complete D-0054 accepted-copy cleanup. Phase 2 remains Unauthorized; Not started and requires a later owner decision after Phase 1 integration.
...
Current 2026-09-09 stopping point: GIT-050 is published at `3b784cc6a68ff6f10fa390d96b81376b46e54b44`. Arthur accepted the exact Phase 1 result and unchanged-app review. The Control Plane Architect verified the accepted 11 technical paths and manifest, propagated D-0058/current records, and stopped before staging with an empty index. GIT-051 publication/integration is the sole next authorized workflow step after a later explicit instruction. Phase 2 and Phases 3–7 remain Unauthorized; Not started. The accepted worktree and technical proof must remain preserved until publication and cleanup complete.

D-0052 publication work resumed after an interruption in dedicated plan worktree `/Users/arthurcarlin/.codex/worktrees/bfd4/stick-animation-app`, branch `codex/spec0005-front-knee-projection`. The 13-document draft carried over unstaged; canonical main was clean at GIT-046. GIT-047 is the containing docs-only commit with parent `55b05e2daad649ac1e0027722a75762a9714d281` and message `Define SPEC-0005 front-facing knee projection`; the returned packet binds its exact SHA and completed ref verification. No implementation worktree was taken over. Analytical leg checks passed 386 assertions over both branches, three seeds, transformed/mirrored cases, profile mirrors, and clearance/ambiguity boundaries; they are not runtime or full-body proof.

SPEC-0004 Phases 1, 2, and timing-only Phase 2.5 remain Verified, published, and integrated. Phase 2.6 remains rejected, unpublished, and superseded historical evidence. Under D-0055, unfinished Phases 3–8 are Superseded by future SPEC-0008, inactive, and must not be implemented. GIT-033 through GIT-037 remain complete.

SPEC-0005 Phase 1 and Phase 2 v1/v2 remain accepted, Verified, published, and integrated; its Phase 3 result remains rejected/unpublished/non-reusable and its unfinished sequence remains superseded under D-0055. SPEC-0006 is Approved under D-0057; GIT-050 activation is published; Phase 1 is accepted and technically Verified pending GIT-051 publication/integration. Phases 2–7 remain Unauthorized/Not started. GIT-047 remains the historical accepted SPEC-0005 Phase 2 v2 implementation base, not a new executor starting point.
...
Current Phase 1 CPA verification: exact base/HEAD/main/local-origin `3b784cc6a68ff6f10fa390d96b81376b46e54b44`; local canonical `0/0`; empty accepted index; exact 11 technical paths; unchanged manifest SHA-256/size and all source bindings; 160-check manifest replay; 3,516-assertion migration rerun; TypeScript/focused lint/inherited validator passes; full lint unchanged at 5 errors/72 warnings; ordinary-app evidence preserved; port `56261` closed; no persistent process owns `/ac2f/`. Control-plane changes are separate and unstaged. No accepted technical byte, existing product runtime, source store, other worktree, provider/network/deployment system, or canonical `main` is mutated.
...
SPEC-0001 Phases 1–6 and the visible Phase 6 wave behavior; SPEC-0002; SPEC-0003; every accepted SPEC-0004/0005 runtime/proof byte; Home/Tutorials/New/Open/My Project/AI Assistant/Export/AI Project Finalizer; current split Drawing/Stick workspaces and write paths; Drawing AI; Stick manual menus/tools/layout, Play/Pause, onion, Creator presentation, line-head appearance, manual animation behavior, and manual post-Apply ownership; provider/API/search/Supabase/model configuration; Terra/Luna/Sol routing; packages/dependencies/configuration/environment/database/public assets; dashboard/auth/billing/deployment; legacy source stores; rejected executor worktrees/results; duplicate worktrees/processes; canonical main; and recovery material remain unchanged. SPEC-0006 Phase 1 changes only its 11 new hidden technical paths and ignored proof artifacts.
