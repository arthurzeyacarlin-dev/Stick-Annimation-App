...
SPEC-0005 status: **Phases 1 and 2 are Verified/published/integrated. The first former Phase 2 is rejected/removed. GIT-043 published the exact accepted 21-path current Phase 2 result at `e52454354c39b962ac2710a8602a5306ffd62ad5`. D-0049 authorizes Phase 3 only; Phase 3 is Approved/Authorized/Not started pending GIT-044.** The correction manifest is 17,520 bytes at SHA-256 `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874`; the 17,826-byte `ea7ab9c5…` manifest remains historical. Phases 4–8 remain Unauthorized/Not started and no executor is active.
Current result: the published Phase 2 correction implements checked immutable important-pose selection before test-local bake, then independent final rounded/post-repair revalidation and one final candidate/Preview door. GIT-043 is complete at `e524543…`; its clean tester passed 40 operations, 13 screenshots, four messages, 37 negatives, exactly one mocked Drawing POST, zero real API/non-loopback/provider requests, and cleanup, with result SHA-256 `c2887be734fe073191aa7d81fc9ffcf2cd6009da0bd188b67ddd9ad77aaebb63`. Arthur's ordinary app acceptance remains unchanged-app smoke evidence only. Phase 3 implementation has not begun.
...
GIT-043 is complete at `e52454354c39b962ac2710a8602a5306ffd62ad5`; Phase 2 is Verified/published/integrated. The exact next action is separate GIT-044 publication of D-0049 and these reviewed Phase 3 authorization records. Until that publication establishes the executor base, do not start Phase 3, create an executor worktree/app copy/server, or mutate runtime/proof bytes. Phases 4–8 remain Unauthorized/Not started. Do not touch `/8de8/` or perform provider/API/paid/Drawing/persistence/deployment work.
