...
## Current handoff — 2026-09-26 SPEC-0015 Phase 1 accepted; planning publication first

- D-0144 records historical research authority. D-0145 records Arthur/PM V5 acceptance of the revised [SPEC-0015 — Functional AI Dashboard, Usage, Accounts and Billing](specs/0015-functional-ai-dashboard.md) Phase 1 TEST PREVIEW and Arthur's explicit authority to publish this reviewed 11-path planning package to canonical GitHub/main. Phase 1 is **Authorized / Not started**, effective after clean publication/synchronization. Phases 2–6 remain **Unauthorized / Not started**.
- The Spec Architect's dedicated `/Users/arthurcarlin/.codex/worktrees/93e8/stick-animation-app` began clean/detached at `c682e430e204a7d750654da3f96e36ab4f57e196`, equal to local canonical `main` and `origin/main`. It changes only the new spec, necessary canonical planning records and generated tree, then publishes those exact paths if both canonical and remote main remain at that base. Read the resulting planning commit SHA from Git after publication; do not hard-code the old research SHA for execution.
- Fresh source and live canonical Dashboard navigation prove static balance/plan/date and no chart. Phase 1 replaces that with a read-only 10,000 recorded-token Monday-start UTC-week **TEST PREVIEW**, default partial Project AI/Assistant browser receipts, off-by-default labeled synthetic Demo with frozen reset/color sequence, five cumulative views, source-specific whole-bar height/color on one shared denominator, pinned Combined status and accepted lower cards recreated afresh. Real paid plan/balance/refill remains unconfigured; preview exhaustion says AI continues working. No Phase 1 runtime implementation is claimed here.
- Next: the separate Phase 1 executor in its dedicated `/Users/arthurcarlin/.codex/worktrees/ea06/stick-animation-app` app copy must refresh to the **new published planning SHA**, verify exact base/clean index/exclusive ownership, enter/complete its Plan-mode boot and implement only the 14-path maximum in §8 with no-cost proof in §9. The executor's prior plan at the old base is preparation, not authorization to code from a stale SHA. It returns its technical manifest and Implementation Review Packet without staging, committing, pushing or editing docs. Arthur/PM V5 then accept or reject before any sequential CPA handoff.
- Later phases require named privacy/metering/auth/economics/caps/payment/launch gates and refreshed exact path ceilings. Paid weekly renewal versus preserving unused 99% is unresolved; no illustrative price, quota, pack or margin is adopted. Preserve SPEC-0008's D-0093 pause and PM V4 ownership. No AI thinking/reply/model/reasoning/search/tool/citation/dictation/retry/limit change is authorized; D-0124's removed cumulative local Assistant cap stays removed. SPEC-0014 remains closed, low-usage producers dormant, and the two existing bells/Export unchanged. No provider/paid call, account, checkout or deployment occurred during planning. The next heading is the preceding historical closeout.

## Historical handoff — 2026-09-26 D-0143/GIT-102 published and cleaned

- Arthur passed SPEC-0014 Phase 4 and authorized control-plane propagation and GitHub/main publication. Exact 28-path commit `283c297d1df01371dc599a52719d35dc78e1d2f4`, parent `57f3a8560dc61f79db87c13dbff7285684b74793`, published only 14 accepted technical and 14 reviewed record/tree paths. Canonical `main`, `origin/main` and live GitHub `main` matched clean `0/0` after normal fast-forward/push. No rejected Phase 3 Export byte was included.
- The sealed Phase 4 manifest SHA-256 `1646e497ad2e96b2263201dbced8c69bd6aae21487de481b255a912f7019a0eb` and ignored proof were preserved in the PM worktree at `output/recovery/GIT-102-spec0014-phase4-283c297/phase4`; no-difference dry-run comparison passed. The exact review server PID 67776/67777 stopped, port 58480 closed, and the clean obsolete `/9ee9/` worktree and merged local branch were removed. Active PM worktree, canonical main, recovery proof and other worktrees remain untouched.
- Current product: Home and Assistant are the only bells. One shared red browser-offline incident and a single durable restored notice on genuine reconnection are active; an unread restoration survives route/reload/later outage until explicit acknowledgement. Accepted Phase 2 Assistant/Terra alerts remain. Phase 3 Export notifications are rejected, and ordinary Export stays screen-owned. No new AI/provider/search/dictation/tool/limit behavior, paid call, or deployment occurred. The full Webpack build retains the identical untouched dev AI-cost `PageProps` failure; physical devices/native OS focus/zoom/non-Chromium remain unproven.
- SPEC-0014 has exactly four phases. Phase 4 is its last accepted technical phase; **there is no Phase 5**. Do not dispatch further notification work or revive rejected Export work without a new owner-defined scope and separate authorization. The D-0142 prepublication handoff below is historical.

## Historical handoff — 2026-09-26 D-0142 accepted; GIT-102 publication was pending
...
- Arthur subsequently authorized a new Phase 4 app copy: one browser-declared offline incident through the existing Home bell, with the Assistant bell reply-only, accepted Assistant/Terra behavior protected, and no Export, AI/provider/search/dictation/limits, low-usage/updater, new bell or deployment change. This product authorization is gated on D-0141 publication and a fresh exact-base Plan-mode Spec Executor; Phase 4 implementation has not started. The next heading is the earlier pre-cleanup handoff.

## Historical handoff — 2026-09-25 D-0141 rejects SPEC-0014 Phase 3 Export notifications

- Arthur rejected the separate Phase 3 Export notification copy on product-utility grounds after visible review. Its technical PASS does not make it accepted. The stopped executor's `/Users/arthurcarlin/.codex/worktrees/bd83/stick-animation-app` is based on canonical `main` `c8fbc954c130acdcc9df429d7581c38b497bc33a`, with empty index, 15 dirty technical paths and ignored manifest SHA-256 `6e93cd7b73f8dca43c19fae2aebc7170889475f515e63909342ab7116817f868`. It remains unpublished and must not be reused or merged.
- Keep the published Phase 1 two-bell foundation and Phase 2 Assistant/Terra unread-only exact-target notifications. Drop only the proposed Export notification/background coordinator. Ordinary Export stays screen-owned. Future low-AI-usage and real updater notices are still desired but dormant until trustworthy sources and separate authorization exist; do not manufacture a limit or Version 2 availability.
- This D-0141 task changes canonical control-plane records only. No rejected runtime, fixture, technical-test or proof bytes are accepted, and no stage/commit/merge/push or Phase 4 implementation is authorized here. Canonical `main` was clean/equal to local `origin/main` at `c8fbc954c130acdcc9df429d7581c38b497bc33a` before these record edits.
- Exact next sequence: separately authorize publishing/synchronizing these docs-only records; complete D-0054 rejected-copy recovery preservation and exact server/worktree cleanup; then Arthur may separately authorize a fresh Plan-mode Phase 4 offline/reliability Spec Executor from the final clean canonical-main SHA. Phase 4 must prove the accepted AI bells and offline incident without adding Export notifications or changing Export behavior. Until those gates, Phase 4 remains **Unauthorized; Not started**. The next heading is the historical Phase 2 closeout handoff.

## Historical handoff — 2026-09-25 SPEC-0014 Phase 2 published and closed; Phase 3 required separate authorization

- GIT-100 published the exact accepted 21 technical plus 15 reviewed control-plane/tree paths in commit `318566d6d20acec672c3d8c6a0e5620ad70c7d66`, parent `acd4031cade0e4e960223190a8c1645d007d61af`. Clean canonical `main` fast-forwarded and pushed normally. Canonical/local-origin/live GitHub main matched cleanly at `0/0` after the product push. The sealed manifest SHA-256 remains `77bc08b62c472d9ed0f75a2cd6b7d9b4b84d3f9b2e75d89645738567904ae8e7`.
- All 109 ignored proof files/10,200,026 bytes were preserved at `output/recovery/GIT-100-spec0014-phase2-318566d/phase2` in the active PM worktree; source/destination inventory SHA-256 matched `dd0983441dbfb0b4d23b99fb470624140544a588977cdb445677d09eb58b65fa`. The exact `/974d/` review server was stopped, port 58440 closed, and only that clean integrated worktree/local branch removed. The existing canonical port-3000 server has canonical-main cwd and `/assistant` returned HTTP 200; no new live AI/provider request was made.
- Phase 2 now supplies app-lifetime Assistant/Terra completion observation and unread-only exact-source alerts through the existing two bells. It does not wire Export or offline alerts and did not change AI thinking/reply/search/dictation/provider/limits, animation mutation or deployment. Full production build still has the inherited untouched dev AI-cost `PageProps` failure; physical devices, native OS focus and non-Chromium remain unproven.
- Exact next step: Arthur may separately authorize a fresh Plan-mode SPEC-0014 Phase 3 Export Spec Executor from the final clean synchronized canonical-main SHA. Until then Phase 3 and Phase 4 are **Unauthorized; Not started**. The D-0140 handoff immediately below is a historical prepublication checkpoint and its GIT-100 pending instruction is superseded.

## Historical handoff — 2026-09-25 SPEC-0014 Phase 2 accepted and recorded; GIT-100 was pending

- Arthur accepted the corrected Phase 2 review copy at `http://127.0.0.1:58440/` and explicitly authorized control-plane recording followed by bounded commit, canonical-main integration and GitHub push. D-0140 records accepted behavior and Control Plane Architect propagation, not premature publication. The stopped Spec Executor transferred exclusive ownership of `/Users/arthurcarlin/.codex/worktrees/974d/stick-animation-app`, branch `codex/spec0014-phase2-ai-completion-review`, unchanged base/HEAD `acd4031cade0e4e960223190a8c1645d007d61af`, with an empty index and exactly 21 accepted technical dirty paths. Canonical `main` and local `origin/main` were clean/equal at that base at the CPA entry check.
- Immutable `output/spec0014/phase2/manifest.json` SHA-256 is `77bc08b62c472d9ed0f75a2cd6b7d9b4b84d3f9b2e75d89645738567904ae8e7`, binding 21 sources/105 evidence files. Strict pre-propagation validation passed with 12 rejected mutations. Forty-two oracle/42 real-browser checks, 16 protected static/four browser receipts, TypeScript/focused lint/build/diff and zero automated external/provider/paid calls passed. The untouched dev AI-cost `PageProps` route still blocks the full production build identically on base and result; physical microphone/devices, native OS focus and non-Chromium remain unproven.
- Accepted Phase 2 connects root Assistant/Terra completion observers for already-started jobs without automatic resubmission. Exact source terminalization precedes one notification. Home and Assistant remain the only bells; panels show only unread items. The exact watched origin produces no visible notification. Assistant rows identify the saved chat and Terra rows the captured project; clicking from Home or another chat opens/focuses the exact turn/project. A row clears only after confirmed exact arrival; unavailable/blocked targets stay unread. Stored read records remain for dedupe, not visible history, with no 24-hour purge. AI thinking/reply/search/dictation/provider/limit, animation, Export and offline behavior remain intentionally unchanged.
- Exact next operation after the Control Plane Architect packet: recheck accepted hashes/manifest and empty index; ensure canonical `main` and live remote have not advanced; stage only the 21 accepted technical paths plus the reviewed canonical control-plane/tree paths; commit on the phase branch, fast-forward clean canonical `main`, push normally and verify clean `0/0`. Stop on an advanced main, changed path or identity mismatch; do not pull/rebase/force. After synchronization, preserve ignored proof, stop/verify closure of the exact 58440 review server and remove only the obsolete accepted worktree/local branch under D-0054. Do not remove the active PM worktree, canonical main or recovery material.
- Phase 3 Export is only the next possible milestone after complete GIT-100 publication/proof preservation/cleanup. It is **Unauthorized; Not started** until Arthur separately authorizes one fresh Plan-mode Spec Executor from the new synchronized main SHA. Phase 4 offline/reliability, deployment, provider/paid operations and paused SPEC-0008 remain outside this closeout.

## Historical handoff — 2026-09-25 SPEC-0014 Phase 1 fully published; Phase 2 entry-ready at that checkpoint
...
- Accepted behavior: exactly one Home bell with all eligible notifications, exactly one Assistant bell with Assistant-reply-only rows/count/blue dot/green ring/announcements/Mark-all, and zero bells on Credits, New/Open workspace, Export, Tutorials, Open Project, My Projects or other surfaces. One local durable read-state store backs both views. Ordinary Phase 1 has no producer, origin registration, destination handler, polling loop or injected fixture, so it does **not** yet alert on actual AI/export/offline outcomes.
- Proof: contract/storage/UI 35/29/41 assertions, exact trigger inventory, two-tab/reload/restart/read-state/capacity/corruption checks, protected Home/Assistant/search/retry/synthetic-dictation/Terra/export/editor flows, TypeScript, focused lint/build and zero automated provider/external calls. Full lint inherits five errors/81 warnings. Full production Webpack build fails identically on untouched `app/dev/ai-costs/lifetime/page.tsx` from both base and result; default Turbopack build failed offline. Native 200% zoom/OS focus, live provider/microphone, physical devices and non-Chromium are unproven.
- Exact next operation: verify reviewed control-plane paths and unchanged 19 technical hashes, generated project tree, empty index, clean canonical `main` and live remote at the original base; stage only accepted implementation plus reviewed records/tree; commit on the correction branch; fast-forward clean canonical `main`; normal push and clean `0/0` verification. No pull/rebase/force or unexpected scope. Then preserve ignored proof, stop exact port-58420 review server, verify closure, and remove only the obsolete accepted worktree/local feature branch under D-0054. Do not remove the active PM worktree or canonical main.
- Phase 2 becomes entry-ready only after full publication/integration/synchronization/proof preservation/cleanup. It remains **Unauthorized; Not started** until Arthur separately authorizes one fresh Plan-mode Spec Executor from the new canonical-main SHA. Phase 2 wires real Assistant and Terra completion/failure across navigation; Phase 3 wires Export and Phase 4 offline/reliability. No later phase begins here.

## Historical handoff — 2026-09-24 SPEC-0014 planning checkpoint
...
D-0132 records Arthur's cost-conscious preference for Sol at proportionate reasoning in routine PM work, Astra Extra High for genuinely difficult consequential cost/research/recommendation work, and Ultra only exceptionally, with explicit phase or safety needs able to justify a stronger setting.

The immutable Phase 6 manifest remains SHA-256 `a0e3eea7e973eb183ff274cfd9ff868d3e4b7712e60e431c9db1c67057702229`; all 20 source/80 evidence bindings and twelve mutation classes revalidated. Eighty-two proof files/4,888 KiB are preserved at `output/recovery/GIT-096-spec0012-phase6-20612c3/phase-6` with an empty checksum-mode comparison. No accepted runtime, fixture, test or proof byte changed after acceptance.
...
Arthur accepted the exact final Phase 4 citation-recovery/reply-reveal correction. D-0130/GIT-094 publishes it as exact 29-path product commit `7053851babec9247c6733e016145fd0d0b8a6e46` from clean base `741ee803f9e0bd72f7c64174a77e52a6ac3a7b17`; exact 14-file source digest is `aa6c1d7954a97d9cb9fab1502d2ba7639f10246c98be03bbfc968ecb9605da54`. Canonical/origin/GitHub main synchronized and the integrated app answered two consecutive live prompts with zero browser errors or disconnect/citation banners. Phase 5 is entry-ready but remains Unauthorized/Not started.

D-0120/GIT-089 establish [`SPEC-0012 — Diamond Animator Guidance Assistant`](specs/0012-diamond-animator-guidance-assistant.md); D-0121–D-0123/GIT-090 close Phase 1, D-0124/GIT-091 close combined Phase 2/absorbed Phase 3, and D-0125/D-0126/GIT-092 close the original Phase 4 hosted-search/corrupt-row result. D-0127 accepts the final terminal/source correction; D-0128/GIT-093 publishes/integrates it as exact product commit `99128d70f4320dcfc757d81c7bc146baf3467f86`, activates canonical `main`, preserves proof and completes D-0054 cleanup.

The stopped accepted correction starts from exact clean synchronized terminal GIT-092 base `21c5b3d70bf3ae5444a310913dbccec9a63895d9`, empty index and exactly 14 technical paths. Immutable `output/spec-0012/phase-4-final-correction/proof-manifest.json` SHA-256 is `a078d42e1b1ac131787c1f8b48aeb333c2263b119b3e2b2b9172a8b213908137`; source digest is `6593a497cc93dd57fbde384071bdb6f84d8e555b4d7e8c0dec8bcd05f73712ce`; it binds 14 sources and five evidence files. Fresh CPA binding verification passed before record edits.

Accepted behavior: Finalizing is job-owned only after the complete Terra result validates and lasts about three seconds; the whole job/search is bounded to 55/30 seconds; a terminal event slot is always reserved; repeated provider search lifecycle events are deduplicated; excess provider source candidates are canonicalized/validated then bounded to eight processed and six displayed rather than surfacing `search source limit was exceeded`; and clean answer prose strips leaked Markdown/raw URLs while dedicated accessible Sources links remain. Query/action/tool/source-retention/token/cost/privacy/cancellation/storage and zero-project-mutation protections remain.

Proof passes 57 deterministic, 23 finalization, 23 browser and four protected-regression groups plus TypeScript, focused lint and diff checks. Two authorized fixed-Terra live requests used no retries: local guidance completed in 8.611 seconds; current YouTube guidance completed in 18.850 seconds with one hosted search, eight processed/two displayed official sources and 2.949 seconds of Finalizing. Reasoning change, reload citation persistence, unchanged project sentinel and zero browser/page errors passed. The search is below the 55-second hard limit but above Arthur's preferred typical 10–15 seconds; physical devices/non-Chromium remain unproven.

Historical next step at D-0130 (superseded by D-0131): Arthur could separately authorize a Phase 5 executor from synchronized canonical `main`. The authorization, accepted result and provider decision are now recorded above. Phase 6, public exposure, deployment, paused SPEC-0008 and every non-Assistant product surface remain unchanged.
