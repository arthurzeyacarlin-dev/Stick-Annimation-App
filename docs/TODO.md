...
- [ ] **DATA-002 — Implement SPEC-0002 Phase 1 safe save format and storage engine.** The publication prerequisite is satisfied. After this reconciliation is separately reviewed and published, start one new Plan-mode Spec Executor task/worktree from the then-current canonical-main SHA and refresh the conflict audit before implementation. Scope is exactly the new files in SPEC-0002 §11.2; Phase 2 UI wiring remains forbidden.
