...
- [ ] **DATA-003 — Execute SPEC-0002 Phase 2 real Save/Open wiring and browser proof.** Status: **Authorized; Not started** by D-0014, published/integrated at `8062274a83776e635e8ed81d9cd2c272d068bc56`. A stopped preflight proved the former §12.8 Phase 2 manifest command targeted the frozen Phase 1-only validator. After the corrected proof contract is reviewed and separately published, one exclusive Plan-mode Spec Executor starts from that correction publication SHA, refreshes the conflict audit, and may touch only SPEC-0002 §12.2's unchanged runtime/test boundary. No overlapping executor may touch `app/page.tsx`, Drawing persistence/navigation, or shared browser proof; SPEC-0001 Phase 2 remains Unauthorized/Not started.
