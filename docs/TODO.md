...
- [x] **SPEC-002 — Review and decide lossless local Drawing Save/Reopen.** D-0013 records Arthur's exact approval of [`SPEC-0002`](specs/0002-lossless-local-drawing-save-and-reopen.md), acceptance of OD2-01 through OD2-08 exactly as written, and authorization of Phase 1 only as Not started at that decision point. D-0014 later authorized SPEC-0002 Phase 2, which is now Verified/accepted in its unpublished worktree; SPEC-0001 Phase 2 remains Unauthorized/Not started.
...
- [x] **DATA-003 — Execute SPEC-0002 Phase 2 real Save/Open wiring and browser proof.** Status: **Verified and accepted in the dedicated worktree; unpublished/unintegrated.** From exact base `e85003089e793791f9a191a56b29c1c377ef5d26`, the executor passed the clean pre-edit permanent tester, changed exactly five runtime files plus nine Phase 2 proof/fixture paths, completed all 12 receipts, the 22-step app proof at both viewports, REG-01–REG-10, TypeScript, lint non-regression, and zero-real/external-request cleanup. The independently revalidated 889-assertion technical manifest has SHA-256 `0a5ea38f8146641430d37ddc272fa0b1169181252b596e0ba14886c2bb4f2657`. Arthur and the Project Manager accepted the result; the executor stopped and the Control Plane Architect completed propagation/closeout without altering accepted bytes.
- [ ] **GIT-011 — Publish and integrate accepted SPEC-0002 Phase 2.** Publication-only next step: verify the accepted technical and closeout manifests and exact reviewed path set, commit only those bytes on the phase branch, require exact `npm run test:spec0001-browser` to pass on the clean committed HEAD before any canonical-main fast-forward or push, then integrate/push and prove clean `0/0` synchronization. Any byte drift, advanced canonical `main`, or permanent-tester failure stops without merge, rebase, force-push, or scope expansion. SPEC-0001 Phase 2 and SPEC-0003 remain unauthorized.
