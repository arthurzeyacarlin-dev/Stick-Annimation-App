...
- [ ] **GIT-005 — Publish the D-0010 role-separation control plane.** After Arthur and Project Manager review, a separate explicit instruction must authorize the Control Plane Architect to stage exactly the reviewed documentation/control-plane paths, commit, push canonical `main`, and verify clean `0/0` synchronization. No implementation or prerequisite work is part of this publication.
