...
- [ ] **DATA-003 — Execute SPEC-0002 Phase 2 real Save/Open wiring and browser proof.** Status: **Authorized; Not started** by D-0014, published/integrated at `8062274a83776e635e8ed81d9cd2c272d068bc56`. The first proof-contract correction is published/integrated at `727a1d9c8fb8fa93e40cb4484949cf499709e17e` and preserves the independent Phase 2 validator. A fresh stopped preflight proved the frozen permanent tester cannot accept a Phase 2 dirty worktree by design. After the permanent-tester compatibility correction is reviewed and separately published, one exclusive Plan-mode Spec Executor starts from that publication SHA, refreshes the conflict audit, runs `npm run test:spec0001-browser` on the clean base before editing, and may touch only SPEC-0002 §12.2's unchanged runtime/proof boundary. Its dirty proof uses the exact two Phase 2 runner modes; the publication task reruns the exact npm tester on the clean reviewed commit before integration/push. No overlapping executor may touch `app/page.tsx`, Drawing persistence/navigation, or shared browser proof; SPEC-0001 Phase 2 remains Unauthorized/Not started.
