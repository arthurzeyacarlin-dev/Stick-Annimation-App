...
Last traced: 2026-09-07 at exact clean canonical/local-tracking basis `a4589664b6857eb10a828189e177e0e7d47e3f69`: published SPEC-0005 Phase 1 and Phase 2 v1 remain runtime truth; the prior Phase 3 result is rejected; GIT-045 published D-0050; D-0051 corrects the future goal to a bounded semantic sequence and blocks Phase 2 v2 execution until GIT-046
...
- broader Stick scene/language/model behavior beyond published SPEC-0004 Phases 1–2.5; rejected motion attempts are not runtime truth, SPEC-0005 Phase 2 v1 is only the published numeric-safety foundation, corrected Phase 2 v2 is Approved but not implementation-authorized until GIT-046, and corrected Phase 3 whole-body pose behavior is unauthorized/unimplemented
