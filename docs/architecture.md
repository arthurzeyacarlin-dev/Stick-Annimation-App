...
- broader Stick scene/language/model behavior beyond published SPEC-0004 Phases 1–2.5; rejected motion attempts are not runtime truth, SPEC-0005 Phase 2 v1 is only the published numeric-safety foundation, corrected Phase 2 v2 is accepted/technically Verified under D-0053, pending separate GIT-048 publication/integration, and corrected Phase 3 whole-body pose behavior is unauthorized/unimplemented
