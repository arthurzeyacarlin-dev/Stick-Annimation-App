...
Last traced: 2026-09-25 through D-0140/GIT-100's published SPEC-0014 Phase 2 correction from `acd4031cade0e4e960223190a8c1645d007d61af`, integrated as `318566d6d20acec672c3d8c6a0e5620ad70c7d66` in canonical `main`.
...
## SPEC-0014 notification architecture — Phase 2 published/integrated under GIT-100
...
`ExportAnimationPlayer` still owns and aborts its export controller on unmount. D-0141 rejects the separate Phase 3 Export-notification/background-lifecycle proposal; this current screen-owned behavior remains unchanged and has no notification producer. Phase 4 is the next candidate for offline/reload/concurrency/dedupe/accessibility closure of the accepted two-bell Assistant/Terra system only, after its separate gates. Browser/app termination must never be misrepresented as continued export execution. Phase 2 is published in canonical main under GIT-100, but this is not a deployment or public-readiness claim.
