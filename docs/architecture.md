...
Last traced: 2026-09-07 at exact clean canonical/local-tracking basis `55b05e2daad649ac1e0027722a75762a9714d281`: published SPEC-0005 Phase 1 and Phase 2 v1 remain runtime truth; the prior Phase 3 result is rejected; GIT-045 published D-0050; D-0051 corrects the future goal to a bounded semantic sequence and was published by GIT-046; D-0052/GIT-047 resolve the later front-knee blocker before PM continuation
...
- broader Stick scene/language/model behavior beyond published SPEC-0004 Phases 1–2.5; rejected motion attempts are not runtime truth, SPEC-0005 Phase 2 v1 is only the published numeric-safety foundation, corrected Phase 2 v2 is Approved; its reported front-knee blocker is addressed by D-0052/GIT-047 before PM continuation, and corrected Phase 3 whole-body pose behavior is unauthorized/unimplemented
