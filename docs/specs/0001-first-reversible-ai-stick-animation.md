...
SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are Verified, published, and integrated. Phase 3 is published in exact canonical-main commit `3fe3a5487389647b67216e9466121e00f1a73856`, parent `b8d8406ca6b51c3b83adb29fa20f20160c871c54`, with technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Arthur accepted D-0022's narrow Phase 4 tester-permission correction and authorized Phase 4 only as **Authorized; Not started**, conditional on separate publication/integration of this decision record. Phases 5–7, the Phase 7 Policy Gate, and paid/live requests remain unauthorized and not started.
...
| 3 — Atomic history and minimal local persistence | **Verified, published, and integrated** | Every manual construction action and joint drag has exact Undo/Redo; explicit local save/reopen preserves user-authored content. One AI-sized three-pose batch remains representable as one undo entry for Phase 4 without exposing an AI path. The existing Onion control implements the exact D-0018 paused active-layer neighbor renderer. | Exact publication `3fe3a5487389647b67216e9466121e00f1a73856`; exact 30 technical plus eight record paths; technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`; Arthur visible acceptance | Complete. Phase 4 still waits for separate publication/integration of D-0022. |
| 4 — Validated editor command transaction | **Authorized; Not started; awaiting D-0022 publication/integration** | Dry-run produces a preview without mutation; Apply composes the same pure mutations as the manual path into one all-or-nothing transaction; stale/duplicate/cancel/failure cases are exact no-ops. | Phase 3 Verified/published/integrated at `3fe3a5487389647b67216e9466121e00f1a73856`; D-0022 accepted; D-0022 publication/integration required | Stop until every injected failure/idempotency fixture passes and the applied AI result content projection equals the Phase 1/3 manual result. |
...
**Status:** **Authorized; Not started; awaiting D-0022 publication/integration.** Arthur accepted the exact narrow Phase 4 tester-permission correction. Phase 4 may begin only in a new Plan-mode Spec Executor task/worktree after this D-0022 record is separately published and integrated into canonical `main`. Phase 5 remains unauthorized.
...
| Approval/status consistency | Pass for the current activation state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are published/integrated. Phase 3 is exact commit `3fe3a5487389647b67216e9466121e00f1a73856`. D-0022 authorizes Phase 4 as Not started after this record is published/integrated. Phases 5–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are Verified, published, and integrated.** Phase 3 is exact 38-path commit `3fe3a5487389647b67216e9466121e00f1a73856`, parent `b8d8406ca6b51c3b83adb29fa20f20160c871c54`, with technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. D-0022 accepts the strict 22-path Phase 4 implementation/proof ceiling and marks Phase 4 **Authorized; Not started; awaiting publication/integration of this record**. Phases 5–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: under a later explicit publication instruction, the Control Plane Architect may stage and publish only this reviewed docs/control-plane correction. After the publication commit is integrated into clean canonical `main`, one new dedicated Plan-mode Phase 4 Spec Executor task may start from that exact publication SHA and change only §10.7's 22 technical paths plus ignored proof artifacts. It must stop after its Implementation Review Packet and must not begin Phase 5, modify canonical control-plane files, or stage/commit/push.

This reviewed Phase 4 activation/correction may change only these canonical record paths:

- `docs/CURRENT_STATE.md`;
- `docs/DECISIONS.md` for D-0022;
