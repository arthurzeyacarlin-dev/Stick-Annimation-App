...
Decision links: accepted SPEC-0001 decision D-0009, permanent role-separation decision D-0010, Phase 1.5 approval decision D-0011, protected-Drawing correction decision D-0012, Phase 2-only authorization decision D-0015, Phase 1.5 compatibility-correction decision D-0016, Phase 2 visible-result correction decision D-0017, Phase 3 Stick onion-skin decision D-0018, and still-broader pending decisions P-0004, P-0005, P-0007, and P-0008 in `../DECISIONS.md`
...
Last verified branch/commit: Phase 1 corrections and renewed offline proof were completed from exact base `832d1f93630d7093514af3e81399077ebed696b4` and published in canonical-main commit `21a88feb65cf1cc51138c9ad4879b962ee468569`; D-0010 was published and integrated in `2029fd07e14b6f48feb6d04e02dbd52ec683d55d`; D-0011 was published and integrated in `a35a268764c21eedffcf3d82b59718699b62d4d0`; D-0012 was published and integrated in `3768226fd3aa3668a6cf7260da8476ceea0a084e`; Phase 1.5 was published and integrated in canonical-main implementation commit `8df64552e29e4170df8000097fe857b7a31dff69`; its six-document control-plane record was published in commit `687cbeaf6acbf9625e0d940e78bc600251eb0604`; D-0015 and the Phase 2 activation record were published in canonical-main commit `a85690de9396cf97e3063005cbb6da85f109ae1d`; D-0016 and the Phase 1.5 compatibility-correction approval were published/integrated in canonical-main commit `6c2973caecb742334fb432bdda8fbc674bb7db42`. The accepted compatibility implementation was completed from exact base/HEAD `8b663d2b80144e9aeba9ea0ecf0f78ccefa78926` and published/integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`, the verified §10.4A technical/publication prerequisite and tested runtime/proof foundation. Its technical-manifest SHA-256 is `53202d21ba7248e46a3e3423a623fbc785b5c3beedd6dd4d2a984b37614cffe8`; closeout SHA-256 is `8972c63420728183ad27454cb5484ab0859361b8fd92797f0531bdc79a773b30`. Phase 2 was implemented from exact activation base/HEAD `68338d54542bbfd3fb1f0fab06548f0424871f80` and is now **Verified, published, and integrated** in canonical-main commit `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. Its exact 36-path publication retains the 27-path prior-definition aggregate SHA-256 `d5526fcba1e0480a20164ab73d8391f49edf6fc66378d641e8b2c0c951fcabd2` over the 4,351-byte canonical binding input, the 33,410-byte proof-manifest SHA-256 `87a24054299da3037e6682bc50595fd8be3c7004222287c3433156264b322212`, and closeout-manifest SHA-256 `cfe9b5c4e695b8e4d77be3e22e94e75a9b4d264a5046a2dcbf3d4f924db125a1`.

Arthur approved this specification on 2026-08-11. OD-01 through OD-06 and OD-09 are accepted exactly as written; OD-07, OD-08, OD-10, and OD-11 are approved engineering rules/prerequisites; OD-12 through OD-14 remain deferred to the separate Phase 7 Policy Gate. That approval authorized Phase 1, which is Verified, published, and integrated into canonical `main` as of 2026-08-13. On 2026-08-14 Arthur approved the **Phase 1.5 — Permanent Automatic Browser Tester** amendment in D-0011. The first Phase 1.5 Executor attempt stopped correctly after exposing a protected Drawing Generate Frames settlement regression. D-0012 authorized the narrow diagnostic/correction ceiling, and the corrected Executor then proved the first clearing writer, retained the smallest one-file `DrawingCanvas.tsx` fix, completed the permanent tester, and produced accepted technical proof. **Phase 1.5 is Verified, published, and integrated into canonical `main` at `8df64552e29e4170df8000097fe857b7a31dff69`.** D-0015 and its activation record were published, and Phase 2 started from the resulting exact activation base `68338d54542bbfd3fb1f0fab06548f0424871f80`. D-0016 authorized the named **Phase 1.5 Compatibility Correction for Phase 2 Proof** and was published/integrated in `6c2973caecb742334fb432bdda8fbc674bb7db42`. The correction and both required clean-committed publication gates are **Verified, published, and integrated** at `e07268cc80751baba99ac6708a1e8a93d4fc4756`. **Phase 2 is Verified, published, and integrated in canonical `main` at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`.** Drawing Save was not part of the 86-action automated proof; Arthur's separate manual Save verification is recorded only as human evidence. Phases 3–7, the Phase 7 Policy Gate, and every live/paid/external request remain unauthorized and not started.

On 2026-08-18 Arthur rejected Phase 2's published visible workspace result without rewriting its historical publication. D-0017 approves §10.5A as the sole focused correction: **Approved; Authorized; Not started**. That authorization record was subsequently published/integrated in exact canonical-main commit `1f9746a6188e5e13aca1fbd62bea2e1e27bba627`, the correction executor's exact base. Phase 3 and later phases remain unauthorized.

Also on 2026-08-18, Arthur accepted the visible §10.5A implementation result and supplied its stopped-executor evidence. A later Control Plane Architect took exclusive ownership of that same dedicated worktree, revalidated the accepted bytes/evidence and fail-closed applicability audit, and propagated the closeout record. §10.5A is now **Verified and accepted in its dedicated worktree; pending separate publication/integration**. D-0018 fixes real Stick onion skin as part of Phase 3. Phase 3 remains **Unauthorized; Not started** and gains no implementation authority here.
...
SPEC-0001 remains Approved and active. Phase 1 and the historical Phase 1.5 are Verified, published, and integrated into canonical `main`; Phase 1.5's implementation commit is `8df64552e29e4170df8000097fe857b7a31dff69`, and its six-document control-plane publication record is `687cbeaf6acbf9625e0d940e78bc600251eb0604`. D-0015 authorized Phase 2 and its later activation record established exact implementation base `68338d54542bbfd3fb1f0fab06548f0424871f80`. D-0016 accepted the Phase 1.5 compatibility correction in §10.4A, which was subsequently published/integrated at exact prerequisite foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. The Phase 2 bytes remain historically published and integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, but Arthur has rejected their visible product result; D-0017 approves §10.5A as the sole correction, **Authorized; Not started**, pending separate activation publication. Drawing Save remains outside the historical Phase 2 automated coverage and is recorded separately as Arthur's human verification. Phases 3–7, the Phase 7 Policy Gate, and paid/live requests remain unauthorized and not started.
...
| Phase 2 UI Restoration and Editable Timeline Correction (§10.5A) | **Approved; Authorized; Not started** | Restore the exact `68338d…` Stick shell, start with one blank keyframe/no automatic content, and add only applicable current-Drawing-style timeline/layer behavior with independent editable Stick keyframes and restored Creator/tools. | D-0017 accepted; separate activation publication will name the exact canonical-main executor base | Stop after one Spec Executor technical packet and Arthur's visible desktop/compact review; no propagation or Git publication without later separate authority. |
| 3 — Atomic history and minimal local persistence | **Unauthorized; Not started** | Every manual construction action and joint drag has exact Undo/Redo; explicit local save/reopen preserves the human-built wave. One AI-sized three-pose batch remains representable as one undo entry for Phase 4. | §10.5A visibly accepted, propagated, separately published/integrated; separate Phase 3 owner authorization | Stop until the correction is durably integrated; then require manual action history and isolated save/reopen proof, including content digest, editing ownership, and corruption/quota safety. |
...
**Status:** **Verified, published, and integrated into canonical `main` on 2026-08-13 after corrected PM review.** D-0011 later authorized the original Phase 1.5 boundary, and D-0012 authorized its correction. Phase 1.5 is now also separately Verified/published/integrated. Phase 1 did not implement Phase 1.5 or any later phase. D-0015 later authorized Phase 2; Phase 2 is now Verified/published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. Phases 3–7 remain unauthorized and not started.
...
**Historical publication boundary:** At Control Plane Architect closeout, Phase 2 was technically Verified and accepted but remained unstaged, uncommitted, unpublished, and unintegrated until a separate explicit publication instruction succeeded. That instruction later published and integrated the exact 36-path result at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. Phase 3 remains Unauthorized/Not started.
...
**Status:** **Verified and accepted in the dedicated correction worktree; pending separate publication/integration.** D-0017's authorization was published/integrated in exact canonical-main commit `1f9746a6188e5e13aca1fbd62bea2e1e27bba627`, the correction executor's exact base. This remains one focused correction to the owner-rejected visible Phase 2 result. It is not Phase 3, does not reopen SPEC-0002, does not activate SPEC-0003, and this closeout does not authorize staging, commit, push, or publication.
...
**Status:** **Unauthorized; Not started.** It may not begin while the §10.5A correction is proposed, executing, under human review, accepted-but-unpublished, or otherwise not durably integrated. A later owner authorization in a new task/worktree is required after the correction is visibly accepted, propagated, separately published, and integrated into canonical `main`.

**Exact observable outcome:** Every Phase 2 manual construction action—hold through, insert blank, start pose, and completed joint drag—creates one exact normal history transaction with Undo/Redo. A human builds the wave without AI, saves it, hard-reloads, reopens it, and retains the Phase 1 manual `animationContentDigest`, identities, three key poses, hold ownership, any corrected joint, line-head derivation, timing, and selection. The reducer can also represent a deterministic AI-sized three-pose batch as one entry for Phase 4. In addition, the existing Phase 2 **Onion** button becomes functional: while paused and ON, the active layer may render at most one previous and one next distinct visible Stick state through the exact Drawing neighbor/tint behavior defined below, without canonical mutation.
...
- `src/components/workspace/stickfigure/StickFigureWorkspace.tsx`;
- `src/components/workspace/stickfigure/StickFigureCanvas.tsx`, only for the transient non-interactive onion overlay renderer described here;
- `src/components/workspace/stickfigure/StickFigureTopBar.tsx`;
...
The phase may invoke but not modify the integrated Phase 1.5 tester core or Phase 2 tester extension; it may add only the two named Phase 3 extension files. Onion neighbor resolution and rendering must remain within the already authorized `StickFigureWorkspace.tsx` and `StickFigureCanvas.tsx`; another Stick runtime file requires return to the Spec Architect. No Drawing runtime, Next route, or temporary product surface is authorized.
...
9. Wire the existing Onion button to one transient renderer path shared by fresh human-authored, later AI-authored, fixture-mounted, and reopened Stick documents. The toggle and overlays remain outside canonical document/history/storage/digest/AI context. Turning Onion OFF or starting playback clears both overlays immediately; pausing does not show them again unless Onion remains ON.
...
**Systems intentionally unchanged:** Drawing onion resolver/renderer/tint strings and all Drawing storage/data/memory/Supabase/UI/AI/history bytes; API routes; OpenAI utilities; Creator Save/schema; package/dependencies; deployment/security settings.
...
| --- | --- | --- |
| §10.5A accepted implementation closeout | Pass; Verified/accepted in worktree, pending publication | Arthur accepted the visible result. The Control Plane Architect verified the exact 20-path state, empty index, accepted hashes, registered 15/15 actions, two compact screenshots, five protected groups, deterministic/type/lint/diff receipts, and revalidated manifest SHA-256 `edda3028b9fbe2759e31059455f16cc3ee02ac9b242149107454071dae62de90`. No publication/integration is claimed. |
...
| Phase 3 Stick onion contract | Specified only; Unauthorized/Not started | D-0018 fixes exact Drawing tints, nearest-distinct active-layer neighbors, hold skipping, blank boundaries, duplicate collapse, playback/OFF suppression, non-interactivity, no canonical mutation, origin-independent rendering, and Drawing byte preservation. No runtime/test/proof implementation ran in this task. |
...
| Phase 2 UI-correction implementation and acceptance | Pass; Verified and accepted in dedicated worktree | §14.14 records exclusive takeover, exact 20-path hash freeze, independent manifest revalidation, zero protected-runtime diff, Arthur/Project Manager acceptance, and canonical control-plane propagation. Git publication/integration remains a future separately authorized gate. |
...
| Approval/status consistency | Pass for accepted closeout state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and the original Phase 2 bytes remain published/integrated; the original Phase 2 visible result is owner-rejected. The §10.5A correction is Verified/accepted in its dedicated worktree and pending separate publication/integration. D-0018 changes no authorization: Phases 3–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Decision D-0009 records the original product/phase approval boundary: OD-01–OD-06 and OD-09 are accepted exactly; OD-07/08/10/11 are approved engineering rules/prerequisites; OD-12–OD-14 are explicitly deferred and unaccepted until the Phase 7 Policy Gate. D-0010 supersedes only OD-10's former combined executor/control-plane mechanics and is published at `2029fd07e14b6f48feb6d04e02dbd52ec683d55d`. D-0011 accepts the Phase 1.5 packaging and original tester boundary. D-0012 accepts the conditional two-file protected-Drawing correction ceiling; the corrected implementation stayed inside it and was subsequently accepted through the D-0010 review lifecycle. D-0015 authorized Phase 2 as Not started; that authorization was later activated, and Phase 2 is now Verified/published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. D-0016 accepts the exact §10.4A Phase 1.5 compatibility correction and is published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`; implementation and both clean committed gates are Verified/published/integrated at `e07268cc80751baba99ac6708a1e8a93d4fc4756`. D-0017 governs the unpropagated §10.5A correction. D-0018 fixes Phase 3 Stick onion-skin behavior without authorizing Phase 3. No decision or technical acceptance authorizes Phases 3–7, the Phase 7 Policy Gate, an external lookup, or a paid/live request.
...
Final spec status is **Approved** and active. **Phase 1 and historical Phase 1.5 remain Verified, published, and integrated.** The §10.4A compatibility correction remains Verified/published/integrated at exact prerequisite foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. The original Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, with their original proof hashes preserved, but Arthur rejected their visible product result. The D-0017 §10.5A correction is **Verified and accepted in its dedicated worktree; pending separate publication/integration**. D-0018 fixes the future Stick onion-skin contract. Phase 3 and Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: under a separate explicit publication instruction only, stage the exact accepted 20 implementation/proof paths, accepted one-file correction finalizer repair, seven reviewed canonical Markdown paths, and deterministic `project/project_structure.txt` regeneration (29 total paths), commit on the correction branch, fast-forward a still-clean canonical `main`, push, and verify synchronization. If canonical `main` advanced or any reviewed byte differs, stop without pull, merge, rebase, force-push, or scope expansion. Phase 3 may not be planned, dispatched, or implemented first.

This approval-recording task may change only these canonical record paths:
...
- `project/project_structure.txt` through `bash scripts/update_memory.sh` only if deterministic tree content changes.

Arthur's correction instruction remains recorded as D-0017; the proof-applicability boundary and Phase 3 onion direction are recorded by this amendment and D-0018. `AGENTS.md`, `docs/PROJECT_MANAGER_CONTEXT.md`, all runtime/fixture/test/proof bytes, product/package/configuration bytes, SPEC-0002, the separate SPEC-0003 worktree, and recovery material are preserved exactly. Every later task must establish exact current Git state rather than infer a future HEAD from this specification.
