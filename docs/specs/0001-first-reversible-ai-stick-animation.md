...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. D-0020 kept that authorization and D-0018 unchanged, added the required versioned tester registration ceiling, superseded the rejected Creator-lock requirements, and made the published §10.5A shell/manual timeline the exact Phase 3 baseline. Phase 3 is now **Verified, published, and integrated** at `3fe3a5487389647b67216e9466121e00f1a73856`. D-0022's Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 records acceptance of the exact implementation. Phase 4 is **Verified, published, and integrated** at `71841e96499f7627139c53d87114bba65e19d29d`. D-0024 now authorizes Phase 5 only as **Authorized; Not started**; Phases 6 and 7 remain **Unauthorized; Not started**.
...
**Status:** **Authorized; Not started** through D-0024. Phase 4 is Verified/published/integrated. Phase 5 may begin only after this activation record is separately published and integrated, in one brand-new dedicated Plan-mode Spec Executor task/worktree from that exact publication SHA.
