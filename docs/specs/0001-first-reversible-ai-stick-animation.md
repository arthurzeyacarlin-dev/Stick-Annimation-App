...
Arthur approved this specification on 2026-08-11. OD-01 through OD-06 and OD-09 are accepted exactly as written; OD-07, OD-08, OD-10, and OD-11 are approved engineering rules/prerequisites; OD-12 through OD-14 remain deferred to the separate Phase 7 Policy Gate. That approval authorized Phase 1, which is Verified, published, and integrated into canonical `main` as of 2026-08-13. On 2026-08-14 Arthur approved the **Phase 1.5 — Permanent Automatic Browser Tester** amendment in D-0011. The first Phase 1.5 Executor attempt stopped correctly after exposing a protected Drawing Generate Frames settlement regression. D-0012 authorized the narrow diagnostic/correction ceiling, and the corrected Executor then proved the first clearing writer, retained the smallest one-file `DrawingCanvas.tsx` fix, completed the permanent tester, and produced accepted technical proof. **Phase 1.5 is Verified, published, and integrated into canonical `main` at `8df64552e29e4170df8000097fe857b7a31dff69`.** D-0015 and its activation record are published in `a85690de9396cf97e3063005cbb6da85f109ae1d`, so Phase 2 remains **Authorized; Not started**. D-0016 authorized the named **Phase 1.5 Compatibility Correction for Phase 2 Proof** and was published/integrated in `6c2973caecb742334fb432bdda8fbc674bb7db42`. The correction and both required clean-committed publication gates are now **Verified, published, and integrated** at `e07268cc80751baba99ac6708a1e8a93d4fc4756`. They change proof infrastructure only and explicitly do not claim product Phase 2 or Drawing Save coverage. Phase 2 becomes dispatchable only after this activation record is separately reviewed, published, and integrated; the exact executor checkout will be that resulting clean canonical-main activation-publication commit, resolved by the later publication report and copied into the executor handoff. Phases 3–7, the Phase 7 Policy Gate, and every live/paid/external request remain unauthorized and not started.
...
| 2 — Independent per-frame Stick state | **Authorized; Not started** | Home → New → Stick visibly supplies the built-in figure, and the user creates the complete three-pose/12-frame wave without AI using the bounded hold/blank/start-pose controls; all 11 joints, playback, holds, and gesture boundaries use independent canonical poses. | Phase 1.5 and §10.4A Verified/published/integrated; D-0015 activation published; this seven-file activation must be separately reviewed/published/integrated | Stop before any Phase 2 byte until the activation publication report resolves the resulting clean canonical-main commit SHA and copies it exactly into a new Plan-mode Phase 2 executor handoff; after main advances, do not use `e07268c`. Then stop until the real no-AI manual construction flow matches the Phase 1 manual content digest and all-11-role isolation, rendering, playback, held-frame, and gesture proof passes. |
...
**Non-goals and stop gate:** No runtime/UI/product behavior, Phase 2 implementation, historical evidence rewrite, package/dependency/configuration/environment/database change, new product/dev route, public asset, broad browser framework, external lookup, provider/search/Supabase request, paid service, or deployment is part of this correction. The accepted result contains no product byte, broader route/network/filesystem/storage/evaluation authority, weaker default suite/recovery/temporary-restoration/production-exclusion rule, unlisted path, v1 evidence rewrite, lint regression, or residual process/profile/port/build/anchor byte. Product Phase 2 and Drawing Save were not tested; Arthur's manual Save verification is separate evidence. Phase 2 becomes dispatchable only after this activation record is separately reviewed, published, and integrated.

### 10.5 Phase 2 — Independent per-frame Stick state

**Status:** **Authorized; Not started.** D-0015 supplies the owner authorization and its activation record is published/integrated at `a85690de9396cf97e3063005cbb6da85f109ae1d`. D-0016's approval is published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`, and the §10.4A correction plus both clean committed publication gates are Verified/published/integrated at exact prerequisite and tested runtime/proof foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Product Phase 2 has not been implemented or tested. Phase 2 becomes dispatchable only after this activation record is separately reviewed, published, and integrated. The exact executor checkout SHA is the resulting clean canonical-main activation-publication commit, resolved by the later publication report and copied exactly into the new Plan-mode executor handoff; after canonical main advances, the executor must not use `e07268c`.
...
- Publication and activation state: the later publication task preserved the accepted implementation bytes, passed both clean committed tester gates, and published/integrated the correction in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. This seven-file activation record is a later unstaged/unpublished Control Plane Architect reconciliation. Phase 2 remains Authorized/Not started and becomes dispatchable only after this activation is separately reviewed/published/integrated and its resulting canonical-main commit SHA is copied into a new Plan-mode executor handoff. Phases 3–7 remain Unauthorized/Not started.
...
- Dispatch rule: Phase 2 remains Authorized/Not started and becomes dispatchable only after this exact seven-file activation record is separately reviewed, published, and integrated. The later publication report resolves the resulting clean canonical-main activation-publication commit SHA and copies it exactly into the new Plan-mode executor handoff. After canonical main advances, the executor must not use `e07268c`; no document invents the future commit's SHA and no extra self-naming activation commit is required.
...
| Approval/status consistency | Pass | SPEC-0001 remains Approved and active. OD-01–OD-06 and OD-09 are accepted; OD-07/08/10/11 retain their accepted safety/process boundary; OD-12–OD-14 remain deferred. Phase 1, historical Phase 1.5, and §10.4A are Verified/published/integrated; §10.4A exact publication foundation is `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Phase 2 remains Authorized/Not started and is not dispatchable until this activation record is separately published/integrated; product Phase 2 was not implemented or tested. Phases 3–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1 and historical Phase 1.5 are Verified, published, and integrated into canonical `main`; Phase 1.5 publication commit is `8df64552e29e4170df8000097fe857b7a31dff69`, accepted technical proof-manifest SHA-256 is `da2dd8cff32367a548a2e7d2e4e789fcf1a4dd129e9dc6200e25650f586f9fc9`, and closeout SHA-256 is `d7d74d9a48e31f997ed772625cc75be53a7d408b96fe093023b50c793c421423`.** D-0015 and the Phase 2 authorization record are published at `a85690de9396cf97e3063005cbb6da85f109ae1d`. D-0016 and the compatibility-correction approval are published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`. The §10.4A correction and both clean committed publication gates are **Verified, published, and integrated** at exact prerequisite and tested runtime/proof foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Its accepted manifest SHA-256 is `53202d21ba7248e46a3e3423a623fbc785b5c3beedd6dd4d2a984b37614cffe8`; closeout SHA-256 is `8972c63420728183ad27454cb5484ab0859361b8fd92797f0531bdc79a773b30`. It proves compatibility infrastructure and synthetic Phase-2-shaped actions only. Product Phase 2 is **Authorized; Not started** and was not implemented or tested. Phases 3–7 remain **Unauthorized; Not started**.

Exact next step: Arthur and the Project Manager review this seven-file Control Plane Architect activation packet, then issue a separate explicit publication-only instruction. That later task may stage only the reviewed seven documentation paths and may publish/integrate only if canonical `main` remains clean and unchanged at `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Its publication report must resolve the resulting clean canonical-main activation-publication commit SHA and copy it exactly into the new Plan-mode Phase 2 executor handoff. The executor becomes dispatchable only after that publication/integration and must not start from `e07268c` after main advances. No document preclaims the future commit's own SHA, and no extra activation commit is required. This control-plane task starts neither publication nor Phase 2. Phases 3–7, the Phase 7 Policy Gate, every external lookup, and any paid/live request remain forbidden.

The historical six-document Phase 1.5 record remains published in `687cbeaf6acbf9625e0d940e78bc600251eb0604`. This activation changes exactly these seven control-plane paths:
