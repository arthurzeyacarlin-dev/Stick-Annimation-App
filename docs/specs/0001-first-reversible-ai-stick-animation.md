...
Decision links: accepted SPEC-0001 decision D-0009, permanent role-separation decision D-0010, Phase 1.5 approval decision D-0011, protected-Drawing correction decision D-0012, Phase 2-only authorization decision D-0015, Phase 1.5 compatibility-correction decision D-0016, Phase 2 visible-result correction decision D-0017, and still-broader pending decisions P-0004, P-0005, P-0007, and P-0008 in `../DECISIONS.md`
...
On 2026-08-18 Arthur rejected Phase 2's published visible workspace result without rewriting its historical publication. D-0017 approves §10.5A as the sole focused correction: **Approved; Authorized; Not started**. Its implementation base remains unset until this activation record is separately published and integrated. Phase 3 and later phases remain unauthorized.
...
**Status:** **Approved; Authorized; Not started** through D-0017. This is one focused correction to the owner-rejected visible Phase 2 result. It is not Phase 3, does not reopen SPEC-0002, does not activate SPEC-0003, and this control-plane task does not begin implementation or authorize propagation, staging, commit, push, or publication. A later activation publication must name its own resulting canonical-main SHA as the exact implementation base before one Plan-mode Spec Executor may begin.
...
| Phase 2 UI-correction implementation and acceptance | Not run / Not started | §10.5A is Approved/Authorized/Not started through D-0017. Activation publication, deterministic isolation tests, desktop/compact historical pixel/layout comparison, permanent tester correction plan, protected flows, manifest, Arthur visible review, control-plane propagation, and Git publication remain required future gates. |
...
| Approval/status consistency | Pass for this activation state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and the original Phase 2 bytes remain published/integrated; the original Phase 2 visible result is now owner-rejected. D-0017 records §10.5A as Approved/Authorized/Not started pending separate activation publication. Phases 3–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1 and historical Phase 1.5 remain Verified, published, and integrated.** The §10.4A compatibility correction remains Verified/published/integrated at exact prerequisite foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. The original Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, with their original proof hashes preserved, but Arthur has rejected their visible product result. D-0017 records §10.5A as the sole **Approved; Authorized; Not started** correction. Phase 3 and Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: review this Control Plane Architect packet, then issue a separate publication-only instruction for the exact approval record. The resulting canonical-main publication SHA becomes the implementation base. Only after that publication may one new Plan-mode Spec Executor implement this correction and stop for Arthur's visible review. Phase 3 may not be planned or dispatched first.
