...
Last verified branch/commit: this D-0028 docs-only correction began from exact clean canonical-main commit `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`, parent `da7c258078a0240da32018b9ecfa7f33ae27d5ac`, message `Authorize SPEC-0001 Phase 6 typo-friendly prompts`. That commit published D-0027's exact seven-document activation. Phase 1 through Phase 5 retain their recorded published commits and proof. The corrected exact 22-path Phase 5 result plus eight reviewed records remain published and integrated in commit `9bbcc1df2fe4c79c0947601d0ea6274a85732d85`, parent `a2b4f3e0fc492df9cd63bda32554e382a344cdb6`, message `Implement SPEC-0001 Phase 5 raw Stick dispatch`. Proof-manifest SHA-256 is `f9024a5d86cc1febbac7df3d4219348cd8289d17723406bac5d90929d4cf5c0f`; pre-publication closeout-manifest SHA-256 is `fd71afec8e637bb3736a63dbbe245c6616e14a4330b91f7e354297d96c2c24dd`.

Arthur approved this specification on 2026-08-11. OD-01 through OD-06 and OD-09 are accepted, with D-0027 superseding only OD-01's former exact-sentence prompt boundary and D-0028 correcting Phase 6's visible review outcome; OD-07, OD-08, OD-10, and OD-11 are approved engineering rules/prerequisites; OD-12 through OD-14 remain deferred to the separate Phase 7 Policy Gate. Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, Phase 4, and Phase 5 are Verified, published, and integrated. D-0027's Phase 6 activation is published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. Arthur rejected the first unpublished Phase 6 review copy, so Phase 6 is **Approved; Authorized; correction required** and no Phase 6 runtime is accepted, Verified, published, or present on canonical `main`. Phase 7, the Phase 7 Policy Gate, and every live/paid/external request remain unauthorized and not started.
...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. D-0020 kept that authorization and D-0018 unchanged, added the required versioned tester registration ceiling, superseded the rejected Creator-lock requirements, and made the published §10.5A shell/manual timeline the exact Phase 3 baseline. Phase 3 is now **Verified, published, and integrated** at `3fe3a5487389647b67216e9466121e00f1a73856`. D-0022/D-0023 govern the published Phase 4 result at `71841e96499f7627139c53d87114bba65e19d29d`. D-0024/D-0025 authorized and bounded Phase 5; D-0026 accepted its exact 22-path technical result, now published and integrated at `9bbcc1df2fe4c79c0947601d0ea6274a85732d85`. D-0027's Phase 6 activation is published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. D-0028 records Arthur's rejection of the first unpublished review copy and supersedes only Phase 6's visible panel/proof requirements. Phase 6 remains **Approved; Authorized; correction required**; Phase 7 remains **Unauthorized; Not started**.
...
SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, Phase 4, and Phase 5 are Verified, published, and integrated. D-0027's Phase 6 activation is published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`; D-0028 records Arthur's rejection of the first unpublished review copy and the corrected visible outcome. Phase 6 is **Approved; Authorized; correction required**, with no accepted or published runtime. Phase 7, the Phase 7 Policy Gate, and paid/live requests remain **Unauthorized; Not started**.
...
**Status:** **Approved; Authorized; correction required.** D-0027's exact seven-document activation is already published/integrated at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. Arthur rejected the first unpublished Phase 6 review copy in the separate executor worktree. That copy is not accepted, Verified, published, or present on canonical `main`. After D-0028's reviewed correction is published, Phase 6 returns to one separately authorized Plan-mode Spec Executor correction task under D-0010/D-0021; it does not become a new implementation phase.
...
| D-0028 Control Plane Architect closeout | Pass; pending separate publication | Arthur and the Project Manager accepted the seven-document correction. The Control Plane Architect independently confirmed exact base/scope, canonical source feasibility, D-0028/D-0027 supersession limits, maximum 26-path authorization, protected immutable systems, and Phase 6/7 lifecycle consistency without inspecting the rejected executor bytes. |
| D-0028 visual/browser acceptance | Not performed; future Phase 6 correction gate | No app was run and no rejected implementation was inspected in this docs-only task. The required future proof is exact: initial panel/absence assertions; Preview/Cancel empty geometry/pixels; Apply keyframe/hold current-figure DOM/geometry/pixels; exact purple/green onion neighbor DOM/color pixels; dual-viewport strict visual masks; protected Drawing/Creator/fat-frame regressions; and zero egress. |
...
| Approval/status consistency | Pass for current accepted implementation state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, Phase 4, and Phase 5 are published/integrated. The exact 22-path Phase 5 result plus eight reviewed records were published at `9bbcc1df2fe4c79c0947601d0ea6274a85732d85`; D-0027's Phase 6 activation was published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. Arthur rejected the first unpublished Phase 6 review copy, so Phase 6 is Approved/Authorized/correction required with no accepted/published runtime. Phase 7 remains Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, Phase 4, and Phase 5 are Verified, published, and integrated.** Phase 5 was published in exact commit `9bbcc1df2fe4c79c0947601d0ea6274a85732d85`, parent `a2b4f3e0fc492df9cd63bda32554e382a344cdb6`, with corrected exact 22-path technical-manifest SHA-256 `f9024a5d86cc1febbac7df3d4219348cd8289d17723406bac5d90929d4cf5c0f` and pre-publication closeout-manifest SHA-256 `fd71afec8e637bb3736a63dbbe245c6616e14a4330b91f7e354297d96c2c24dd`; 362 source assertions, 31 guarded real-route cases, 12 receipts, 53 artifacts, inherited regressions, EOF/UTF-8/whitespace, zero-egress, and cleanup passed. D-0027's typo-friendly Phase 6 activation was published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. D-0028 records Arthur's rejection of the first unpublished review copy and requires the corrected original panel, user-first reveal sequence, Cancel-empty result, visible applied figure/holds/onion, and strict visual proof. Phase 6 is **Approved; Authorized; correction required**; no Phase 6 runtime is accepted, Verified, published, or on canonical `main`. Phase 7 remains **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: under a later explicit publication-only instruction, publish/integrate exactly these seven reviewed D-0028 records. Only after that correction is on canonical `main` may a separately authorized Phase 6 Spec Executor correction task resume the rejected unpublished implementation under D-0010/D-0021 from the exact resulting canonical-main SHA. This task does not inspect or change that executor worktree and does not start implementation.
...
Arthur's published shell correction remains recorded as D-0017; D-0018 remains the exact onion contract; D-0019/D-0020 govern Phase 3; D-0022/D-0023 govern Phase 4; D-0024/D-0025 authorize and bound Phase 5; D-0026 accepts its exact technical result; D-0027 is the published Phase 6 typo-friendly activation; and D-0028 governs its rejected-review correction. `project/project_structure.txt` may change only through deterministic `bash scripts/update_memory.sh`. `AGENTS.md`, `docs/PROJECT_MANAGER_CONTEXT.md`, all accepted technical/proof bytes, package/configuration bytes, SPEC-0002, the separate SPEC-0003 worktree, the rejected Phase 6 worktree, and recovery material remain preserved. Every later task must establish exact current Git state rather than infer a future HEAD from this specification.
