...
| D-0033/D-0035 Phase 7 transition | Pass for this docs-only transition | The preceding approval/status row is retained historical evidence. D-0033 preserves Phase 1–6 and retires old Phase 7/its Policy Gate; D-0034 records the complete direction; D-0035 approves and authorizes only SPEC-0004 Phase 1, which is not started. Old Phase 7 must not be implemented. |
...
No row below was accepted. D-0033 retires the former Phase 7 Policy Gate, so these rows are no longer pending SPEC-0001 gates and cannot be implemented or accepted piecemeal. D-0034 captures the replacement direction in SPEC-0004; D-0035 authorizes only its Phase 1, while its named later owner gates remain separate and closed.
...
- **SPEC-0004 — One-Time Stick Figure AI Animator** is the only requirements home for the design that replaces the retired SPEC-0001 Phase 7. D-0035 approves and authorizes only its unchanged Phase 1; it is not started, and Phases 2–8 carry no implementation authorization today.
...
Exact next step: one dedicated SPEC-0004 Phase 1 Spec Executor starts in Plan mode under D-0035, re-verifies its clean canonical basis, exclusive worktree, empty index, and exact Phase 1 scope, implements/proves only that phase, and stops. SPEC-0004 is approved only for Phase 1; Phases 2–8 remain unauthorized.
