...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. Arthur's later explicit correction keeps that authorization and D-0018 unchanged, adds the required versioned tester registration ceiling, supersedes the rejected Creator-lock requirements, and makes the published §10.5A shell/manual timeline the exact Phase 3 baseline. Phase 3 is **Authorized; Not started** pending publication of this corrected record. Phases 4–7 remain **Unauthorized; Not started**, and no Phase 3 runtime, fixture, test, or proof work begins in this correction task.
...
**Status:** **Authorized; Not started.** D-0019 remains the Phase 3 authorization, and D-0020 accepts this corrected implementation/proof boundary. The first Phase 3 Spec Executor completed the mandatory boot and live trace, proved the tester-registration blocker below, changed no repository file, and stopped before implementation. Arthur's accepted outcome supersedes the older §10.6 Creator-lock requirements and confirms that Phase 3 adds only Stick Undo/Redo, local Save/Open, and D-0018 onion skin to the published §10.5A editor. This accepted corrected record must be published and integrated before a replacement Phase 3 Spec Executor starts. Phases 4–7 remain **Unauthorized; Not started**.
...
**Dependencies and live feasibility finding:** §10.5A is Verified/published/integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`; the current authorization base is clean canonical `main` `45504214dffb528e930194b93fc2ab78dc730ebc`; D-0018 remains exact; D-0019 authorizes Phase 3 only. Fresh tracing at that base proved the permanent extension catalog contains exactly `phase-1.5-compatibility-synthetic/v1` and `phase-2/v1`; its closed schemas, typed contract, runner dispatch, recorder, and validator cannot represent or execute Phase 3. The former read-only tester-core ceiling therefore made §10.6 proof impossible. This is one bounded engineering correction inside the existing authorized Phase 3, not another product phase or prerequisite phase.
...
1. Before its first edit, the replacement Spec Executor records passing baseline receipts for the legacy no-plan suite, the registered Phase 1.5 synthetic plan, and the registered Phase 2 plan from exact clean `45504214dffb528e930194b93fc2ab78dc730ebc`.
...
| Phase 3 tester-registration/Creator correction | Accepted control-plane correction; no implementation | Fresh live trace at `45504214dffb528e930194b93fc2ab78dc730ebc` proves Phase 3 is absent from the two-entry catalog, closed schemas/types, runner dispatch, recorder, and validator. D-0020 accepts corrected §10.6's exact additive registration ceiling, old-mode protection, removal of all current Phase 3 lock fields/assertions/copy, D-0018/Drawing preservation, and two-viewport shell non-regression. Phase 3 remains Authorized/Not started pending publication; Phases 4–7 remain Unauthorized. |
...
| Approval/status consistency | Pass for current correction state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and the original Phase 2 bytes remain published/integrated; the original Phase 2 visible result is owner-rejected. The §10.5A correction is Verified/published/integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 remains exact, D-0019 marks Phase 3 Authorized/Not started, D-0020 accepts the corrected tester/Creator boundary pending publication, and Phases 4–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1 and historical Phase 1.5 remain Verified, published, and integrated.** The §10.4A compatibility correction remains Verified/published/integrated at exact prerequisite foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. The original Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, with their original proof hashes preserved, but Arthur rejected their visible product result. The D-0017 §10.5A correction is **Verified, published, and integrated** at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 remains the exact accepted Stick onion-skin contract. D-0019 marks Phase 3 **Authorized; Not started**; D-0020 accepts the exact tester-registration/Creator-preservation correction pending publication. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: review this correction packet, then separately publish/integrate only the reviewed documentation/control-plane correction. After that publication, start one replacement dedicated Phase 3 Spec Executor task in Plan mode from the correction publication's exact clean canonical-main SHA. It may implement only corrected §10.6, including D-0018 unchanged and the exact additive tester ceiling, and must stop after its technical proof manifest and Implementation Review Packet. It may not update canonical control-plane files, stage, commit, merge, push, publish, deploy, or begin Phase 4.
