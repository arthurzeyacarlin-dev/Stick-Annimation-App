...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. D-0020 kept that authorization and D-0018 unchanged, added the required versioned tester registration ceiling, superseded the rejected Creator-lock requirements, and made the published §10.5A shell/manual timeline the exact Phase 3 baseline. Phase 3 is now **Verified, published, and integrated** at `3fe3a5487389647b67216e9466121e00f1a73856`. D-0022's Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 records acceptance of the exact implementation. Phase 4 is **Verified, published, and integrated** at `71841e96499f7627139c53d87114bba65e19d29d`. D-0024 authorizes Phase 5 only as **Authorized; Not started**, and D-0025 adds only its exact proof-feasibility ceiling; Phases 6 and 7 remain **Unauthorized; Not started**.
...
| 5 — Server raw-dispatch and mocked boundary | **Authorized; Not started** | Marked availability and mock POST work through a guarded real `/api/ai`; malformed/oversized Stick intent fails before Drawing, while marker-free Drawing reaches the original unread path; no editor/UI mutation is possible. | Phase 4 Verified/published/integrated; Phase 1.5 tester/server-egress/tester-only-offline-font boundary Verified/published/integrated; D-0024 activation published at `245ac7e8bceeca76b522ff21c4327fa0219a3805`; D-0025 proof-feasibility correction must be separately published before replacement execution | Stop until the exact 24-path ceiling is available and off/mock availability, strict raw routing, real-route fallthrough, mock envelope, and zero-egress/no-editor proof pass; then stop for Arthur's one-time review of the exact unpublished app copy before acceptance. |
...
**Status:** **Authorized; Not started** through D-0024. The activation record is published at exact canonical-main commit `245ac7e8bceeca76b522ff21c4327fa0219a3805`. A fresh Phase 5 Spec Executor completed the mandatory boot from that clean SHA and stopped before edits because the mandatory `phase-5/v1` permanent-tester proof was not representable by the Phase-4-closed tester graph. D-0025 corrects only that proof-feasibility contradiction. Replacement execution may begin only after this correction record is separately published and integrated, in one brand-new dedicated Plan-mode Spec Executor task/worktree from that correction-publication SHA.
...
| Approval/status consistency | Pass for current correction state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, and Phase 4 are published/integrated. D-0022's Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 accepts Phase 4; and exact publication is `71841e96499f7627139c53d87114bba65e19d29d`. D-0024's Phase 5 activation is published at `245ac7e8bceeca76b522ff21c4327fa0219a3805`. The first clean executor stopped without edits on the tester-registration blocker. D-0025 keeps Phase 5 Authorized/Not started and permits only the exact 10-path additive tester correction within the exact 24-path Phase 5 ceiling after separate publication. Phases 6 and 7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, and Phase 4 are Verified, published, and integrated.** Under D-0023, the exact 22 technical plus eight reviewed canonical record paths for Phase 4 are published in `71841e96499f7627139c53d87114bba65e19d29d`, parent `62f046adff7418d2e644365fc04bd5d6312dcca9`. Technical-manifest SHA-256 is `d34d589373713ac7930984aeb3ef0640539316c00e1f510cf8d798aee931bf46` and runner SHA-256 is `353f4937972d30b1959f1c7aee3075f5ebafb308d04a778db69372969e7b906f`. D-0024's seven-document activation record is published at `245ac7e8bceeca76b522ff21c4327fa0219a3805`. D-0025 keeps Phase 5 **Authorized; Not started** and corrects only its permanent-tester permission ceiling. Phases 6 and 7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: separately publish and integrate this D-0025 proof-feasibility correction. Its resulting canonical-main SHA becomes the exact base for one brand-new dedicated Plan-mode replacement Phase 5 Spec Executor task/worktree. That executor may implement only section 10.8's exact 24 technical paths, must return its Implementation Review Packet, and must stop. The Project Manager then gives Arthur the exact unpublished app copy once to confirm the existing visible app remains unchanged while automated proof verifies the hidden mock route. This record does not authorize Git publication, a writable Stick chat/UI, a live/paid/external request, deployment, Phase 6, or Phase 7.

This Phase 5 tester-permission correction changes only these canonical record paths:

- `docs/CURRENT_STATE.md`;
- `docs/DECISIONS.md` for D-0025;
...
Arthur's published shell correction remains recorded as D-0017; D-0018 remains the exact onion contract; D-0019 records Phase 3 authorization; D-0020 records the accepted tester/Creator correction; D-0022 records Phase 4 authorization and its strict proof-feasibility ceiling; D-0023 records Phase 4 acceptance and publication history; D-0024 authorizes only Phase 5's unchanged section 10.8 provider-free server/mock product boundary; and D-0025 adds only the exact 10-path route-only tester ceiling needed to prove it. `project/project_structure.txt` may change only through deterministic `bash scripts/update_memory.sh`. `AGENTS.md`, `docs/PROJECT_MANAGER_CONTEXT.md`, all accepted technical/proof bytes, package/configuration bytes, SPEC-0002, the separate SPEC-0003 worktree, and recovery material remain preserved. Every later task must establish exact current Git state rather than infer a future HEAD from this specification.
