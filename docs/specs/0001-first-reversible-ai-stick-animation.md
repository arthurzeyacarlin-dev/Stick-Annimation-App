...
Arthur approved this specification on 2026-08-11. OD-01 through OD-06 and OD-09 are accepted exactly as written; OD-07, OD-08, OD-10, and OD-11 are approved engineering rules/prerequisites; OD-12 through OD-14 remain deferred to the separate Phase 7 Policy Gate. Phase 1, historical Phase 1.5, §10.4A, and §10.5A are Verified, published, and integrated. D-0018 remains the exact Stick onion contract; D-0019 authorizes Phase 3; and D-0020's exact boundary is published at `54234b7c7b95201e274975a804859fa9c36806a1`. After the bounded proof correction, Arthur completed visible human review and accepted the exact 30-path Phase 3 result. Phase 3 is now **accepted and technically Verified in its dedicated worktree; pending separate publication/integration** with technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Phases 4–7, the Phase 7 Policy Gate, and every live/paid/external request remain unauthorized and not started.
...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. D-0020 keeps that authorization and D-0018 unchanged, adds the required versioned tester registration ceiling, supersedes the rejected Creator-lock requirements, and makes the published §10.5A shell/manual timeline the exact Phase 3 baseline. That correction is published/integrated at `54234b7c7b95201e274975a804859fa9c36806a1`. Arthur has accepted the exact Phase 3 result after visible review; it is **technically Verified in its dedicated worktree and pending separate publication/integration** with manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Phases 4–7 remain **Unauthorized; Not started**.
...
SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and §10.5A are Verified, published, and integrated. D-0018 remains the exact accepted Phase 3 onion contract, D-0019 authorizes Phase 3, and D-0020's exact tester/Creator correction is published/integrated at `54234b7c7b95201e274975a804859fa9c36806a1`. Arthur accepted the exact 30-path Phase 3 result after visible review. Phase 3 is technically Verified in its dedicated worktree and pending separate publication/integration with manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Phases 4–7, the Phase 7 Policy Gate, and paid/live requests remain unauthorized and not started.
...
| 3 — Atomic history and minimal local persistence | **Accepted and technically Verified in dedicated worktree; pending publication/integration** | Every manual construction action and joint drag has exact Undo/Redo; explicit local save/reopen preserves user-authored content. One AI-sized three-pose batch remains representable as one undo entry for Phase 4 without exposing an AI path. The existing Onion control implements the exact D-0018 paused active-layer neighbor renderer. | Exact base/HEAD `54234b7c7b95201e274975a804859fa9c36806a1`; exact 30 accepted paths; technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`; Arthur visible acceptance | Publish/integrate only under a later explicit instruction and pass the clean four-suite gate. Phase 4 remains Unauthorized/Not started. |
...
**Status:** **Accepted and technically Verified in its dedicated worktree; pending separate publication/integration.** D-0019 remains the Phase 3 authorization, and D-0020's corrected implementation/proof boundary is published/integrated at exact base `54234b7c7b95201e274975a804859fa9c36806a1`. The proof-only executor corrected the stale Drawing-memory validator inside the exact authorized 30-path ceiling, reran the full recorder, independently validated the fresh manifest, returned its packet, and stopped. Arthur completed visible human review and accepted the result. Technical-manifest SHA-256 is `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Phase 3 adds only Stick Undo/Redo, local Save/Open, and D-0018 onion skin to the published §10.5A editor. No implementation is published/integrated yet. Phases 4–7 remain **Unauthorized; Not started**.
...
- Control-plane boundary: canonical `main` advanced after the Phase 3 base to documentation-only proof-blocker record `b8d8406ca6b51c3b83adb29fa20f20160c871c54`. This closeout carries that record forward but does not stage, commit, merge, rebase, push, publish, deploy, or mutate another worktree. Phase 3 is **accepted and technically Verified in its dedicated worktree; pending separate publication/integration**. Phases 4–7 remain **Unauthorized; Not started**.
...
| Approval/status consistency | Pass for accepted pre-publication state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and §10.5A remain published/integrated. D-0018 remains exact; D-0019 authorizes Phase 3; D-0020's boundary is published at `54234b7c7b95201e274975a804859fa9c36806a1`; Phase 3 is accepted/technically Verified in its worktree pending publication; and Phases 4–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1, historical Phase 1.5, §10.4A, and §10.5A remain Verified, published, and integrated.** D-0018 remains the exact accepted Stick onion-skin contract. D-0019 authorizes Phase 3, and D-0020's exact tester-registration/Creator-preservation boundary is published/integrated at `54234b7c7b95201e274975a804859fa9c36806a1`. Phase 3 is **accepted and technically Verified in its dedicated worktree; pending separate publication/integration** with technical-manifest SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: under a later explicit publication instruction, preserve and publish/integrate only the exact accepted 30-path implementation set plus the reviewed canonical closeout paths. Revalidate the technical and closeout manifests and run the required clean no-plan, Phase 1.5 synthetic, Phase 2, and Phase 3 suites before any push. Canonical `main` has advanced to documentation-only record `b8d8406ca6b51c3b83adb29fa20f20160c871c54`, so the publication task must use a separately reviewed forward-only accepted-byte procedure or stop; it may not merge, rebase, force-push, rewrite history, silently discard the newer records, expand runtime scope, deploy, or begin Phase 4.

The reviewed Phase 3 closeout may change only these canonical record paths:

- `docs/CURRENT_STATE.md`;
- `docs/DECISIONS.md` for the D-0019 closeout note only;
...
Arthur's published shell correction remains recorded as D-0017; D-0018 remains the exact onion contract; D-0019 records Phase 3 authorization; D-0020 records the accepted tester/Creator correction; and the D-0019 closeout note records Arthur's accepted technically Verified result without widening scope. `project/project_structure.txt` may change only through deterministic `bash scripts/update_memory.sh`. `AGENTS.md`, `docs/PROJECT_MANAGER_CONTEXT.md`, all accepted product/runtime/fixture/test/proof bytes, package/configuration bytes, SPEC-0002, the separate SPEC-0003 worktree, and recovery material remain preserved. Every later task must establish exact current Git state rather than infer a future HEAD from this specification.
