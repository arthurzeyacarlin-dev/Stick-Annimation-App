...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 authorized Phase 3. D-0020 kept that authorization and D-0018 unchanged, added the required versioned tester registration ceiling, superseded the rejected Creator-lock requirements, and made the published §10.5A shell/manual timeline the exact Phase 3 baseline. Phase 3 is now **Verified, published, and integrated** at `3fe3a5487389647b67216e9466121e00f1a73856`. D-0022's Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 records acceptance of the exact implementation without authorizing publication or Phase 5. Phase 4 is **Verified/accepted in the dedicated worktree; pending publication/integration**. Phases 5–7 remain **Unauthorized; Not started**.
...
SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are Verified, published, and integrated. D-0022's exact Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 accepts the exact 22-path implementation. Phase 4 is **Verified and accepted in its dedicated worktree; pending separate publication/integration**. Phases 5–7, the Phase 7 Policy Gate, and paid/live requests remain unauthorized and not started.
...
| 4 — Validated editor command transaction | **Verified and accepted in dedicated worktree; pending publication/integration** | Dry-run produces a preview without mutation; Apply composes the same pure mutations as the manual path into one all-or-nothing transaction; stale/duplicate/cancel/failure cases are exact no-ops. | Exact 22 technical paths from base/HEAD `62f046adff7418d2e644365fc04bd5d6312dcca9`; technical-manifest SHA-256 `d34d589373713ac7930984aeb3ef0640539316c00e1f510cf8d798aee931bf46`; runner SHA-256 `353f4937972d30b1959f1c7aee3075f5ebafb308d04a778db69372969e7b906f`; Arthur visible acceptance under D-0023 | Passed technical and human acceptance. Separate publication/integration remains required; Phase 5 stays unauthorized. |
...
**Status:** **Verified and accepted in its dedicated worktree; pending separate publication/integration.** D-0022's activation was published in `62f046adff7418d2e644365fc04bd5d6312dcca9`. The stopped Spec Executor completed exactly the 22 authorized technical paths, and Arthur accepted the exact worktree result under D-0023. Phase 5 remains unauthorized and not started.
...
### 14.20 Phase 4 accepted and technically Verified in its dedicated worktree 2026-08-19
...
- Status and boundary: D-0023 records that acceptance. Phase 4 is **Verified and accepted in its dedicated worktree; pending separate publication/integration**. The Control Plane Architect changed no accepted technical byte. Phases 5–7 remain **Unauthorized; Not started**; no external/provider/OpenAI/search/Supabase/paid operation, staging, commit, merge, push, publication, or deployment is part of this closeout.
...
| Approval/status consistency | Pass for current accepted-worktree state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are published/integrated. D-0022's Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`; D-0023 accepts Phase 4 as Verified in the dedicated worktree pending publication/integration. Phases 5–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1, historical Phase 1.5, §10.4A, §10.5A, and Phase 3 are Verified, published, and integrated.** D-0022's seven-path Phase 4 activation is published at `62f046adff7418d2e644365fc04bd5d6312dcca9`. Under D-0023, Phase 4 is **Verified and accepted in its dedicated worktree; pending separate publication/integration**. The accepted result is exactly 22 technical paths with technical-manifest SHA-256 `d34d589373713ac7930984aeb3ef0640539316c00e1f510cf8d798aee931bf46` and runner SHA-256 `353f4937972d30b1959f1c7aee3075f5ebafb308d04a778db69372969e7b906f`. Phases 5–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: under a later explicit publication instruction, the Control Plane Architect may stage only the accepted 22 technical paths and eight reviewed canonical record paths, commit them on the Phase 4 branch, fast-forward a still-clean canonical `main`, push normally, rerun the required clean gates, and verify clean `0/0` synchronization. It must stop without beginning or authorizing Phase 5.

This accepted Phase 4 closeout changes only these canonical record paths:

- `docs/CURRENT_STATE.md`;
- `docs/DECISIONS.md` for D-0023;
...
Arthur's published shell correction remains recorded as D-0017; D-0018 remains the exact onion contract; D-0019 records Phase 3 authorization; D-0020 records the accepted tester/Creator correction; D-0022 records Phase 4 authorization and the strict proof-feasibility ceiling; and D-0023 records acceptance of the exact implementation without authorizing Phase 5. `project/project_structure.txt` may change only through deterministic `bash scripts/update_memory.sh`. `AGENTS.md`, `docs/PROJECT_MANAGER_CONTEXT.md`, all accepted technical bytes, package/configuration bytes, SPEC-0002, the separate SPEC-0003 worktree, and recovery material remain preserved. Every later task must establish exact current Git state rather than infer a future HEAD from this specification.
