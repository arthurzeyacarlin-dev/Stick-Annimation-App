...
Decision links: accepted SPEC-0001 decision D-0009, permanent role-separation decision D-0010, Phase 1.5 approval decision D-0011, protected-Drawing correction decision D-0012, Phase 2-only authorization decision D-0015, Phase 1.5 compatibility-correction decision D-0016, Phase 2 visible-result correction decision D-0017, Phase 3 Stick onion-skin decision D-0018, Phase 3 authorization decision D-0019, and still-broader pending decisions P-0004, P-0005, P-0007, and P-0008 in `../DECISIONS.md`
...
D-0018 fixes real Stick onion skin as part of Phase 3 without changing Drawing onion behavior. D-0019 records Arthur's explicit instruction that onion skin remains inside Phase 3 and authorizes the rest of the already approved §10.6 scope unchanged. Phase 3 is **Authorized; Not started**. Phases 4–7 remain **Unauthorized; Not started**, and no Phase 3 runtime, fixture, test, or proof work begins in this activation record.
...
| 3 — Atomic history and minimal local persistence | **Authorized; Not started** | Every manual construction action and joint drag has exact Undo/Redo; explicit local save/reopen preserves the human-built wave. One AI-sized three-pose batch remains representable as one undo entry for Phase 4. The existing Onion control gains the exact D-0018 paused active-layer neighbor renderer. | §10.5A Verified/published/integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`; D-0018 unchanged; D-0019 owner authorization | Begin only in one new dedicated Plan-mode Phase 3 Spec Executor task from this activation publication's final canonical-main SHA; stop after the technical proof and Implementation Review Packet. |
...
**Status:** **Authorized; Not started.** D-0019 records Arthur's authorization after §10.5A became Verified, published, and integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`. No Phase 3 runtime, fixture, test, or proof work has begun. Implementation may begin only in one new dedicated Plan-mode Phase 3 Spec Executor task from this activation publication's final canonical-main SHA.
...
**Dependencies:** §10.5A Verified/published/integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`; D-0018's exact onion contract; D-0019 owner authorization; current Drawing save/open behavior freshly regression-recorded; isolated storage available.
...
| Phase 3 activation and Stick onion contract | Authorized; Not started | D-0018 remains unchanged and fixes exact Drawing tints, nearest-distinct active-layer neighbors, hold skipping, blank boundaries, duplicate collapse, playback/OFF suppression, non-interactivity, no canonical mutation, origin-independent rendering, and Drawing byte preservation. D-0019 authorizes §10.6 only. No runtime/test/proof implementation ran in this activation task. |
...
| Approval/status consistency | Pass for current activation state | SPEC-0001 remains Approved and active. Phase 1, historical Phase 1.5, §10.4A, and the original Phase 2 bytes remain published/integrated; the original Phase 2 visible result is owner-rejected. The §10.5A correction is Verified/published/integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 remains exact, D-0019 marks Phase 3 Authorized/Not started, and Phases 4–7 remain Unauthorized/Not started. SPEC-0002 remains complete/protected; SPEC-0003 remains separate Proposed/inactive. |
...
Final spec status is **Approved** and active. **Phase 1 and historical Phase 1.5 remain Verified, published, and integrated.** The §10.4A compatibility correction remains Verified/published/integrated at exact prerequisite foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`. The original Phase 2 bytes remain historically published/integrated at `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, with their original proof hashes preserved, but Arthur rejected their visible product result. The D-0017 §10.5A correction is **Verified, published, and integrated** at `edfb3dea023119b91336e6e5da645d4982a9f068`. D-0018 remains the exact accepted Stick onion-skin contract. D-0019 marks Phase 3 **Authorized; Not started**; Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 remains complete/protected, and SPEC-0003 remains Proposed/inactive in its separate preserved worktree.

Exact next step: after this activation record is published/integrated, start exactly one new dedicated Phase 3 Spec Executor task in Plan mode from the activation publication's final canonical-main SHA. It may implement only §10.6, including D-0018 unchanged, and must stop after its technical proof manifest and Implementation Review Packet. It may not update canonical control-plane files, stage, commit, merge, push, publish, deploy, or begin Phase 4.
