...
| Phase 1.5 compatibility correction — versioned later-phase proof | **Approved; Authorized; Not started** under D-0016, published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42` | Preserve the exact no-plan Phase 1.5 suite while adding a fail-closed, hash-bound Phase 2 plan/registry/browser-adapter path, exact dirty allowlisting, truthful lint comparison, and synthetic compatibility proof. No product/UI behavior changes. | Historical Phase 1.5 Verified/published/integrated; D-0015 activation published at `a85690de9396cf97e3063005cbb6da85f109ae1d`; current incompatibility reproduced from live code; Arthur autopilot authorization and PM acceptance recorded by published D-0016 | Start only after this reconciliation is separately published, in one new dedicated Plan-mode executor from that reconciliation publication SHA. After implementation, stop again unless the technical proof, independent validation, D-0010 propagation/closeout, clean committed no-plan tester, clean synthetic extension, and separate publication/integration all pass. |
| 2 — Independent per-frame Stick state | **Authorized; Not started; blocked by the unimplemented Phase 1.5 compatibility correction** | Home → New → Stick visibly supplies the built-in figure, and the user creates the complete three-pose/12-frame wave without AI using the bounded hold/blank/start-pose controls; all 11 joints, playback, holds, and gesture boundaries use independent canonical poses. | Phase 1.5 Verified/published/integrated; D-0015 and its activation published/integrated at `a85690de9396cf97e3063005cbb6da85f109ae1d`; D-0016 approval published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`; compatibility correction must be implemented, propagated, published/integrated, and followed by a new activation SHA | Stop before any Phase 2 byte until the correction lifecycle and new activation are complete and a new Plan-mode Phase 2 executor starts from that new SHA; then stop until the real no-AI manual construction flow matches the Phase 1 manual content digest and all-11-role isolation, rendering, playback, held-frame, and gesture proof passes. |
...
**Status:** **Approved; Authorized; Not started** under D-0016, published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`. This is a named proof-infrastructure correction inside the already Approved SPEC-0001. It is not a new numbered product phase, does not reopen the historical Phase 1.5 user-visible result, does not authorize a Phase 2 runtime byte, and does not change D-0015. After this post-publication reconciliation is separately published, exactly one focused Plan-mode Spec Executor may begin from that reconciliation publication SHA within the exact ceiling below.
...
**Non-goals and stop gate:** No runtime/UI/product behavior, Phase 2 implementation, historical evidence rewrite, package/dependency/configuration/environment/database change, new product/dev route, public asset, broad browser framework, external lookup, provider/search/Supabase request, paid service, deployment, or Git operation is part of this correction. Stop on any product byte, any broader route/network/filesystem/storage/evaluation authority, any weaker default suite/recovery/temporary-restoration/production-exclusion rule, any unlisted path, any v1 evidence rewrite, any unmeasured or worse lint result, any residual process/profile/port/build/anchor byte, or any proof artifact outside the exact root. The compatibility correction remains Approved/Authorized/Not started under the approval record published at `6c2973caecb742334fb432bdda8fbc674bb7db42`; one focused executor may begin only from the separately published reconciliation SHA. Technical success alone does not unblock Phase 2.

### 10.5 Phase 2 — Independent per-frame Stick state

**Status:** **Authorized; Not started; blocked.** D-0015 supplies the owner authorization and its activation record is published/integrated at `a85690de9396cf97e3063005cbb6da85f109ae1d`. D-0016 accepts the §10.4A correction and that approval is published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`, but the correction remains unimplemented. The Phase 1.5 product/tester result remains satisfied, but the current tester/proof protocol cannot execute this phase. Phase 2 may begin only after the §10.4A correction is implemented by one focused executor, accepted and propagated under D-0010, separately published/integrated with both clean tester gates passing, and followed by a new control-plane activation naming the exact new Phase 2 SHA and executor.
...
| Approval/status consistency | Pass | SPEC-0001 remains Approved and active. OD-01–OD-06 and OD-09 are accepted; OD-07/08/10/11 retain their accepted safety/process boundary; OD-12–OD-14 remain deferred. Phase 1 and historical Phase 1.5 are Verified/published/integrated. D-0015 and its activation are published; Phase 2 remains Authorized/Not started but blocked. The Phase 1.5 compatibility correction is Approved/Authorized/Not started under D-0016 published/integrated at `6c2973caecb742334fb432bdda8fbc674bb7db42`. Phases 3–7 remain Unauthorized/Not started. |
