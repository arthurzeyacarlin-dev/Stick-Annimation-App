...
Decision links: [D-0033 through D-0051](../DECISIONS.md)
...
> **SPEC-0005 bounded-sequence prerequisite.** GIT-045 published D-0050 at exact commit `a4589664b6857eb10a828189e177e0e7d47e3f69`; D-0051 makes the final pre-execution correction from one whole-goal state to an ordered `stick.movement-goal/v1` sequence with exact base binding, per-landmark facing/support/contact/limb/active-part state, adjacent transitions, and exact completion. GIT-047 is published at `5d0299a00459d39d6c4bff5eeb345f72c5abde4e`; D-0053's accepted Phase 2 v2 result is Verified, published, and integrated through GIT-048 at `05faa59195c6d5f2d8a11ebcc9ab77fe1b6fdf14`. SPEC-0004 Phases 3–8 remain paused until all eight SPEC-0005 phases are accepted, published, and integrated; they may consume but never flatten, fork, or bypass that sequence.
...
SPEC-0005 Phase 1, Phase 2 v1, and D-0050/GIT-045 are published history. D-0051's bounded-sequence correction is the current prerequisite, and GIT-046 is complete at `55b05e2daad649ac1e0027722a75762a9714d281`; D-0052/GIT-047 now supply the front-knee projection correction. Corrected SPEC-0005 Phase 2 v2 is Verified, published, and integrated through GIT-048 at `05faa59195c6d5f2d8a11ebcc9ab77fe1b6fdf14`; SPEC-0005 Phase 3 is Authorized/Not started under D-0054, pending GIT-049 publication; SPEC-0005 Phases 4–8 and SPEC-0004 Phase 3 remain unauthorized. Do not start or correct Phase 2.6, resume Phase 3, contact a provider/API, perform paid work, deploy, create Phase 2.7, or add a special review UI.
