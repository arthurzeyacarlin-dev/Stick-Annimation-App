...
Status: **Approved. Phases 1 and 2 are Verified, published, and integrated. The first former Phase 2 was rejected/removed. GIT-043 published the accepted current Phase 2 result at `e52454354c39b962ac2710a8602a5306ffd62ad5`. D-0049 authorizes Phase 3 only; Phase 3 is Approved/Authorized/Not started pending GIT-044 publication of its authorization record. Phases 4–8 are Unauthorized; Not started.**

Owner: Arthur
Spec role: Spec Architect
Created: 2026-09-04
Last updated: 2026-09-06
Decision links: [D-0043 through D-0049](../DECISIONS.md)
...
>
> **2026-09-06 Phase 2 publication and Phase 3 authorization.** GIT-043 published the exact accepted 21-path Phase 2 package in `e52454354c39b962ac2710a8602a5306ffd62ad5`, parent `1861db92…`, message `Implement SPEC-0005 Phase 2 body safety`. The required clean tester passed 40 operations, 13 screenshots, four messages, all 37 negatives, one deterministic mocked Drawing POST, zero real API-route/non-loopback/provider requests, and cleanup; result SHA-256 is `c2887be734fe073191aa7d81fc9ffcf2cd6009da0bd188b67ddd9ad77aaebb63`. D-0049 authorizes only the existing Phase 3 contract. Phase 3 is Approved/Authorized/Not started and may begin only after GIT-044 publishes this authorization record. Phases 4–8 remain Unauthorized/Not started.
>
...
**Entry gate.** Phase 1 remains accepted/published at `2436a9414221e8ee7ef40151284cb8f4e069e828`; GIT-042 published D-0047 at `1861db92e8f599afa811b0ab6fdd46cc475f9f1c`. D-0048 accepted the exact eight-path `/7dfc/` correction with manifest `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874` (17,520 bytes), while historical manifest `ea7ab9c5a142843b109ad49924f4709660347265099740312a666eca07972cd4` (17,826 bytes) remains non-acceptance evidence. GIT-043 published/integrated the accepted result at `e52454354c39b962ac2710a8602a5306ffd62ad5`. The old rejected pose-maker remains removed and unavailable.
...
**Entry gate.** Corrected Phase 2 is accepted and published/integrated in GIT-043 at `e52454354c39b962ac2710a8602a5306ffd62ad5`; its accepted two-stage API, exact source, independent oracle fixtures, reason matrix, current safety/property/integration validators, and canonical acceptance record must revalidate. The correction manifest proves selection-before-bake and final revalidation; the earlier `ea7ab9c5…` manifest remains historical non-acceptance evidence only. D-0049 authorizes Phase 3, but implementation remains Not started and blocked until GIT-044 publishes the authorization record. The resulting GIT-044 commit—not `e524543…`—must be the exact base for one new dedicated Plan-mode Phase 3 Spec Executor worktree/app copy.
...
GIT-043 is complete at canonical `e52454354c39b962ac2710a8602a5306ffd62ad5`; it published the exact accepted 21-path Phase 2 package and its required clean tester passed. D-0049 authorizes only Phase 3's existing nine-path grounded non-locomotion contract. The exact next lifecycle action is separate GIT-044 publication of this reviewed authorization record.

Do not start Phase 3 until GIT-044 establishes its exact canonical-main executor base. After that publication, one fresh dedicated Plan-mode Spec Executor worktree/app copy may implement the four ordinary review cases and must stop for Arthur's review. Do not start Phases 4–8, mutate historical evidence, touch rejected `/8de8/` history, contact a provider, deploy, or expand scope.
