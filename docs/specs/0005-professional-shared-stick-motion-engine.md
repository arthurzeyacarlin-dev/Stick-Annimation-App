...
Status: **Approved with a final pre-execution sequence/composition correction. Phase 1 is Verified/published/integrated. Phase 2 v1 remains published historical numeric-safety evidence at `e52454354c39b962ac2710a8602a5306ffd62ad5`. GIT-045 published D-0050's first v2 plan in exact 13-document commit `a4589664b6857eb10a828189e177e0e7d47e3f69`; D-0051 now supersedes only its incomplete single-state goal/executor-start gate. Corrected Phase 2 v2 is Approved but Not implementation-authorized/Not started until GIT-046 separately publishes D-0051; that publication activates one fresh exact eight-path executor. The rejected Phase 3 result remains closed without acceptance. Corrected Phase 3 and Phases 4–8 remain Unauthorized/Not started.**

Owner: Arthur
Spec role: Spec Architect
Created: 2026-09-04
Last updated: 2026-09-07
Decision links: [D-0043 through D-0051](../DECISIONS.md)
...
**Lifecycle/status.** GIT-043's v1 result remains immutable published history and bounded numeric-safety evidence. It is not relabelled failed or erased. GIT-045 published D-0050's first correction plan at exact commit `a4589664b6857eb10a828189e177e0e7d47e3f69`. D-0051 supersedes only that plan's incomplete single-state goal and executor-start gate. This corrected v2 contract is Approved but **Not implementation-authorized/Not started** until GIT-046 publishes D-0051 from exact basis `a4589664b6857eb10a828189e177e0e7d47e3f69`; only then may one fresh Phase 2 correction executor begin. It remains Phase 2, not Phase 2.1/2.5/2A.
...
**Entry evidence.** Phase 1 remains published at `2436a941…`; GIT-043 v1 and its `e8a3fbbb…` correction manifest remain historical anchors; GIT-044 is complete at `269ac823…`; GIT-045 published D-0050 at `a4589664…`; D-0051 and this final corrected contract must be separately published by GIT-046 before execution.
...
Named gates that do not block the restructured Phase 2 after GIT-046 publication:
...
GIT-045 is complete at exact clean canonical commit `a4589664b6857eb10a828189e177e0e7d47e3f69`, parent `269ac82335ee4576cb471bd9dffc8f7ce9bdec0f`, message `Correct SPEC-0005 Phase 2 safety and Phase 3 plan`. D-0051 records the final pre-execution bounded-sequence/composition correction without rewriting GIT-045 or any runtime byte. The exact next lifecycle action is GIT-046: publish only the reviewed D-0051 control-plane correction and establish the exact executor base.

Before GIT-046, Phase 2 v2 is Approved but not implementation-authorized. After GIT-046, one fresh dedicated Plan-mode Phase 2 correction executor may implement exactly the eight-path correction boundary and stop with its technical proof. Do not start corrected Phase 3, Phases 4–8, mutate any rejected worktree or historical manifest, contact a provider, deploy, or expand scope. Corrected Phase 3 requires Phase 2 acceptance, sequential CPA closeout, separate publication/integration, and a later explicit owner authorization.
