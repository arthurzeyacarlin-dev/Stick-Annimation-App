...
Status: **Approved. Phase 1 is Verified, published, and integrated. The first former Phase 2 was rejected/removed. GIT-042 published D-0047 at `1861db92e8f599afa811b0ab6fdd46cc475f9f1c`. D-0048 accepts the stopped exact eight-path current Phase 2 correction as technically Verified; publication/integration is pending. Phases 3–8 are Unauthorized; Not started.**

Owner: Arthur
Spec role: Spec Architect
Created: 2026-09-04
Last updated: 2026-09-05
Decision links: [D-0043 through D-0048](../DECISIONS.md)
...
The distinct restructured Phase 2 executor implemented the body-safety foundation from published GIT-041 base `46b97556ec4e9c9249a1ff354c546f7b1c32ea4d`. Its first `ea7ab9c5…` manifest is preserved as historical non-acceptance evidence because the PM publication review found two specification defects: Phase 3 could not obtain checked important poses before baking, and Phase 4 lacked authority to extend the safety module for airborne mechanics. D-0047 corrected those contracts; D-0048 now accepts the corrected exact eight-path result as technically Verified, pending publication/integration.
...
**Entry gate.** Phase 1 remains accepted/published at `2436a9414221e8ee7ef40151284cb8f4e069e828`; GIT-042 published D-0047 at `1861db92e8f599afa811b0ab6fdd46cc475f9f1c`. D-0048 accepts the stopped `/7dfc/` correction with empty index, exactly eight authorized technical paths, correction manifest `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874` (17,520 bytes), and preserved historical manifest `ea7ab9c5a142843b109ad49924f4709660347265099740312a666eca07972cd4` (17,826 bytes). The result is technically Verified but remains unpublished/unintegrated until GIT-043. The old rejected pose-maker remains removed and unavailable.
...
GIT-042 is complete at canonical `1861db92e8f599afa811b0ab6fdd46cc475f9f1c`. D-0048 accepts the exact stopped eight-path correction as technically Verified. The exact next lifecycle action is separate GIT-043 publication of those frozen technical bytes plus the reviewed control-plane closeout. Phase 3 remains Unauthorized/Not started after that publication until a separate owner decision.

Publication must preserve the exact eight accepted hashes, both proof manifests, the reviewed control-plane paths, empty index, and base `1861db92…`; it must not publish ignored evidence. The manifest-recorded ordinary review process has been stopped and port `57795` is closed. Do not start Phase 3, mutate/delete the preserved worktree or historical evidence, touch rejected `/8de8/` history, contact a provider, deploy, or expand scope.
