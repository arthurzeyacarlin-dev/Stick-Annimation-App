...
This Control Plane Architect task stops after its packet. It changes no accepted runtime/fixture/technical-test/evidence byte and performs no staging, commit, merge, push, deployment, server stop or cleanup. Publication remains separately authorized. The same-copy correction exception and its verified recovery conditions are recorded in §16; rejected bytes are preserved as evidence, then replaced from canonical foundations, not reused.
...
**Lifecycle:** Completed, Arthur-accepted, technically Verified, published, integrated, recorded, and cleaned up under D-0065–D-0067/GIT-057–GIT-059. The immutable accepted manifest is preserved in the D-0067 backup at SHA-256 `6a1c65c967f8f1d87a27e3834677bea84381f0c2577125bebfead6ca77308b6d`, with exactly 17 technical paths and 77 evidence bindings. The exact implementation publication is `a759ae8afbb67e8fb723983851ae36947fd97f17`; the exact GIT-058 record publication is `41983b0c88e1994675a4901d5814b3d972ad46b4`; terminal GIT-059 is the canonical commit containing D-0067, read directly from Git after publication; the old server/worktree/branch are absent.
...
**Accepted realization.** The existing shared layout now exposes Stick Figure Tools, Properties, Library, and Assets; the Drawing toolbar remains intact. App-owned naming/collision UI creates Drawing, Stick, and Drawing+Stick project definitions. Stick-bearing definitions and selections preserve structured joints/segments with constant radii/thickness; Mixed definitions store their Drawing portion once as a hash-bound PNG. Placed instances retain independent transforms. Select and Lasso move/resize Drawing-only, Stick-only, and Mixed content through one existing history/save owner.

Stick and symbol gestures use synchronous ref-backed drafts. Pointer-up consumes the final sample and seals interaction ownership before release/lost-capture callbacks; Stick history commits synchronously through the established root. Selection interactions seal before their commit callbacks. Empty canvas and Brush/Lasso/Add Limb/Move Joint activation clear placed-symbol selection immediately, including same-tool reactivation, while own symbol interactions keep selection. No timer/retry, second dispatch, magic offset, test hook, or new history authority was added.

**Accepted evidence.** Both 1440×900 DPR1 and 390×844 DPR2 ran 17 real-browser flows/profile: 50 Add Limb plus 50 Move Joint gestures/profile with varied pointer samples/timing and 1,400 ms post-release observation; all six Select/Lasso × Drawing/Stick/Mixed groups with eight transforms; symbol deselection/action success; and 48 onion category-direction checks. Release/settle, exact Undo/Redo, scrub, Save/reload/Open hashes/geometry and unrelated rig/raster invariance passed. Phase 1 migration passed 3,516 assertions; Phase 4A 364; Phase 4B six flows; Phase 5 tools/catalog 231; TypeScript, focused lint (zero errors/ten inherited warnings), scoped build, diff/scope/index and strict manifest validation passed. PM independent smoke passed 12/12 Add Limb, 12/12 Move Joint, autosave, symbol conversion/placement/deselection, and Brush. Real API/external/AI requests were zero.

**Limits and preserved systems.** Compact is Chromium emulation, not physical-device proof. Existing compact title clipping, missing favicon 404, and Canvas readback performance warning remain outside scope. Paid AI was not run. AI/provider/prompt/motion/video/tracking/API, dependencies/configuration, Creator Save, new Stick features, automatic attachment/following, export, legacy source stores, deployment, and later phases remain unchanged.

### Phase 6 — Complete canonical legacy adoption, recovery, naming and persistence proof

**Lifecycle:** Arthur-accepted and technically Verified under D-0068 on 2026-09-14; published/integrated in exact GIT-060 commit `cbe16411a0f83d3b86136f41d0a66d1874d009aa`. Exact accepted technical boundary: 18 paths from GIT-059 base/HEAD `62feafc220c35eb1203dc4f19820e533a54002e1`, immutable 43,794-byte manifest SHA-256 `5883ea735bd741b2f14e45d2fa84669ea3bb78ad5ed23693011e0280e4070902`, PASS/VALID with 18 source and 13 evidence bindings. See §19.
...
**Entry.** Satisfied from published GIT-060. Preceding preserved manifests and recorded identities were inventoried; import/route/write inventory proved the bounded removals safe; the complete ordinary capability matrix was frozen.
...
This Phase 4 acceptance did not add or improve AI, motion generation, providers, prompts, video/tracking, cloud/social Share, export, advanced symbol/library creation, exhaustive legacy recovery, or duplicate-owner retirement. GIT-056 published this exact accepted implementation and reviewed records at `9c971fa4f7ea0e636ecc6957755552f678f344df`; canonical `main` synchronized cleanly at `0/0`, and the accepted review copy was removed under D-0054. Phase 5 subsequently completed and is recorded below.

## 18. Phase 5 accepted result — D-0065 (2026-09-13)

Arthur explicitly accepted the final Phase 5 app copy as acceptable after its gesture-durability correction. The stopped Spec Executor used detached base/HEAD `740eb70d2c713bf6bf8bd08123a0ed5eef3bc34d` in `/Users/arthurcarlin/.codex/worktrees/5a2c/stick-animation-app`, kept an empty index, and changed exactly the 17 technical paths bound by `output/spec-0006/phase-5/proof-manifest.json`. That immutable manifest is 32,852 bytes at SHA-256 `6a1c65c967f8f1d87a27e3834677bea84381f0c2577125bebfead6ca77308b6d`, status PASS, integrity VALID, technicalAcceptance PASS, with 17 source and 77 evidence bindings.

The accepted result completes the existing current-capability matrix rather than introducing future SPEC-0007 tools. It provides the four shared tabs, app-owned symbol naming/collision feedback, project-owned Drawing/Stick/Mixed definitions, independent placed instances, structured Stick scaling, all six ordinary Select/Lasso content-category transforms, durable Add Limb and Select/Move Joint first gestures, immediate placed-symbol deselection at empty-canvas/tool boundaries, unified six-category onion masks, stable multilayer Brush pixels, and compact ordinary pointer timeline navigation.

Final proof ran 17 real-browser flows on each of 1440×900 DPR1 and 390×844 DPR2. Each profile completed 50 Add Limb and 50 Move Joint gestures with real pointer timing variation and zero release/post-autosave missing/reversion; the six Select/Lasso category groups completed eight transforms each with release/settle, exact Undo/Redo, scrub and Save/reload/Open equality, plus unrelated raster/rig invariance. Symbol deselection and the subsequent Brush/Lasso/Add Limb/Move Joint actions passed. Onion proof included 48 category-direction checks. Phase 1 migration (3,516 assertions), Phase 4A (364), Phase 4B (six flows), Phase 5 tools/catalog (231), TypeScript, focused lint, scoped build, diff/scope/index and strict manifest validation passed. Browser ledgers recorded zero real API/external/AI requests.

The PM separately observed 12/12 first-try Add Limb and 12/12 first-try Move Joint actions, autosave stability, Stick symbol conversion/placement, empty-canvas and same/tool-switch deselection, and Brush success. Compact remains Chromium emulation rather than physical-phone proof. Existing compact title clipping, a generic missing-favicon 404, and a Canvas readback performance warning are not Phase 5 regressions and remain unchanged.

After the executor stopped, Arthur/PM acceptance transferred `/5a2c/` sequentially to the Control Plane Architect for propagation only. CPA revalidated the unchanged manifest before editing records, preserved every accepted source/evidence byte, updated canonical memory/tree, and left the index empty. This is historical ownership evidence; D-0067 records the later verified server/worktree/branch cleanup.

GIT-057 published the exact accepted 17 technical paths plus 14 reviewed control-plane/tree paths as commit `a759ae8afbb67e8fb723983851ae36947fd97f17`, parent `740eb70d2c713bf6bf8bd08123a0ed5eef3bc34d`, message `Implement SPEC-0006 Phase 5 tools and library`. GIT-058 then published its exact 13 reviewed records as `41983b0c88e1994675a4901d5814b3d972ad46b4`. D-0054 cleanup stopped/removed the obsolete review server/worktree/local branch after the PM recorded an empty checksum-mode rsync dry-run. The 98-file/17,456 KiB proof backup retains the technical manifest and prior/post-publication CPA closeouts at SHA-256 `6a1c65c967f8f1d87a27e3834677bea84381f0c2577125bebfead6ca77308b6d`, `91129b7c1b6294acd2189e9820f0c0665b4c8f6981d97e04c6ee36d3431da01c`, and `32357b0351bd3f0f23f0bd78146c5e15c7e026296013d494b7330409e4855991`. GIT-059 later published the exact D-0067 package at `62feafc220c35eb1203dc4f19820e533a54002e1`, fully closing Phase 5. That historical closeout granted no Phase 6 authority; Phase 6 was separately authorized and accepted later under D-0068 as recorded in §19.

## 19. Phase 6 accepted result — D-0068 (2026-09-14)

Arthur explicitly accepted the identical Phase 6 app-copy bytes after the same review copy was restarted on port 56666. The stopped Spec Executor used detached base/HEAD GIT-059 `62feafc220c35eb1203dc4f19820e533a54002e1` in `/Users/arthurcarlin/.codex/worktrees/b70c/stick-animation-app`, kept an empty index and changed exactly the 18 technical paths bound by `output/spec-0006/phase-6/proof-manifest.json`. That immutable manifest is 43,794 bytes at SHA-256 `5883ea735bd741b2f14e45d2fa84669ea3bb78ad5ed23693011e0280e4070902`, status PASS, integrity VALID, technicalAcceptance PASS, with 18 source and 13 evidence bindings.

The accepted result completes the Phase 6 source/persistence boundary. Drawing V1/V2, Stick V1/V2, strict unified V1 and native unified V2 open through the common neutral editor. Legacy/V1 upgrade preserves raster/tween/audio/text/rig data, dormant blank-owner payloads, source identity/provenance and project-bound auxiliary state. First Save allocates one canonical identity without changing source stores; Save As binds a distinct copy and rebinds Drawing AI memory/Stick latch. The collection collapses only an exact adopted provenance pair, never a same-title project, and discloses that original local source data remains.

Canonical storage replaces typed arrays and image/audio data URLs with content-addressed assets, stages immutable versions, verifies hydration/readback and only then compare-and-swap publishes a head. Older direct records remain readable and are retired only after a verified new head publishes. Open tries the exact active head first and falls back through retained valid versions; failures preserve the complete editable root, history, last-good head and source bytes. Save completion from an older generation does not mark newer edits saved.

Proof passed 1,117 deterministic assertions, 1,000 repeated cases, 48 history operations, six source kinds and 16 named fault families. Browser evidence passed ten adoption flows plus native Save/Save As/reopen in 19 operations, four screenshots and 120 selection-settle samples/profile at desktop 1440×900 DPR1 and compact 390×844 DPR2. The realistic project retained two distinct 60,268,104-byte raster assets, audio/catalog data and auxiliary state; large open/reopen stayed below 775 ms, Save below 1.53 s, settled heap below 320 MiB, and no long tasks occurred. TypeScript, focused lint with zero errors/one inherited warning, full-lint changed-line non-regression, scoped build, inherited Phase 1/4A/4B/5/Drawing/Stick/AI validators, diff/scope/index and strict manifest validation passed. Source-store writes, external requests, real API requests and AI changes were zero.

The immutable manifest records listener PID 23344 and the successful strict validation before that process expired. Arthur's later acceptance covered identical bytes after a restart on the same port. CPA freshly revalidated exact base/index/18-path state and every source/evidence binding; all match. The current port has no listener, so no current PID/cwd claim is made. This operational expiry neither rewrites the manifest nor weakens its technical bindings.

Phase 6 adds no legacy source write/delete behavior, AI model/prompt/provider/API/task change, motion/video/tracking, Creator Save, new manual capability, automatic attachment/following, export, dependency/configuration, cloud/auth/billing or deployment. Compact remains browser-profile rather than physical-phone proof; native/GPU allocation remains unproven and existing compact title clipping remains.

After executor stop and Arthur/PM acceptance, ownership transferred sequentially to the Control Plane Architect. CPA changed no accepted technical/evidence byte and added only canonical Phase 6 records plus the generated tree, leaving the index empty. A later GIT-060 publication turn may stage only the accepted 18 technical paths and reviewed control-plane/tree paths from unchanged GIT-059, commit once on a `codex/` branch, fast-forward a still-clean canonical `main`, push normally and verify clean local/remote `0/0`. Preserve `/b70c/` and proof until synchronization and later authorized D-0054 cleanup. Phase 7 is unauthorized and not started.

GIT-060 subsequently published the exact accepted 18 technical paths plus 14 reviewed control-plane/tree paths as commit `cbe16411a0f83d3b86136f41d0a66d1874d009aa`, parent GIT-059 `62feafc220c35eb1203dc4f19820e533a54002e1`, message `Implement SPEC-0006 Phase 6 adoption and recovery`, exactly 32 paths. Fresh Phase 7 CPA checks found local `main`, local `origin/main`, live GitHub `main`, and detached Phase 7 base/HEAD equal at that SHA with clean `0/0` before propagation. This newer publication fact supersedes only the preceding paragraph's historical pending-publication status.

## 20. Phase 7 accepted result — D-0069 (2026-09-14)

Arthur reviewed the ordinary app at `http://127.0.0.1:56770/` and called the result a PASS. The stopped Spec Executor used detached base/HEAD GIT-060 `cbe16411a0f83d3b86136f41d0a66d1874d009aa` in `/Users/arthurcarlin/.codex/worktrees/cd3e/stick-animation-app`, kept an empty index and changed exactly the 11 technical paths bound by `output/spec-0006/phase-7/proof-manifest.json`. That immutable manifest is 50,224 bytes at SHA-256 `c6202f6deab4d3bcc75af3ad6699fc2dc70fc58723eccaa8337b1a2aef74bc51`, status PASS, integrity VALID, technicalAcceptance PASS, with 11 source and 16 evidence bindings. Its historical `humanAcceptance: pending Arthur` and finalization `controlPlaneUpdated: false` fields are retained as executor-snapshot facts; D-0069 records the later acceptance and propagation.

The accepted result completes the ordinary ownership cutover. `WorkspaceCandidate.editor` has only the unified V2 variant; New and every supported Open path create or hydrate that root; `AnimationWorkspace` mounts exactly one `DrawingWorkspace`; and manual Save, Save As and AI-triggered Save call the canonical V2 repository. The Drawing-shaped projection and `DrawingCanvas` remain controlled algorithm/interaction adapters. The ordinary coordinator no longer contains a reachable legacy Drawing hydration/storage/cloud-sync write branch. The standalone Stick coordinator remains only as a protected historical/test anchor and is not imported or mounted by the ordinary workspace. Legacy source parsers remain read-only and source records are not deleted or rewritten.

The Stick Creator is embedded inside the unified root with an accessible modal identity, inert background containment, keyboard-visible focus and trigger-focus return. Creator Save remains disabled. Browser proof passed at 1440×900 DPR1 and 390×844 DPR2 with 200% zoom, reduced motion, Creator keyboard round trip, zero Axe critical/serious findings, canonical V2 writes only, no second coordinator mount, and zero external/real API requests, console errors or page errors.

The complete 24-command ledger passed. Phase 7 authority passed 30 assertions over nine ordinary flows and 12 regressions. TypeScript and scoped production build passed. Focused lint reported zero errors/eight inherited warnings; full lint retained the inherited five-error/72-warning baseline with zero changed-line findings. Phase 6 production stress remained PASS with 19 browser operations, two 60,268,104-byte rasters, desktop open/reopen/save at 735.8/758.3/1507.5 ms, settled desktop heap 312,397,923 bytes, compact settled heap 11,204,437 bytes, 240 selection-settle samples and zero long tasks.
