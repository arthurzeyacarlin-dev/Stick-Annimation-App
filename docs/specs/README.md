...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Approved/active; Phase 1 Authorized/Not started** | D-0085 creates the six-phase contract; D-0086/GIT-067 publishes the exact planning-only package at `ba5ecd694df78414240ce83a9140c5196334ebdc`; D-0087 records Arthur's approval and authorizes Phase 1 only; GIT-068 publishes that authorization at `1d80141f2465db6f0e389fb43dc1cdfb8dafbdf8`. One fresh Plan-mode Phase 1 executor is next. Phases 2–6 retain their predecessor and named provider/security/cost/privacy entry gates and remain unauthorized. |
