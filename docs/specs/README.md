...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved with correction; Phase 1 Verified/published/integrated; Phase 2 v1 published historical evidence, v2 correction Approved/Authorized/Not started pending GIT-045; prior Phase 3 rejected; corrected Phase 3 and Phases 4–8 Unauthorized/Not started | GIT-043's exact 21-path Phase 2 package and `e8a3fbbb…` manifest remain immutable numeric-safety history. GIT-044 published the prior Phase 3 authorization at `269ac82335ee4576cb471bd9dffc8f7ce9bdec0f`; its executor result was rejected and is not reusable. D-0050 authorizes only the eight-path Phase 2 body-local natural-safety correction after GIT-045 and rewrites Phase 3 to consume it later. |
