...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Approved/active; Phase 1 fully closed; Phase 2 accepted/technically Verified with propagation complete and publication pending; Phase 3 Unauthorized/Not started** | D-0113/GIT-084 close Phase 1. D-0115 accepts the exact 15-path Phase 2 result from base/HEAD `e6f6b1d…`; immutable 29,132-byte manifest SHA-256 `ddf3b9ac…823d` freshly validates with 22 assertions/16 mutation rejections. One-clock playback, synchronized audio, completion/Replay, fullscreen, keyboard/focus/accessibility, contain geometry and resource cleanup pass 146 real-Chromium assertions/15 flows/seven screenshots. The inherited frame-3 mismatch was stale proof math; product geometry/tolerance remain unchanged. GIT-086 publication/integration, proof preservation and D-0054 cleanup are pending a separate instruction; no Phase 3 or deployment authority. |
