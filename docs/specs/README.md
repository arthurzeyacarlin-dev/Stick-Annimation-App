...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved; Phase 1/v1 published history; Phase 2 v2 accepted/technically Verified, pending publication; corrected Phase 3–8 unauthorized | GIT-047 published D-0052 at `5d0299a00459d39d6c4bff5eeb345f72c5abde4e`. D-0053 records the accepted SPEC-0005 Phase 2 v2 result as technically Verified, pending separate GIT-048 publication/integration. Phase 1 and Phase 2 v1 remain published history; canonical main still contains v1 until that publication. Corrected Phase 3 and Phases 4–8 remain Unauthorized/Not started. The phase allowlists remain 6/8/10/12/9/10/7/8; D-0053 records exclusive accepted-worktree transfer to CPA; no publication or next-phase authority is implied. |
