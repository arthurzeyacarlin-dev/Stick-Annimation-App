...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; active; Phase 1 technically Verified/publication pending** | GIT-050 published activation at `3b784cc6a68ff6f10fa390d96b81376b46e54b44`. D-0058 records Arthur/PM acceptance of the exact 11-path Phase 1 hidden contract/read-only migration result; GIT-051 publication/integration remains pending. Phases 2–7 remain Unauthorized/Not started. SPEC-0006 alone owns unification. |
...
SPEC-0006 is **Approved and active** under D-0057. GIT-050 published the reviewed activation records at `3b784cc6a68ff6f10fa390d96b81376b46e54b44`. Arthur accepted the exact Phase 1 result, and D-0058 records it as technically Verified pending GIT-051 publication/integration. Phase 1 adds only 11 new hidden contract/migration/fixture/proof paths and modifies no existing runtime file. **Phases 2–7 remain Unauthorized; Not started.** Current runtime remains split. SPEC-0006 alone owns unification; future SPEC-0007/0008 remain absent and unauthorized. No new AI/provider/model/video/tracking, paid service, or deployment is authorized.

D-0055's supersession and D-0056's proposal remain historical; D-0057 records approval/authorization; D-0058 records accepted Phase 1 technical completion. Next step is separate GIT-051 publication of the exact reviewed technical/control-plane allowlist. Phase 2 requires a later explicit owner authorization after Phase 1 is cleanly integrated.
