...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phase 1 accepted and technically Verified; publication pending | D-0036 accepts the exact 17-path provider-free Phase 1 engine from base `9fae072359f3c0d10f1ed2bcee8da9ebc11d54ec`. Its 15,683-byte manifest passed 126 independent checks at SHA-256 `ee3a92edf8f4227dfa91ec3b84de3599fa158d5fb5f3df83155ab5192c076e4a`, with 14 receipts, 27 artifacts, 707 assertions, four fixtures, 12 browser flows, 11 screenshots, and zero external/API/provider requests. The blue fixture picker was isolated proof-only code and is absent from product paths. GIT-033 publication is next; Phases 2–8 remain unauthorized. |

SPEC-0004 Phase 1 is accepted and technically Verified under D-0036, but its exact 17 technical paths and reviewed records are not yet published. GIT-033 is the next separate step. It must exclude the private review copy/overlay and prove clean branch/main/origin/live-GitHub synchronization after a normal push. No provider/API activity, paid proof, deployment, Phase 2 implementation, or Phases 2–8 authorization exists.
