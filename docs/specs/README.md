...
| [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](0014-in-app-notification-center.md) | **Phases 1–2 published/closed; Phase 3 Export rejected/unpublished; Phase 4 accepted/technically Verified, GIT-102 publication pending; no Phase 5** | GIT-099 closes the two-bell foundation; D-0140/GIT-100 close Assistant/Terra exact-target alerts. D-0141/GIT-101 reject and record Phase 3 Export without publishing its bytes. D-0142 accepts the corrected Phase 4 offline/restored shared two-bell result from `57f3a8560dc61f79db87c13dbff7285684b74793`, manifest SHA-256 `1646e497ad2e96b2263201dbced8c69bd6aae21487de481b255a912f7019a0eb`: 14 technical paths, 93 oracle/98 headed-Chrome/42 protected-browser assertions and zero real provider calls. An unread restoration survives a later outage until acknowledged. GIT-102 publication, proof preservation and D-0054 cleanup remain pending; full build retains the unrelated dev AI-cost baseline failure. |
...
D-0135/D-0136/GIT-097 close SPEC-0013. D-0137 created SPEC-0014's original four-phase plan. D-0138/D-0139/GIT-099 fully closed Phase 1; D-0140/GIT-100 closed Phase 2. D-0141/GIT-101 rejected and recorded Phase 3 Export without publishing its implementation. D-0142 accepts Phase 4's corrected offline/restored two-bell result; its exact 14 technical paths and proof remain in the dedicated review worktree until GIT-102 publication and D-0054 cleanup. The spec has no Phase 5.
