...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Proposed and decision-complete; Phase 1 conditionally selected next after activation publication | D-0043 accepts the seven-phase product/spec direction: independent accepted references and full-playback proof; action-independent whole-body pose making; support/weight/ground mechanics; natural paths/timing/gravity; real walk/run; semantic wave/jump/hop/bow/dodge recipes; and one provider-free Pretend-AI/future-Terra planning door. This docs-only activation is not yet published. No implementation phase is active. After review and separate publication/integration, one new Plan-mode Phase 1 executor is next under its exact six-path ceiling. |
