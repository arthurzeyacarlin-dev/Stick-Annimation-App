...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; active; Phase 1 Authorized/Not started** | D-0057 records Arthur's approval of the exact seven-phase design and Phase 1 only. Phases 2–7 remain Unauthorized/Not started. A brand-new dedicated Plan-mode Phase 1 worktree starts only after separate activation publication from its exact clean canonical-main SHA; no executor starts here. SPEC-0006 alone owns unification. |
