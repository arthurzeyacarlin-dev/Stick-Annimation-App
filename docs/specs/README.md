...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Approved; Phases 1–2 fully closed; Phase 3 accepted/technically Verified; publication pending** | D-0105/GIT-081 `44cdafc…` close Phase 1. D-0106/D-0107/GIT-082 `7e7063e…` close Phase 2. D-0108 accepts Phase 3's exact twelve-path startup recovery; rebound manifest SHA-256 `5dc275dc…23f5`, source digest `48ec1461…d60`. Publication/integration, proof preservation and cleanup are authorized. |
