...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Approved; Phase 1 accepted/technically Verified with publication authorized/pending; Phases 2–3 Unauthorized/Not started** | GIT-080 `cb80f2b…` publishes the plan; D-0103 authorizes Phase 1; D-0104 accepts the exact ten-path result and authorizes its sequential propagation/publication. Manifest SHA-256 `b400293271c1ae0cf78007de5024eb616516a6219d3a9965e03a16d8f7890f19`. Recovery storage/startup recovery and later phases remain unauthorized. |
