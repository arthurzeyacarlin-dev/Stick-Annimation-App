...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; corrected Phase 4 accepted/technically Verified pending publication** | Phases 1–3 are Verified/published/integrated through GIT-054. GIT-055 published D-0062's neutral architecture at `e956840001d18757af8f2de5361640ba70d44d68`. D-0063 accepts the corrected 26-path Phase 4 result at manifest SHA-256 `9d2d18871981db2e499c689723730ada4690dd5cb94ab620a038e45557f298de`; GIT-056 publication/integration is next. Phases 5–7 remain not started. |
...
SPEC-0006 Phases 1–3 are Verified/published/integrated through GIT-054. GIT-055 published the corrected neutral architecture at `e956840001d18757af8f2de5361640ba70d44d68`. Arthur accepted the corrected Phase 4 ordinary neutral workspace under D-0063; its exact 26-path manifest SHA-256 is `9d2d18871981db2e499c689723730ada4690dd5cb94ab620a038e45557f298de`. Phase 4 is technically Verified pending GIT-056 publication/integration. Phases 5–7 remain not started.

The corrected 4A → stopped-owner checkpoint → 4B sequence is complete in the accepted `/1550/` review worktree. D-0063 records Arthur's visible acceptance. GIT-056 must publish only the accepted 26 technical paths and reviewed control-plane/tree paths, verify clean synchronized canonical `main`, and then clean up the accepted review copy under D-0054 before Phase 5 begins.
