...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; Phases 1–4 published/integrated; Phase 5 accepted/Verified pending publication** | D-0065 accepts the exact 17-path Phase 5 result at manifest SHA-256 `6a1c65c967f8f1d87a27e3834677bea84381f0c2577125bebfead6ca77308b6d`, with 17 source/77 evidence bindings. GIT-057 publication/integration is next. Phases 6–7 remain not started. |
...
SPEC-0006 Phases 1–4 are Verified/published/integrated. Arthur accepted Phase 5 under D-0065; its exact 17-path manifest SHA-256 is `6a1c65c967f8f1d87a27e3834677bea84381f0c2577125bebfead6ca77308b6d`, status PASS/integrity VALID. Phase 5 is technically Verified pending GIT-057 publication/integration. Phases 6–7 remain not started.

The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. Phase 5 then completed through a separate stopped Spec Executor, Arthur acceptance, and sequential CPA ownership transfer in `/5a2c/`. GIT-057 publication and subsequent D-0054 cleanup are the next lifecycle actions; Phase 6 cannot start first.
