...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phases 1, 2, and timing-only 2.5 Verified/published/integrated; Phase 2.6 rejected/superseded; paused before Phase 3 | D-0036's Phase 1 engine is published/integrated in exact 28-path commit `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-035 published D-0039's exact eight-path Phase 2 engine in exact 20-path commit `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`. D-0041 accepts the exact seven-path Phase 2.5 result only as the timing/spacing primitive; GIT-037 published it within exact 19-path commit `16799539fb7db31e345a878aa892d4485115188b`; and its 14,601-byte manifest SHA-256 is `783e6396cf994ce48fb9d7c94dc58674594dd545f888a9c25fe3c1f654a788d1`. The later unpublished Phase 2.6 executor result was rejected after human review and was never accepted, propagated, or published. D-0043 supersedes its intended job with SPEC-0005 and pauses Phases 3–8; no Phase 2.7 exists. |
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved; Phase 1 Verified/published/integrated; current restructured Phase 2 implemented-but-publication-blocked, stopped, correction not started, not accepted/Verified/published | D-0044's exact six-path Phase 1 proof-only gate remains published/integrated within exact 20-path commit `2436a9414221e8ee7ef40151284cb8f4e069e828`; its 10,011-byte manifest SHA-256 is `af287680b7ae73fd4c543edf8076d9fbb7fb65474a5d4508f8b17dde56174e84`. The first former Phase 2 remains rejected/removed. GIT-041 published D-0046's exact eight-phase structure at `46b97556ec4e9c9249a1ff354c546f7b1c32ea4d`. A distinct eight-path body-safety implementation is preserved stopped in `/7dfc/` with historical manifest `ea7ab9c5…`, but D-0047 blocks publication until checked important-pose selection occurs before bake/final frames and Phase 4's twelve-path ceiling lawfully extends the same safety module for mechanics-qualified airborne transitions. The exact eight Phase 2 paths, 10,000+10,000 property floor, one final Preview door, ordinary editable frames, no numerical anatomy change, and one existing ordinary smoke-only process boundary remain. Phases 3–8 remain Unauthorized/Not started. |

SPEC-0004 Phase 1 is Verified, published, and integrated under D-0036/GIT-033 at `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-034 published Phase 2's activation at `70bf7b0799bcff8d703525bcb50c378b8a122ebf`; GIT-035 published the accepted result at `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`. GIT-036 published the Phase 2.5 activation at `a755f892d7737c6a10d9c381ec59c1e2fdba4d47`; GIT-037 published its accepted timing-only bytes and reviewed records in `16799539fb7db31e345a878aa892d4485115188b`. The later exact eight-path Phase 2.6 executor result stayed unpublished and was rejected by Arthur after visible review. Its technically green manifest cannot substitute for accepted motion quality because browser proof did not require a complete playback cycle and the exact frozen output came from the same generation path. D-0043 gives that missing shared-motion outcome to SPEC-0005 and pauses SPEC-0004 before Phase 3. No provider/API activity, paid proof, deployment, Phase 3–8 authorization, Phase 2.7, or Drawing/workspace integration exists.
