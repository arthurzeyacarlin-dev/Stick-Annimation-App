...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 published/integrated through D-0130/GIT-094; Phase 5 accepted and technically Verified under D-0131 in its review worktree, pending publication/integration; Phase 6 unauthorized/not started** | Phase 5's accepted exact 16-path implementation has sealed manifest SHA-256 `3e37e42b2a402bbb50a9f6bc33fd6cc537f527791aee85664d0e23bd24a666ed`, 33 oracle/71 Chrome/4 route assertions and five protected regression groups; Arthur reported a successful physical-microphone dictated message. GIT-095 publication, proof preservation and cleanup remain pending. |
...
D-0120 created SPEC-0012; GIT-089 published the plan. D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125/D-0126/GIT-092 close Phase 4 hosted search and its corrupt-row correction. D-0127 accepts the final terminal/source correction; D-0128/GIT-093 publishes, activates, preserves and cleans it up. D-0131 subsequently accepts and technically verifies Phase 5 in its review worktree; GIT-095 publication/integration remains pending. SPEC-0012 remains independent from paused SPEC-0008 and cannot mutate animation/project content or resume any Animator phase.
