...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, §10.4A, and §10.5A remain Verified/published/integrated. D-0018 remains the exact Phase 3 Stick onion contract; D-0019 authorizes Phase 3; D-0020's exact boundary is integrated at `54234b7c7b95201e274975a804859fa9c36806a1`. Arthur completed visible human review and accepted the exact 30-path Phase 3 result. Its 11-command technical manifest independently validates at SHA-256 `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`, binds 63 artifacts, and records a 71-action/7-checkpoint/4-screenshot browser pass with five protected groups, zero non-loopback/provider traffic, and complete cleanup. Phase 3 is **accepted and technically Verified in its dedicated worktree; pending separate publication/integration**. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 is complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched. |
