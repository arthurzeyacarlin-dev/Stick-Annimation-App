...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; active; Phases 1–2 published; Phase 3 accepted/Verified, unpublished** | GIT-051/GIT-052 preserve the published contract/migration and shell/New/Open results. D-0061 accepts the exact 16-path Phase 3 stage/compositing result from runtime `d2096109900cc50a0a4dae2f603bd74b7b4a3427` and authorization `916a4d913c6fdf8340b67bcc88dcea184d67cd32`; CPA propagation is complete in c6b0, pending separate GIT-054 publication/integration. Phases 4–7 remain Unauthorized/Not started. SPEC-0006 alone owns unification. |
...
SPEC-0006 is **Approved and active** under D-0057. Phases 1–2 are published through GIT-052 `d2096109900cc50a0a4dae2f603bd74b7b4a3427`. Phase 3 is **accepted and Verified in the dedicated worktree; unpublished and not integrated**, under D-0061. **Phases 4–7 remain Unauthorized/Not started.** Phase 3 provides the manually seeded mixed Drawing/Stick stage only; no AI output, unified timeline/tools/history/canonical Save, later spec, provider, paid service, or deployment is included. Technical manifest SHA-256 is `207aea2a7d664e49d28dd6b8c4704e50da9fae8d5197d9164ccbac871db4fcc0` (22,897 bytes).

Next step is separate CPA publication of the exact accepted 16 technical paths plus the 14 reviewed records/tree paths in SPEC-0006 §15. Follow SESSION_HANDOFF: unchanged clean canonical main at GIT-053, exact bytes, empty index, and sequential ownership are mandatory. This record does not authorize staging or publication in the propagation turn. Preserve the review copy through successful integration/synchronization and authorized D-0054 cleanup; no Phase 4 starts automatically.
