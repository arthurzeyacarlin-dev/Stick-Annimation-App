...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 accepted; Phase 4 terminal correction accepted with GIT-093 publication authorized/pending; Phase 5 unauthorized/not started; Phase 6 unauthorized/not started** | D-0125/D-0126/GIT-092 close hosted search. D-0127 binds the exact 14-path terminal/source correction from base `21c5b3d…d9`, manifest `a078d42e…137`, source digest `6593a497…2ce`: three-second job-owned Finalizing, 55-second hard deadline, deduplicated search lifecycle, bounded retained sources without the temporary source-overflow failure, clean prose and dedicated Sources links. Phase 5 requires separate authorization after GIT-093. |
...
D-0120 created SPEC-0012; GIT-089 published the plan. D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125/D-0126/GIT-092 close Phase 4 hosted search and its corrupt-row correction. D-0127 accepts the final terminal/source correction and authorizes GIT-093 publication. Phase 5 remains Unauthorized/Not started until that publication closes and Arthur separately authorizes it. SPEC-0012 remains independent from paused SPEC-0008 and cannot mutate animation/project content or resume any Animator phase.
