...
| [`SPEC-0003 — Tutorials and Cleaner Home Screen`](0003-tutorials-and-cleaner-home-screen.md) | Approved | D-0030's exact corrected showcase-only outcome is published in `4cd1a98b2f0b53c89d50ede453d1ab14bccbc9c7`, and D-0031's authorization is published in `57ef6ff5ff9d2da7ca3ab1e154aac9f506cc6b81`. The exact seven-path prerequisite is accepted and **technically Verified pending publication/integration** at manifest SHA-256 `adc3ad5534027470e436d92c0cbeaa6bc51fd5821303bb008f771b57da91edb3`. The product implementation remains **Authorized; Not started** and blocked until the package is published and its clean committed tester passes. |

## Proposed Specs

No additional product specification is currently Proposed for implementation. SPEC-0003 remains Approved/active through D-0030. D-0031's accepted, technically Verified tester-only prerequisite is an entry gate inside SPEC-0003, not a new product spec or a fake phase; it must be separately published and pass its clean committed rerun before the one product implementation starts.
