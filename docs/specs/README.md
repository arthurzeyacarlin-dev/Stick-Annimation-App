...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Approved/active; Phase 1 Verified/published/integrated/synchronized/proof-preserved/cleaned up; Phase 2 Authorized/Not started; Phase 3 Unauthorized/Not started** | D-0112 binds Arthur's PASS and the exact accepted Phase 1 result. D-0113/GIT-084 close exact 29-path commit `9a3c5733…`, preserve the 22-file proof at inventory SHA-256 `e2fc1d2f…5d47`, and complete D-0054 cleanup. D-0114/GIT-085 authorize exactly one fresh Phase 2 executor after activation synchronization; no Phase 3, external/paid, implementation-publication or deployment authority. |
