...
| [`SPEC-0007 — Drawing-Only Manual Editor Completion and AI-Ready Tools`](0007-manual-editor-completion-and-ai-ready-tools.md) | **Approved and active; corrected Phase 1 Authorized/Not started; prior result Rejected** | D-0074 supersedes D-0071–D-0073 where their seven-phase structured-rig/Creator direction or earlier Phase 1 result conflicts. Corrected phases: Drawing Engine/No-Loss; Draw Rig; Safe Legacy Rig Retirement/Migration; Assets; Final Bug Burn/Future-AI Registry. Only Phase 1 is authorized. The `/3cd3/` result is rejected/unpublished/non-reusable; restart is gated on this package's separate publication/synchronization and D-0054 recovery preservation/cleanup. Phases 2–5 remain unauthorized. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. Phase 5 completed through GIT-059 and its cleanup; Phase 6 published in GIT-060; Phase 7 published in GIT-061 and cleanup completed under D-0070. Drawing-only SPEC-0007 is Approved/active under D-0074. Corrected Phase 1 is Authorized/Not started and awaits this records package's separate publication/synchronization plus verified D-0054 preservation/cleanup of rejected `/3cd3/` before a fresh executor. Phases 2–5 and all future SPEC-0008 work remain unauthorized. D-0072's exact prior proposal hash and D-0073's `/4bb1/` entry evidence remain historical, not current phase-contract authority.
