...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 accepted/published/integrated; Phase 4 terminal correction closed by D-0128/GIT-093; Phase 5 entry-ready but unauthorized/not started; Phase 6 unauthorized/not started** | D-0125/D-0126/GIT-092 close hosted search. D-0127 binds the exact 14-path terminal/source correction from base `21c5b3d…d9`, manifest `a078d42e…137`, source digest `6593a497…2ce`; D-0128/GIT-093 publishes it as exact product commit `99128d70…`, preserves proof, activates canonical port 3000 and completes review-copy cleanup. |
