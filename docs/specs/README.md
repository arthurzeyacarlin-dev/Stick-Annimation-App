...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Approved/active; Phase 1 Verified/published/integrated/recorded/cleaned up; corrected Phase 2 awaiting review/publication before separate authorization** | D-0085–D-0088 create/approve/authorize/correct the six-phase contract. D-0089 accepts the exact 19-path correction with PASS/VALID manifest SHA-256 `80a5463775f498116389e49cb94d3282023355c6f7dd1bae9cc026a727916313`; D-0090 records exact 33-path GIT-070 commit `76708645c96b3b0ea95c524f162bb6152d539fcf`, clean local/origin/live synchronization, proof preservation and D-0054 cleanup. D-0091 integrates bounded Terra hosted internet research into existing Phase 2 while preserving exactly six phases, Phase 1 closure and the one-week target. Phase 2 remains Unauthorized/Not started; live search/video-provider use stays separately gated and Phases 3–6 remain unauthorized. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066. D-0085 creates SPEC-0008, D-0086/GIT-067 publishes its planning-only package, D-0087 authorizes Phase 1, and D-0089/D-0090/GIT-070 close its accepted corrected result. D-0091 prepares the bounded existing-Phase-2 internet-research correction for review and separate publication; Phase 2 remains Unauthorized/Not started and Phases 3–6 remain unauthorized. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
