...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, Phase 4, and Phase 5 are **Verified, published, and integrated**. The corrected exact 22-path Phase 5 implementation plus eight reviewed records were published in commit `9bbcc1df2fe4c79c0947601d0ea6274a85732d85`, with proof-manifest SHA-256 `f9024a5d86cc1febbac7df3d4219348cd8289d17723406bac5d90929d4cf5c0f` and closeout SHA-256 `fd71afec8e637bb3736a63dbbe245c6616e14a4330b91f7e354297d96c2c24dd`. D-0027's closed typo-friendly V2 intent/matrix and maximum 26-path/V6-proof ceiling are published at `f46ed3b13e6bca3a09c9b2926c972bea8c331f2c`. Arthur and the Project Manager accepted D-0028 after rejecting the first unpublished Phase 6 review copy; the Control Plane Architect independently closed out its requirement for the original user-first panel, Preview/Cancel empty canvas, visible applied figure/holds, exact purple/green onion figures, strict geometry/pixel proof, and no unrelated visual change. Phase 6 is **Approved; Authorized; correction required**, with no accepted/published runtime. Phase 7 remains **Unauthorized; Not started**. SPEC-0002 is complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched. |
