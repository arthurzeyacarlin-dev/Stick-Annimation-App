...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phase 1 Verified/published/integrated; Phase 2 Authorized/Not started | D-0036's exact 17-path provider-free Phase 1 engine is published/integrated within exact 28-path commit `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. D-0037 authorizes Phase 2 only: one hidden local motion engine, deterministic body/easing/arc rules, every generated slot baked as an independent ordinary keyframe, exact eight-path ceiling, and four disposable normal-looking review links with no blue box. GIT-034 must publish/integrate this activation before one new executor starts. Phases 3–8 remain unauthorized; no provider/API/paid/Drawing/workspace-integration work is authorized. |

SPEC-0004 Phase 1 is Verified, published, and integrated under D-0036/GIT-033 at `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. The normal push and clean permanent tester passed, branch/main/origin/live-GitHub/GitHub-API equality and clean `0/0` synchronization were verified, and the private review copy/overlay was excluded. D-0037 now authorizes Phase 2 only, still Not started and entry-gated on GIT-034. No provider/API activity, paid proof, deployment, Phase 3–8 authorization, or Drawing/workspace integration exists.
