...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Approved/active; Phases 1–2 Verified/published/integrated/synchronized/proof-preserved; Phase 2 review server stopped; Phase 3 Unauthorized/Not started** | D-0113/GIT-084 close Phase 1. D-0115 accepts the exact 15-path Phase 2 result and immutable manifest SHA-256 `ddf3b9ac…823d`; D-0116/GIT-086 `faf2965c…915d` publish/integrate the 29-path package, synchronize refs, preserve 33 files/1,370,820 bytes at inventory SHA-256 `ee486196…3ac`, stop PID 23010 and close ports 57760/57730. Final obsolete worktree/local-branch removal remains for the Project Manager after this task. Phase 3 is entry-ready only after cleanup and separate Arthur authorization; no Phase 3 or deployment authority exists. |
