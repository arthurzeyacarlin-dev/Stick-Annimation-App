...
## Current accepted plan — SPEC-0015 Phase 1

[`SPEC-0015 — Functional AI Dashboard, Usage, Accounts and Billing`](0015-functional-ai-dashboard.md) is an **approved staged plan** under D-0144 research and D-0145 Arthur/PM Phase 1 acceptance. Planning base is canonical `c682e430e204a7d750654da3f96e36ab4f57e196`; Arthur authorized publication of this reviewed docs/tree package and one separate exact-base Phase 1 executor after synchronization. Phase 1 is **Authorized / Not started** and implements only a read-only retained local conversation TEST PREVIEW, labeled Demo and lower cards; it is not paid billing or AI enforcement. Phases 2–6 are **Unauthorized / Not started** behind named owner/privacy/security/economics gates. SPEC-0008 and existing spec statuses are unchanged.
...
| [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](0014-in-app-notification-center.md) | **Phases 1–2 and 4 published/closed; Phase 3 Export rejected/unpublished; no Phase 5** | GIT-099 closes the two-bell foundation; D-0140/GIT-100 close Assistant/Terra exact-target alerts. D-0141/GIT-101 reject and record Phase 3 Export without publishing its bytes. D-0142 accepts the corrected Phase 4 offline/restored shared two-bell result from `57f3a8560dc61f79db87c13dbff7285684b74793`, manifest SHA-256 `1646e497ad2e96b2263201dbced8c69bd6aae21487de481b255a912f7019a0eb`: 14 technical paths, 93 oracle/98 headed-Chrome/42 protected-browser assertions and zero real provider calls. An unread restoration survives a later outage until acknowledged. D-0143/GIT-102 publishes exact commit `283c297d1df01371dc599a52719d35dc78e1d2f4`, preserves proof and cleans the review copy; full build retains the unrelated dev AI-cost baseline failure. |
| [`SPEC-0015 — Functional AI Dashboard, Usage, Accounts and Billing`](0015-functional-ai-dashboard.md) | **Approved staged plan; Phase 1 Authorized / Not started after planning publication; Phases 2–6 Unauthorized / Not started** | D-0145 accepts only the display-only weekly TEST PREVIEW Phase 1; later durable metering, identity, real entitlements, sandbox payments and launch readiness retain separate gates. No commercial price/quota/rollover approval, AI enforcement or SPEC-0008 resumption. |
...
D-0135/D-0136/GIT-097 close SPEC-0013. D-0137 created SPEC-0014's original four-phase plan. D-0138/D-0139/GIT-099 fully closed Phase 1; D-0140/GIT-100 closed Phase 2. D-0141/GIT-101 rejected and recorded Phase 3 Export without publishing its implementation. D-0142 accepted Phase 4's corrected offline/restored two-bell result; D-0143/GIT-102 published, synchronized, preserved proof and removed its obsolete review copy. The spec has no Phase 5.
