...
SPEC-0003 remains a separate **Proposed; inactive** draft in its own worktree. It is not present on canonical `main`, is not linked as an active canonical spec here, and authorizes no implementation. This §10.5A activation record does not copy, merge, edit, or activate it.
...
The correction was published and integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Phase 2 subsequently started from exact activation base `68338d54542bbfd3fb1f0fab06548f0424871f80` and its exact 36-path result was published in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. Its historical technical/closeout evidence and hashes remain preserved. On 2026-08-18 Arthur rejected the visible workspace result: it replaced the pre-Phase-2 Stick shell with a large twelve-cell timeline, automatic figure, reduced tools/panel, and restricted Creator access. D-0017 approves §10.5A as one correction: exact `68338d…` shell restoration plus current-Drawing-style applicable timeline behavior and independently editable Stick keyframes. It is Authorized/Not started pending separate activation publication, whose commit becomes the executor base. Drawing Save was not automated in the historical Phase 2 proof; Arthur's separate manual Save verification is human evidence only. Phases 3–7 remain unauthorized.
