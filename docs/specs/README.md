...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phase 1 Verified/published/integrated/synchronized/proof-preserved/cleaned up; Phases 2–6 unauthorized/not started** | GIT-089 `f2bda338…` published the D-0120 plan. D-0121/D-0122 bind Arthur's separate Phase 1 authorization/PASS and exact eleven-path corrected shell; D-0123/GIT-090 `e725f562…` close publication, synchronization, proof preservation, server shutdown and D-0054 cleanup. Phase 2 is ready only for separate Arthur authorization. |
...
D-0120 created SPEC-0012 from Arthur's accepted six-phase guidance-Assistant direction; GIT-089 `f2bda33842a3f5a4b560a7d3aab170a6ca4c2fd0` published that plan. D-0121/D-0122 authorize and accept Phase 1; D-0123/GIT-090 close it. SPEC-0012 remains independent from paused SPEC-0008: it cannot mutate animation/project content and cannot resume any Animator phase.
