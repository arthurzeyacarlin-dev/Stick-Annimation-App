...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Approved/active; Phase 1 correction Authorized/Not started; first result Rejected/cleaned** | D-0085 creates the six-phase contract; D-0086/GIT-067 publishes its plan; D-0087/GIT-068 approves it and authorizes Phase 1. D-0088 rejects the first app after the `hello` conversation failure, preserves its evidence, completes D-0054 cleanup, authorizes one fresh correction, and permits at most six short text-only live Terra requests/$0.50 total. Phases 2–6 remain unauthorized. |
