...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved; Phase 1 Verified/published/integrated; restructured Phase 2 Approved/Authorized/Not started pending D-0046 publication | D-0044's exact six-path Phase 1 proof-only gate remains published/integrated within exact 20-path commit `2436a9414221e8ee7ef40151284cb8f4e069e828`; its 10,011-byte manifest SHA-256 is `af287680b7ae73fd4c543edf8076d9fbb7fb65474a5d4508f8b17dde56174e84`. GIT-040 published D-0045's former Phase 2 authorization in `b5ddd5e3f4fb3b19e5c7c2be8a1bd35b0f8d6070`, but Arthur rejected that executor's visible motion; no implementation/proof byte was accepted, propagated, committed, published, or integrated, and its disposable app/worktree was removed. D-0046 supersedes the former phase structure with exactly eight phases and authorizes only the fresh exact eight-path planner-independent Body Safety Gate/Foundation after separate publication. Phase 2 stays technical-only/no-new-motion, but after every technical gate passes it must leave exactly one ordinary unchanged-source loopback/non-`3000` app instance from the exact unpublished executor worktree for Arthur's existing-app regression smoke check; that instance proves no Phase 2 safety, and Phase 3 remains the first new-motion review. Phases 3–8 remain Unauthorized/Not started. |
