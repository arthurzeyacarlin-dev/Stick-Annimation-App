...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Approved/active; Phase 1 correction Accepted/technically Verified; GIT-070 publication/cleanup pending** | D-0085 creates the six-phase contract; D-0086/GIT-067 publishes its plan; D-0087/GIT-068 approves it and authorizes Phase 1; D-0088 rejects/cleans the first result and authorizes one correction. D-0089 accepts the exact 19-path correction with PASS/VALID manifest SHA-256 `80a5463775f498116389e49cb94d3282023355c6f7dd1bae9cc026a727916313`; publication/integration, proof preservation and D-0054 cleanup remain pending. Phases 2–6 remain unauthorized. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066. D-0085 creates SPEC-0008, D-0086/GIT-067 publishes its planning-only package, and D-0087 approves it with Phase 1 alone Authorized/Not started. Phases 2–6 remain unauthorized. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
