...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; active; Phases 1–2 published; Phase 3 authorized** | GIT-051 published/integrated Phase 1 at `804ff39dc73c88d4799570cce2ef18987745a0be`; GIT-052 published/integrated the corrected exact 15-path Phase 2 shell/New/Open result at `d2096109900cc50a0a4dae2f603bd74b7b4a3427`. D-0060 records Arthur's explicit Phase 3 stage/compositing authorization from that exact runtime base; Phase 3 is Authorized/Not started. Phases 4–7 remain Unauthorized/Not started. SPEC-0006 alone owns unification. |
...
SPEC-0006 is **Approved and active** under D-0057. GIT-051 published/integrated Phase 1 at `804ff39dc73c88d4799570cce2ef18987745a0be`; GIT-052 published/integrated the corrected exact 15-path Phase 2 result at `d2096109900cc50a0a4dae2f603bd74b7b4a3427`. Phase 2 changes direct New, one combined inherited Projects collection, and one compatibility-editor mount; it does not merge the editor internals or persistence. D-0060 authorizes Phase 3 stage/compositing only from that exact runtime base; it is Not started. **Phases 4–7 remain Unauthorized/Not started.** Future SPEC-0007/0008 remain absent and unauthorized. No new AI/provider/model/video/tracking, paid service, or deployment is authorized.

Next step is one new dedicated Plan-mode Phase 3 Spec Executor. Its technical diff starts from exact runtime base `d2096109900cc50a0a4dae2f603bd74b7b4a3427`; it must bind the later records-only authorization commit/spec bytes, freeze its exact path list within the 16-path ceiling, satisfy the Phase 3 entry gate, and stop after its Implementation Review Packet without control-plane or Git publication work.
