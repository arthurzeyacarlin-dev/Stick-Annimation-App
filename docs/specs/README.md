...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phase 1 and combined Phase 2/absorbed Phase 3 fully closed; Phase 4 accepted/technically Verified/control-plane propagated with publication pending; Phases 5–6 unauthorized/not started** | GIT-091 `fa2ef6c…` publishes/integrates D-0124's exact 34-path sessions/fixed-Terra result and completes proof preservation/cleanup. D-0125 binds Phase 4's exact 27-path hosted-search/citation/activity plus corrupt-row correction result. Final manifest SHA-256 `08ff725e…095`, validation receipt `3107a15f…060`, source digest `073bc363…fd`; GIT-092 remains a separately authorized future publication/cleanup task. Phase 5 is entry-ready only after GIT-092 and remains Unauthorized/Not started. |
...
D-0120 created SPEC-0012; GIT-089 published the plan. D-0121–D-0123/GIT-090 fully close Phase 1. D-0124 accepts combined Phase 2 and records that the original Phase 3 fixed-Terra scope was moved forward and satisfied there; GIT-091 `fa2ef6c…` publishes/integrates it and completes proof preservation/cleanup. D-0125 accepts and technically verifies Phase 4 hosted search plus its corrupt-row correction; GIT-092 publication remains separate. Phase 5 is entry-ready only after Phase 4 publication/cleanup and is still Unauthorized/Not started. SPEC-0012 remains independent from paused SPEC-0008 and cannot mutate animation/project content or resume any Animator phase.
