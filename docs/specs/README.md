...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; Phases 1–5 published/integrated/cleaned; Phase 6 accepted/technically Verified pending GIT-060** | GIT-059 is exact canonical commit `62feafc220c35eb1203dc4f19820e533a54002e1`. D-0068 accepts the exact 18-path Phase 6 result from that base at immutable manifest SHA-256 `5883ea735bd741b2f14e45d2fa84669ea3bb78ad5ed23693011e0280e4070902`, PASS/VALID with 18 source and 13 evidence bindings. GIT-060 publication/integration is next. Phase 7 remains unauthorized and not started. |
...
SPEC-0006 Phases 1–5 are Verified/published/integrated/recorded and cleaned up through exact GIT-059 `62feafc220c35eb1203dc4f19820e533a54002e1`. Arthur accepted Phase 6 under D-0068; its exact 18-path immutable manifest is PASS/VALID at SHA-256 `5883ea735bd741b2f14e45d2fa84669ea3bb78ad5ed23693011e0280e4070902`, with 18 source and 13 evidence bindings. CPA propagation is complete and GIT-060 publication/integration is next. Phase 7 remains unauthorized and not started.

The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. Phase 5 completed through GIT-059 and its cleanup. Phase 6 then completed through a separate stopped Spec Executor, Arthur acceptance and sequential CPA ownership transfer; GIT-060 now names its implementation/control-plane publication task, not a Phase 5 records-only self-closeout. Phase 7 requires Phase 6 publication/integration and separate authorization.
