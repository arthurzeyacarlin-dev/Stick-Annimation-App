...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Approved/active; Phase 1 fully closed; D-0091 Phase 2 research contract published in GIT-072; D-0092 automatic-commit correction review-ready/unpublished; Phase 2 Unauthorized/Not started** | D-0085–D-0088 create/approve/authorize/correct the six-phase contract. D-0089 accepts the exact 19-path Phase 1 correction; D-0090/GIT-070 close it. D-0091 integrates bounded Terra hosted internet research into existing Phase 2 and is published as exact 13-document GIT-072 `9b4b116d24b076b1c05d91a02fd7318ae5a44148`. D-0092 makes an explicit unambiguous create/edit message authorize an internally validated automatic one-transaction commit with visible result and Undo/Redo, while preserving active-work cancellation, plan-only no-op, focused ambiguity and explicit destructive intent. D-0092 awaits separate publication. Phase 2 and live search/video-provider use remain separately unauthorized/gated; Phases 3–6 remain unauthorized. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066. D-0085 creates SPEC-0008, D-0086/GIT-067 publishes its planning-only package, D-0087 authorizes Phase 1, and D-0089/D-0090/GIT-070 close its accepted corrected result. D-0091's bounded existing-Phase-2 internet-research correction is published/synchronized in GIT-072; D-0092's automatic-commit transaction correction is review-ready and awaits separate publication. Phase 2 remains Unauthorized/Not started and Phases 3–6 remain unauthorized. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
