...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Approved; Phases 1–2 fully closed; Phase 3 entry-ready but Unauthorized/Not started** | D-0105/GIT-081 `44cdafc…` close Phase 1. D-0106/D-0107/GIT-082 `7e7063e…` close Phase 2; manifest SHA-256 `444cf469…ccc2e2`, source digest `b11323e4…`; twelve-file preserved-proof inventory SHA-256 `b5717d6e…ee7`. Startup recovery remains absent and needs separate authorization. |
