...
| [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](0014-in-app-notification-center.md) | **Phase 1 accepted and technically Verified; GIT-099 publication pending; Phases 2–4 Unauthorized/Not started** | D-0138 binds Arthur's PASS of the fresh exact 19-path two-bell foundation from canonical base `a5ca805b…fa790`, immutable manifest SHA-256 `b1c082c2508b3039fdeacdd65f99ded4a9d49ed7cec99eb9aaff8352be143669`, empty index and stopped executor. Home has the all-event bell, Assistant its reply-only bell, other screens none. No production completion producer/handler is connected. Full production build retains an identical unrelated dev AI-cost baseline failure. Separate checked publication, proof preservation and D-0054 cleanup must finish before Phase 2 can be separately authorized. |
