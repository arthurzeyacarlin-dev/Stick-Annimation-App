...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 fully accepted/published/integrated through D-0130/GIT-094; Phase 5 entry-ready but unauthorized/not started; Phase 6 unauthorized/not started** | GIT-094 `7053851b…` publishes the exact 14-file D-0129 citation-recovery/reply-reveal result plus 15 reviewed records; canonical/origin/GitHub main synchronized and the integrated Assistant passed two consecutive live replies without disconnect/citation banners. |
