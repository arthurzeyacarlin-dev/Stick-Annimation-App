...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Proposed; planning complete; no implementation phase authorized** | D-0102 defines exactly three separately gated phases: Save and Exit; one separate local latest emergency recovery draft; and startup Recover Work / Discard Draft plus final safety proof. Recovery never silently changes an official project. No executor/app copy/runtime work, Git publication, cloud/network/AI/provider work, or phase authorization exists. |
