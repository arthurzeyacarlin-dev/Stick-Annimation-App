...
| [`SPEC-0009 — Animation Export`](0009-animation-export.md) | **Approved; Phase 1 accepted and technically Verified; propagation complete; publication/integration pending; Phases 2–3 Unauthorized** | D-0096 records Arthur's approval and acceptance of the corrected Choose and Watch app copy. Exact 12-path Phase 1 result on base `37cdb7203286c2ea333a3766ba2e81bc06830200`; immutable manifest SHA-256 `40af1b220958a5d99094a07c763194b4cb6e2338ee6e14f0b2674a671564c2fb`. It adds no video encoder, Finder writer, destination catalog, social login/upload/post or Phase 2 authority. |
