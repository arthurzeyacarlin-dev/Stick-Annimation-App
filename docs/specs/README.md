...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phase 1 Verified/published/integrated; Phase 2 accepted/technically Verified/publication pending | D-0036's exact 17-path provider-free Phase 1 engine is published/integrated within exact 28-path commit `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-034 published D-0037's Phase 2 activation at `70bf7b0799bcff8d703525bcb50c378b8a122ebf`; D-0039 accepts the exact eight-path hidden local motion engine with independent ordinary keyframes and no blue-box/product helper. Its 11,493-byte manifest SHA-256 is `a6e656d930781b589a3350abec62000818fade6553638ada0899ec7183b24d3f`. GIT-035 publication is next. Phases 3–8 remain unauthorized; no Phase 2.5 app code, provider/API/paid/Drawing/workspace-integration work is authorized. |

SPEC-0004 Phase 1 is Verified, published, and integrated under D-0036/GIT-033 at `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-034 then published Phase 2's activation at `70bf7b0799bcff8d703525bcb50c378b8a122ebf`. Arthur accepted the stopped exact eight-path result under D-0039 after reviewing four ordinary samples with no blue box. The prior live validator passed 210 checks; CPA closeout revalidated all 29 durable manifest bindings after review-server cleanup. Phase 2 is technically Verified but remains unpublished/unintegrated pending GIT-035. No provider/API activity, paid proof, deployment, Phase 2.5 app code, Phase 3–8 authorization, or Drawing/workspace integration exists.
