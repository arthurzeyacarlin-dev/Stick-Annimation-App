...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1 and historical Phase 1.5 are **Verified, published, and integrated**. The §10.4A compatibility correction is **technically Verified/accepted in its dedicated worktree; unpublished/unintegrated** with technical-manifest SHA-256 `53202d21ba7248e46a3e3423a623fbc785b5c3beedd6dd4d2a984b37614cffe8`. Phase 2 is **Authorized; Not started; blocked** until correction publication/integration, both clean committed tester gates, and a later activation. Product Phase 2 was not implemented or tested. Phases 3–7 are **Unauthorized; Not started**. |
...
The correction remains unstaged, unpublished, and unintegrated. A separate publication-only instruction must commit the accepted 23 paths plus the reviewed eight control-plane paths, then run the exact no-plan tester and the byte-identical synthetic `--plan` in clean-committed mode before canonical-main integration/push. Only after that publication/integration and a later activation naming a new base/executor may Phase 2 begin. Phases 3–7, the Phase 7 Policy Gate, provider choices, external lookups, and paid/live requests remain unauthorized.
