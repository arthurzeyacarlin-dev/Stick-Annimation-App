...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, and the §10.4A compatibility correction are **Verified, published, and integrated**. Phase 2 is **Verified and accepted; ready for publication; not yet published/integrated** from exact base `68338d54542bbfd3fb1f0fab06548f0424871f80`; its accepted 4,351-byte prior-definition 27-path aggregate is `d5526fcba1e0480a20164ab73d8391f49edf6fc66378d641e8b2c0c951fcabd2` and its 33,410-byte proof-manifest SHA-256 is `87a24054299da3037e6682bc50595fd8be3c7004222287c3433156264b322212`. Phases 3–7 are **Unauthorized; Not started**. |
...
SPEC-0003 remains a separate **Proposed; inactive** draft in its own worktree. It is not present on canonical `main`, is not linked as an active canonical spec here, and authorizes no implementation. This compatibility closeout does not copy, merge, edit, or activate it.
...
The correction was published and integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Phase 2 subsequently started from exact activation base `68338d54542bbfd3fb1f0fab06548f0424871f80` and is now Verified and accepted, ready for separate publication, but not yet published/integrated. Its accepted 4,351-byte prior-definition technical aggregate is `d5526fcba1e0480a20164ab73d8391f49edf6fc66378d641e8b2c0c951fcabd2`; its 33,410-byte proof-manifest SHA-256 is `87a24054299da3037e6682bc50595fd8be3c7004222287c3433156264b322212`. The manifest records 277 Phase 2 assertions, 631 Phase 1 regressions, TypeScript, measured lint, diff check, and 86/86 browser actions with 4 checkpoints, 1 screenshot, all five protected regression groups, zero non-loopback attempts, zero real API-route requests, and full cleanup. Drawing Save was not automated; Arthur's separate manual Save verification is human evidence only. The accepted proof corrections are stable driver-key ordering, closeout-safe validation, shared UTF-8 byte-wise canonical path order with strict equality/mixed-case proof, and nested `phase-2-closeout` context propagation through the browser-result validation graph. The executor addendum rejects its alternative stable-JSON report beginning `1dd18` as the wrong aggregate definition without indicating byte drift. Phases 3–7, the Phase 7 Policy Gate, provider choices, external lookups, and paid/live requests remain unauthorized.
