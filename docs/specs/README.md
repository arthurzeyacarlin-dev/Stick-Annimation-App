...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1 and historical Phase 1.5 are **Verified, published, and integrated**. The §10.4A compatibility correction and both clean-committed publication gates are **Verified, published, and integrated** at exact prerequisite and tested runtime/proof foundation `e07268cc80751baba99ac6708a1e8a93d4fc4756`; technical-manifest SHA-256 is `53202d21ba7248e46a3e3423a623fbc785b5c3beedd6dd4d2a984b37614cffe8` and closeout SHA-256 is `8972c63420728183ad27454cb5484ab0859361b8fd92797f0531bdc79a773b30`. Phase 2 is **Authorized; Not started** and becomes dispatchable only after this activation record is separately reviewed, published, and integrated. Product Phase 2 was not implemented or tested. Phases 3–7 are **Unauthorized; Not started**. |
...
The correction was published and integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Its clean no-plan gate passed 40 ordered operations, 13 screenshots, 4 tester-driver messages, and exactly one deterministic mocked Drawing POST with zero real API/non-loopback violations. Its byte-identical synthetic gate derived `clean-committed`, observed `[]`, selected `cleanExpectedPaths: []`, proved the exact accepted 23-path base projection, and matched the accepted catalog/plan/registry/adapter bindings while executing 27 closed actions, 4 checkpoints, and 1 screenshot. Product Phase 2 and Drawing Save were not tested; Arthur's manual Save verification is separate evidence. Phase 2 becomes dispatchable only after this seven-file activation record is separately reviewed, published, and integrated. The later publication report must resolve the resulting clean canonical-main activation-publication SHA and copy it exactly into the new Plan-mode executor handoff; after main advances, the executor must not use `e07268c`. Phases 3–7, the Phase 7 Policy Gate, provider choices, external lookups, and paid/live requests remain unauthorized.
