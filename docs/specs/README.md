...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, and §10.4A remain Verified/published/integrated. The original Phase 2 bytes remain historically published/integrated in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, but Arthur rejected their visible product result. The D-0017 §10.5A correction is **Verified, published, and integrated** in exact 29-path canonical-main commit `edfb3dea023119b91336e6e5da645d4982a9f068`. Its exact 20 implementation/proof paths remain bound to manifest SHA-256 `edda3028b9fbe2759e31059455f16cc3ee02ac9b242149107454071dae62de90`; the correction-specific finalizer remains SHA-256 `e6795e9f686117d89824bea4f9de3ed766077ba9a8d00c51c27b074708c396f9`. D-0018 remains the exact Phase 3 Stick onion contract, D-0019 marks Phase 3 **Authorized; Not started**, and D-0020 accepts the exact tester-registration/Creator-preservation correction. Publish the accepted corrected §10.6 record before dispatching a replacement executor. Phases 4–7 remain **Unauthorized; Not started**. SPEC-0002 is complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched. |
...
The correction was published and integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Phase 2 subsequently started from exact activation base `68338d54542bbfd3fb1f0fab06548f0424871f80` and its exact 36-path result was published in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. Its historical technical/closeout evidence and hashes remain preserved. On 2026-08-18 Arthur rejected that visible workspace result, and D-0017 authorized §10.5A's exact `68338d…` shell restoration plus current-Drawing-style applicable timeline and independent keyframes. Arthur visibly accepted the exact 20-path executor result, and the Control Plane Architect revalidated its 15/15 action plan, compact screenshots, five protected groups, deterministic/type/lint/diff receipts, exact hashes, and manifest SHA-256 `edda3028b9fbe2759e31059455f16cc3ee02ac9b242149107454071dae62de90`. The exact 29-path correction was then published and integrated at `edfb3dea023119b91336e6e5da645d4982a9f068`; D-0019's Phase 3 activation was published at `45504214dffb528e930194b93fc2ab78dc730ebc`. The stopped Phase 3 executor then proved that the two-entry tester cannot register or dispatch Phase 3 and changed no file. D-0020 accepts corrected §10.6's exact additive v3 tester ceiling, preservation of older modes, removal of the rejected Creator lock, and two-viewport protection of the §10.5A shell. D-0018 remains exact; Phase 3 stays Authorized/Not started pending correction publication. Tweening/in-betweens/easing/motion frames remain deferred. Phases 4–7 remain unauthorized and not started.
