...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Approved; Phase 1 Authorized/Not started; Phases 2–3 Unauthorized/Not started** | GIT-080 `cb80f2b…` publishes the three-phase plan. D-0103 approves it and authorizes one fresh Phase 1 Save-and-Exit executor after activation-record publication. Recovery storage/startup recovery, cloud/network/AI/provider work and later phases remain unauthorized. |
