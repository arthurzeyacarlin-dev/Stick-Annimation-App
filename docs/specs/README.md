...
| [`SPEC-0007 — Manual Editor Completion and AI-Ready Tools`](0007-manual-editor-completion-and-ai-ready-tools.md) | **Approved and active** | D-0072 accepts the exact Proposed preimage and authorizes Phase 1 — Drawing Tool Stabilization as **Authorized; Not started**, entry-gated on activation publication/synchronization. Phases 2–7 remain unauthorized. No runtime, AI/provider/model/prompt/API, video/tracking, deployment, or implementation behavior changes in this activation. |
