...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Approved/active; Phase 1 Authorized/Not started; Phases 2–3 Unauthorized/Not started** | D-0110 fixes the three-phase local plan and its reuse/safety/proof gates. D-0111 authorizes exactly one fresh Phase 1 Spec Executor after activation publication. No later phase, external/paid activity, implementation publication, or deployment authority. |
