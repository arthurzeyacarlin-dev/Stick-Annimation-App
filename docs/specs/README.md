...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phases 1 and 2 Verified/published/integrated; Phase 2.5 accepted/technically Verified/pending publication; Phase 2.6 Approved/Authorized/Not started | D-0036's Phase 1 engine is published/integrated in exact 28-path commit `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-035 published D-0039's exact eight-path Phase 2 engine in exact 20-path commit `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`. D-0041 accepts the exact seven-path Phase 2.5 result only as the timing/spacing primitive; its 14,601-byte manifest SHA-256 is `783e6396cf994ce48fb9d7c94dc58674594dd545f888a9c25fe3c1f654a788d1`, while its old samples remain rejected as natural-action evidence. D-0041 also authorizes final Phase 2.6; GIT-037 publication/integration is the remaining entry gate. Phases 3–8 remain unauthorized, and no Phase 2.7 exists. |

SPEC-0004 Phase 1 is Verified, published, and integrated under D-0036/GIT-033 at `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-034 published Phase 2's activation at `70bf7b0799bcff8d703525bcb50c378b8a122ebf`; GIT-035 published the accepted result at `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`. The prior live validator passed 210 checks; CPA closeout revalidated all 19 unique durable artifacts after review-server cleanup; and the clean publication tester passed 40 operations and 13 screenshots with zero real-route/non-loopback/provider requests. GIT-036 published the Phase 2.5 activation at `a755f892d7737c6a10d9c381ec59c1e2fdba4d47`. D-0041 now accepts its exact stopped seven-path result narrowly as the timing/spacing primitive and authorizes the decision-complete final Phase 2.6 shared action foundation. GIT-037 must publish/integrate the accepted Phase 2.5 bytes and reviewed records before Phase 2.6 begins. No provider/API activity, paid proof, deployment, Phase 3–8 authorization, Phase 2.7, or Drawing/workspace integration exists.
