...
| [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](0014-in-app-notification-center.md) | **Phase 1 fully closed; Phase 2 accepted/technically Verified/control-plane-recorded but unpublished; Phases 3–4 Unauthorized/Not started** | D-0138/D-0139/GIT-099 close the exact 19-path two-bell foundation in commit `06365eacffe493ea3550de71b3baff0f57bf03b2`. D-0140 binds Arthur's accepted 21-path Phase 2 correction from base `acd4031cade0e4e960223190a8c1645d007d61af` to immutable manifest SHA-256 `77bc08b62c472d9ed0f75a2cd6b7d9b4b84d3f9b2e75d89645738567904ae8e7`. Root Assistant/Terra observers publish source-verified terminal results; two existing bells show unread-only items and exact chat/project target navigation. Full build retains the unchanged unrelated dev AI-cost baseline failure. GIT-100 publication/proof preservation/cleanup remain pending; Phase 3 needs full closeout and separate Arthur authorization. |
...
D-0135/D-0136/GIT-097 close SPEC-0013. D-0137 created SPEC-0014's four separately gated phases. D-0138/D-0139/GIT-099 fully closed Phase 1; D-0140 accepts and technically verifies corrected Phase 2 in a separate worktree, with GIT-100 pending. Export Phase 3 and offline/reliability Phase 4 remain Unauthorized/Not started.
