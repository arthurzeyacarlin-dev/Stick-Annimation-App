...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Approved/active; Phase 1 Accepted/technically Verified after control-plane propagation; publication/integration pending; Phases 2–3 Unauthorized/Not started** | D-0112 binds Arthur's PASS, the exact 15-path implementation from base `0169c09…`, immutable manifest SHA-256 `69a169bd…39b6`, and the accepted real local library/playback-only modal/shared-player result. Publication, proof preservation and cleanup are pending the already-authorized separate publication turn. Fullscreen/synchronized audio remain Phase 2; shared management remains Phase 3. |
