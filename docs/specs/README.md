...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Proposed; decision-complete and review-ready** | D-0085 creates the six-phase contract and resolves the intended bounded V1 sequence. No phase is implementation-authorized. Phase 1 is ready for Arthur's separate approval/authorization after this proposal is reviewed and published; Phases 2–6 retain their predecessor and named provider/security/cost/privacy entry gates. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066. D-0085 creates SPEC-0008 as Proposed/review-ready with no implementation phase authorized; Phase 1 is the next possible separately approved implementation action after proposal publication. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
