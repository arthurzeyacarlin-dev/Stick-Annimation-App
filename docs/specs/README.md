...
| [`SPEC-0006 — Unified Animation Workspace`](0006-unified-animation-workspace.md) | **Approved; active; Phase 1 published; Phase 2 technically Verified/publication pending** | GIT-051 published/integrated Phase 1 at `804ff39dc73c88d4799570cce2ef18987745a0be`. D-0059 records Arthur/PM acceptance of the corrected exact 15-path Phase 2 shell/New/Open result; GIT-052 publication/integration remains pending. Phases 3–7 remain Unauthorized/Not started. SPEC-0006 alone owns unification. |
...
SPEC-0006 is **Approved and active** under D-0057. GIT-051 published/integrated Phase 1 at `804ff39dc73c88d4799570cce2ef18987745a0be`. D-0059 records the corrected exact 15-path Phase 2 result as accepted and technically Verified pending GIT-052 publication/integration. Phase 2 changes direct New, one combined inherited Projects collection, and one compatibility-editor mount; it does not merge the editor internals or persistence. **Phases 3–7 remain Unauthorized; Not started.** Future SPEC-0007/0008 remain absent and unauthorized. No new AI/provider/model/video/tracking, paid service, or deployment is authorized.

Next step is GIT-052 publication of the exact reviewed Phase 2 technical/control-plane allowlist in the later authorized publication task. Phase 3 requires a later explicit owner authorization after clean Phase 2 integration.
