...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1 and historical Phase 1.5 are **Verified, published, and integrated**. D-0015 and its activation are published at `a85690de9396cf97e3063005cbb6da85f109ae1d`. Phase 2 is **Authorized; Not started; blocked** by the embedded Phase 1.5 compatibility correction, which is **Approved; Authorized; Not started** under D-0016 pending separate publication/integration. Phases 3–7 are **Unauthorized; Not started**. |
