...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 accepted/published/integrated through GIT-093; D-0129 final Phase 4 correction accepted with GIT-094 publication pending; Phase 5 unauthorized/not started; Phase 6 unauthorized/not started** | D-0129 binds the exact 14-file citation-recovery/reply-reveal result from base `741ee803…b17`, manifest `f611cfa7…ba9e`, source digest `aa6c1d79…da54`; GIT-094 is explicitly authorized to publish/integrate it. |
