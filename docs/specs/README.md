...
| [`SPEC-0014 — Durable In-App Notification Center and Background Completion`](0014-in-app-notification-center.md) | **Phase 1 Verified/published/integrated/synchronized/proof-preserved/cleaned up; Phases 2–4 Unauthorized/Not started** | D-0138/D-0139/GIT-099 close the fresh exact 19-path two-bell foundation in exact 33-path commit `06365eacffe493ea3550de71b3baff0f57bf03b2`, with immutable manifest SHA-256 `b1c082c2508b3039fdeacdd65f99ded4a9d49ed7cec99eb9aaff8352be143669`. Home has the all-event bell, Assistant its reply-only bell, other screens none. No production completion producer/handler is connected. Full production build retains an identical unrelated dev AI-cost baseline failure. Proof is preserved, review port 58420 closed, and D-0054 cleanup complete. Phase 2 is entry-ready only; separate Arthur authorization is still required. |
