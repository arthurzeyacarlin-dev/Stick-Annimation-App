...
| [`SPEC-0007 — Drawing-Only Manual Editor Completion and AI-Ready Tools`](0007-manual-editor-completion-and-ai-ready-tools.md) | **Approved and active; Phases 1–3 closed** | GIT-062 closes Phase 1, GIT-063 closes Phase 2, and D-0079/D-0080/GIT-064 `b8d3b37…` close Phase 3 with publication/integration, proof preservation and cleanup. Phase 4 is ready for separate authorization but remains unauthorized; Phase 5 remains unauthorized. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is Approved/active under D-0074; Phases 1–3 are closed through GIT-062/GIT-063/GIT-064. Phase 4 is ready for separate authorization but remains unauthorized; Phase 5 and future SPEC-0008 work remain unauthorized. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
