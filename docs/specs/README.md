...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phases 1–4 fully closed; Phase 5 entry-ready but unauthorized/not started; Phase 6 unauthorized/not started** | D-0125 binds Phase 4's exact 27-path hosted-search/citation/activity plus corrupt-row correction result. D-0126/GIT-092 `2381616…` publishes/integrates the 42-path package, preserves proof, activates canonical runtime and completes cleanup. Final manifest SHA-256 `08ff725e…095`, validation receipt `3107a15f…060`, source digest `073bc363…fd`. Phase 5 requires separate authorization. |
...
D-0120 created SPEC-0012; GIT-089 published the plan. D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125 accepts and technically verifies Phase 4 hosted search plus its corrupt-row correction; D-0126/GIT-092 `2381616…` publishes/integrates it, preserves proof, activates canonical runtime and completes cleanup. Phase 5 is entry-ready but still Unauthorized/Not started. SPEC-0012 remains independent from paused SPEC-0008 and cannot mutate animation/project content or resume any Animator phase.
