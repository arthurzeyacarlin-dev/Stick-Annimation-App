...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved; Phase 1 Verified/published/integrated; Phase 2 Approved/Authorized/Not started | D-0043 accepts the seven-phase direction. D-0044's exact six-path Phase 1 proof-only gate is published/integrated within exact 20-path commit `2436a9414221e8ee7ef40151284cb8f4e069e828`; its 10,011-byte manifest SHA-256 is `af287680b7ae73fd4c543edf8076d9fbb7fb65474a5d4508f8b17dde56174e84`. D-0045 authorizes only Phase 2's exact nine-path action-independent whole-body key-pose maker, but implementation waits for separate publication of this activation record. Phases 3–7 remain Unauthorized/Not started. |
