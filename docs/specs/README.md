...
| [`SPEC-0004 — One-Time Stick Figure AI Animator`](0004-future-real-ai-animator-requirements.md) | Phases 1 and 2 Verified/published/integrated; Phase 2.5 Approved/Authorized/Not started; activation published | D-0036's Phase 1 engine is published/integrated in exact 28-path commit `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-035 published D-0039's exact eight-path Phase 2 hidden local motion engine plus reviewed records in exact 20-path commit `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`; its 11,493-byte manifest SHA-256 is `a6e656d930781b589a3350abec62000818fade6553638ada0899ec7183b24d3f`. D-0040 authorizes Phase 2.5; GIT-036 published its docs-only activation at `a755f892d7737c6a10d9c381ec59c1e2fdba4d47`, so one new Plan-mode executor is next. Phases 3–8 remain unauthorized; no Phase 2.5 app code, provider/API/paid/Drawing/workspace-integration work is authorized. |

SPEC-0004 Phase 1 is Verified, published, and integrated under D-0036/GIT-033 at `086420e6b0cbe683adbb8f0024e65a2fc1d68d6d`. GIT-034 published Phase 2's activation at `70bf7b0799bcff8d703525bcb50c378b8a122ebf`; GIT-035 published the accepted result at `e3ec6a33438c2f3d2e075b6477f18b8eb1b58e24`. The prior live validator passed 210 checks; CPA closeout revalidated all 19 unique durable artifacts after review-server cleanup; and the clean publication tester passed 40 operations and 13 screenshots with zero real-route/non-loopback/provider requests. D-0040 makes Phase 2.5 decision-complete and authorized; GIT-036 published this docs-only activation at `a755f892d7737c6a10d9c381ec59c1e2fdba4d47`. One new Plan-mode Phase 2.5 executor is next. No provider/API activity, paid proof, deployment, Phase 3–8 authorization, or Drawing/workspace integration exists.
