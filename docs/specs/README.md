...
| [`SPEC-0002 — Lossless Local Drawing Save and Reopen`](0002-lossless-local-drawing-save-and-reopen.md) | Approved | Phase 1 is **Verified, published, and integrated** at `0416fc3828a863a797ee9f1c3daa8508792ac64a`. D-0014 is published/integrated at `8062274a83776e635e8ed81d9cd2c272d068bc56`, and the independent Phase 2 manifest correction is published/integrated at `727a1d9c8fb8fa93e40cb4484949cf499709e17e`. Phase 2 remains **Authorized; Not started** until the permanent-tester compatibility correction is reviewed and separately published. |

## Proposed Specs

No additional specification is currently Proposed.

SPEC-0002 approves a strict version-2 local Drawing record, lossless raster/audio assets, non-destructive version-1 compatibility, transactional failure safety, finite capacity, and truthful Save/Open presentation. Its corrected 34-path Phase 1 implementation and eight reviewed control-plane paths were published/integrated in exact commit `0416fc3828a863a797ee9f1c3daa8508792ac64a`, parent `82663051b30cdcfd6766cf4714cdeb2306970045`, with exactly 42 paths. Technical-manifest SHA-256 remains `2d20a4a63103618505b60cf590835191841d1c1968bc2bc14ef2c953253243a1`; closeout-manifest SHA-256 remains `b2d50852cffa40dbf3d7535665a12abe66439cfceeffc61d6eb56195ff947b3c`. The hidden engine remains unwired, so visible Drawing Save/Open/Delete still uses the V1 path. D-0014 was published/integrated at `8062274a83776e635e8ed81d9cd2c272d068bc56`, and the six-path proof-contract correction was published/integrated at `727a1d9c8fb8fa93e40cb4484949cf499709e17e`, leaving the Phase 1 validator byte-identical and assigning independent Phase 2 validation to `scripts/spec0002-browser/validatePhase2.ts`. A fresh stopped preflight then proved that the frozen permanent SPEC-0001 tester correctly rejects Phase 2's dirty implementation. The compatibility correction keeps the exact npm tester as clean pre-edit and post-commit/pre-integration gates and moves dirty-time regression proof to the already-authorized Phase 2 runner's versioned mode. One new Plan-mode executor may start only after this correction is reviewed/separately published, its conflict audit passes, and the clean pre-edit tester passes. SPEC-0001's status and authorization are unchanged.
