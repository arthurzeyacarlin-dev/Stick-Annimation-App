...
| [`SPEC-0011 — My Projects Library, Movie Viewer, and Shared Project Management`](0011-my-projects-library-movie-viewer-and-shared-project-management.md) | **Proposed; planning complete; all three phases Unauthorized/Not started** | D-0110 fixes the three-phase local plan and its reuse/safety/proof gates. Proposal approval, activation publication, and separate Phase 1 authorization are still required. No implementation, external/paid activity, or Git publication authority. |
