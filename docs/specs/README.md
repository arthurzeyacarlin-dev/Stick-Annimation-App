...
| [`SPEC-0008 — Conversational AI Animator and Editable Video Reconstruction`](0008-conversational-ai-animator.md) | **Proposed; published; awaiting owner approval** | D-0085 creates the six-phase contract and resolves the intended bounded V1 sequence; D-0086/GIT-067 publishes the exact planning-only package at `ba5ecd694df78414240ce83a9140c5196334ebdc`. No phase is implementation-authorized. Phase 1 is ready only after Arthur separately approves SPEC-0008 and authorizes Phase 1; Phases 2–6 retain their predecessor and named provider/security/cost/privacy entry gates. |
...
The corrected 4A → stopped-owner checkpoint → 4B sequence remains complete. SPEC-0006 is closed through GIT-061. Drawing-only SPEC-0007 is fully closed through D-0083/D-0084/GIT-066. D-0085 creates SPEC-0008 as Proposed/review-ready and D-0086/GIT-067 publishes its planning-only package; no implementation phase is authorized. Phase 1 is the next possible action only after separate owner approval and authorization. D-0072's prior proposal, D-0073's `/4bb1/` evidence, and rejected `/3cd3/` remain historical.
