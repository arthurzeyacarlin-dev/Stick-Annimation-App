...
| [`SPEC-0005 — Professional Shared Stick Motion Engine`](0005-professional-shared-stick-motion-engine.md) | Approved; Phases 1–2 Verified/published/integrated; Phase 3 Approved/Authorized/Not started pending GIT-044; Phases 4–8 Unauthorized/Not started | GIT-043 published the exact accepted 21-path Phase 2 package at `e52454354c39b962ac2710a8602a5306ffd62ad5`. Its correction manifest SHA-256 remains `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874`; historical `ea7ab9c5…` evidence remains preserved. The clean tester result SHA-256 is `c2887be734fe073191aa7d81fc9ffcf2cd6009da0bd188b67ddd9ad77aaebb63`. D-0049 authorizes only the existing Phase 3 grounded non-locomotion whole-body pose contract; GIT-044 publication must establish its executor base before implementation. |
