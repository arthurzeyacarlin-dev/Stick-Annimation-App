...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, and §10.4A remain Verified/published/integrated. The original Phase 2 bytes remain historically published/integrated in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`, but Arthur rejected their visible product result. The D-0017 §10.5A correction is **Verified and accepted in its dedicated worktree; pending separate publication/integration**. Its exact 20 implementation/proof paths bind to manifest SHA-256 `edda3028b9fbe2759e31059455f16cc3ee02ac9b242149107454071dae62de90`; the accepted correction-specific finalizer repair has SHA-256 `e6795e9f686117d89824bea4f9de3ed766077ba9a8d00c51c27b074708c396f9` and produces the valid ignored 29-path tracked-state closeout. D-0018 fixes future Stick onion behavior inside Phase 3. Phases 3–7 remain **Unauthorized; Not started**. SPEC-0002 is complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched. |
