...
| [`SPEC-0012 — Diamond Animator Guidance Assistant`](0012-diamond-animator-guidance-assistant.md) | **Active; Phase 1 accepted/technically verified and publication authorized; Phases 2–6 unauthorized/not started** | GIT-089 `f2bda338…` published the D-0120 plan. D-0121/D-0122 bind Arthur's separate Phase 1 authorization/PASS and the exact eleven-path corrected shell result at manifest SHA-256 `3d25091e…`. Publication/integration is authorized but not yet claimed by this propagation record. Phase 2 starts only after clean synchronization, proof preservation, D-0054 cleanup, and separate Arthur authorization. |
...
D-0120 created SPEC-0012 from Arthur's accepted six-phase guidance-Assistant direction; GIT-089 `f2bda33842a3f5a4b560a7d3aab170a6ca4c2fd0` published that plan. D-0121/D-0122 now authorize and accept Phase 1 only. SPEC-0012 remains independent from paused SPEC-0008: it cannot mutate animation/project content and cannot resume any Animator phase.
