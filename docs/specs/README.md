...
| [`SPEC-0010 — Project Safety and Recovery`](0010-project-safety-and-recovery.md) | **Approved; Phase 1 fully closed; Phase 2 accepted/technically Verified with publication authorized/pending; Phase 3 Unauthorized/Not started** | D-0105/GIT-081 `44cdafc…` close Phase 1. D-0106 accepts Phase 2's corrected exact eleven-path result; manifest SHA-256 `444cf4695574a6d7653a628e4a3a2035db3305054d2a76905e73cd3fa0ccc2e2`, source digest `b11323e4…`. Startup recovery remains absent and unauthorized. |
