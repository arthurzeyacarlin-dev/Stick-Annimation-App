...
| [`SPEC-0009 — Animation Export`](0009-animation-export.md) | **Proposed; planning published in GIT-074; not Approved; no implementation phase authorized** | D-0094 preserves the accepted three-phase local export proposal: Choose and Watch; Create and Save Video; Social Destinations and Final Testing. D-0095 records planning publication at `30f6f85e5c483c9df15946e7a451bf2a31374f2e`. No phase may begin without whole-spec approval and a separate phase authorization. No AI/provider/social-account/deployment behavior is included. |
