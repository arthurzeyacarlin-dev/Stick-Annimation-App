...
| --- | --- | --- |
| [`SPEC-0001 — First Reversible AI-Created Stick Animation from Workspace Chat`](0001-first-reversible-ai-stick-animation.md) | Approved | Phase 1, historical Phase 1.5, §10.4A, §10.5A, Phase 3, and Phase 4 are Verified/published/integrated. The exact 22 technical plus eight reviewed canonical record paths for Phase 4 are published in `71841e96499f7627139c53d87114bba65e19d29d`, parent `62f046adff7418d2e644365fc04bd5d6312dcca9`, with technical-manifest SHA-256 `d34d589373713ac7930984aeb3ef0640539316c00e1f510cf8d798aee931bf46` and browser-runner SHA-256 `353f4937972d30b1959f1c7aee3075f5ebafb308d04a778db69372969e7b906f`. D-0024's Phase 5 activation is published at `245ac7e8bceeca76b522ff21c4327fa0219a3805`; D-0025 keeps Phase 5 **Authorized; Not started** and defines its exact 24-path ceiling (14 original product/fixture/validator paths plus 10 shared route-only tester paths). Its replacement executor base is the future correction-publication SHA. Phases 6 and 7 remain **Unauthorized; Not started**. SPEC-0002 is complete/protected; SPEC-0003 remains separate Proposed/inactive and untouched. |
...
The correction was published and integrated in exact canonical-main commit `e07268cc80751baba99ac6708a1e8a93d4fc4756`. Phase 2 subsequently started from exact activation base `68338d54542bbfd3fb1f0fab06548f0424871f80` and its historical result was published in `adbda9dd4f42a103c3c5af41ccc19b110b6825c0`. After Arthur rejected that visible result, D-0017's §10.5A correction was accepted and published at `edfb3dea023119b91336e6e5da645d4982a9f068`; D-0019 activation was published at `45504214dffb528e930194b93fc2ab78dc730ebc`; and D-0020's Phase 3 boundary was published at `54234b7c7b95201e274975a804859fa9c36806a1`. The later bounded Drawing-memory proof correction enabled a fresh 11-command Phase 3 manifest. A separately accepted two-file proof-only correction then added the missing strict Phase 3 closeout context for the exact 30 technical plus eight record paths without changing accepted product behavior. Arthur accepted the exact result after visible review. Technical-manifest SHA-256 is `07bd09c413a28ffcc706be85d00d1d4466cde1e336daceab23d9a1617153b675`; Phase 3 was then published/integrated in exact 38-path canonical-main commit `3fe3a5487389647b67216e9466121e00f1a73856`. D-0018 remains exact. D-0022's narrow additive Phase 4 permission record was published in exact seven-path activation commit `62f046adff7418d2e644365fc04bd5d6312dcca9`. The stopped executor then completed exactly 22 technical paths. Its 12-receipt/61-artifact manifest revalidates at SHA-256 `d34d589373713ac7930984aeb3ef0640539316c00e1f510cf8d798aee931bf46`; the 105-action/31-checkpoint/2-screenshot browser result has SHA-256 `353f4937972d30b1959f1c7aee3075f5ebafb308d04a778db69372969e7b906f`. Arthur accepted Play, atomic Undo/Redo, manual joint drag, and Creator/Back, recorded by D-0023. The exact 30-path result was then published/integrated in `71841e96499f7627139c53d87114bba65e19d29d`. Tweening/in-betweens/easing/motion frames remain deferred. D-0024's activation was published in exact seven-document commit `245ac7e8bceeca76b522ff21c4327fa0219a3805`. Its fresh executor stopped cleanly before edits because the tester support ended at Phase 4. D-0025 keeps Phase 5 **Authorized; Not started** and adds only the exact 10 shared paths required for registered route-only v5 proof, for 24 technical paths total; Phases 6 and 7 remain unauthorized and not started.
