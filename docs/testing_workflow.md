...
D-0094 and [`SPEC-0009`](specs/0009-animation-export.md) define exactly three separately gated phases. D-0095/GIT-074 records publication of the planning-only package at `30f6f85e5c483c9df15946e7a451bf2a31374f2e`; this is not implementation proof. The proposal remains Proposed; no phase is Approved or authorized and no runtime/test/fixture/dependency/provider proof has been created.
