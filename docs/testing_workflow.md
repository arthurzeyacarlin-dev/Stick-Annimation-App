...
## Historical SPEC-0014 proof override — D-0141 Phase 3 rejection and Phase 4 boundary
...
The deterministic oracle and real Chromium suite each passed 42 assertions. The corrected flow includes watched exact-origin silence, unread-only Home/Assistant panels, one shared Assistant event/read state, human-readable chat/project labels, same-route other-chat and Home exact navigation, arrival-confirmed clearing, and safe unread unavailable targets. Sixteen protected static and four protected browser receipts cover Home/Assistant/search/retry/synthetic dictation/Terra and unrelated editor/Export behavior. TypeScript, focused lint/build and diff passed. The manifest records nine explicit Assistant and seven explicit Terra local proof submissions, zero automatic resubmits, zero automated external/provider/paid/live AI calls and byte-identical protected runtime outside the 21-path allowlist. Full Webpack production build remains `BLOCKED_BY_VERIFIED_BASELINE` on the identical untouched dev AI-cost `PageProps` route; full lint retains five inherited errors. Native OS focus, physical microphone/devices and non-Chromium are not proven. GIT-100 published/integrated the exact sealed technical bytes; the canonical port-3000 app's Home and Assistant unread-only bell panels were inspected without sending any AI request. No post-publication live AI completion was exercised.

## Historical SPEC-0014 Phase 1 accepted and published proof — D-0138/D-0139/GIT-099
...
D-0136/GIT-097 publishes exact 21-path commit `893daa82f555381d775af8fb73b14a551bd5fb45`: seven accepted technical plus fourteen reviewed control-plane/tree paths. Canonical/origin/live GitHub `main` synchronized at clean `0/0` before terminal closeout. Thirteen proof files/262,442 bytes are preserved under `output/recovery/GIT-097-spec0013-phase1-893daa8/phase-1` with source/destination aggregate SHA-256 `cbe9142a42612f73f8e9cdec11452859085f98f4026dd7f21a3df48acc117d4b`. Control-plane closeout manifest SHA-256 is `9346eb3eb1f1b7997e8339d5db2df0d6a1cd737e9e8be429b351fc8aaa938e6c`. Port 58080 is closed and D-0054 cleanup is complete.
...
D-0129 proof is sealed at manifest SHA-256 `f611cfa77811685f9ddc208df3d314f1710a8bfb9ceac3fcedf058818780ba9e`, receipt `171c22eb1f7c00cf38cb9b71f12f08bf66a3fc838fbad48ae9b98e226ba6fc2b`, source digest `aa6c1d7954a97d9cb9fab1502d2ba7639f10246c98be03bbfc968ecb9605da54`; 25 completions and 208 reveal assertions pass at 100% with zero duplicates/reload replays, six protected browser suites and zero real/paid calls.
...
- Combined Phase 2/absorbed Phase 3: PASS/accepted. Final manifest SHA-256 `b6251390f20e8bb7dfe26208241b163c3f306e197ae37ace5340b6a8f572350c`, source digest `304ef20707128abef122355ccf5e0692ed7663be45e75cb3640d519f500e88d7`, 34 sources/116 evidence/34 mutation rejections. It proves blank-chat non-persistence; 49→50→blocked no eviction; first-send/title/manual-title/rename/delete; 200-message/1 MiB/32 MiB bounds; long-chat/restart/fault/two-tab safety; strict fixed-Terra route/jobs/catalog/context/output/deadline/concurrency/identity/cancel/cost receipts; and zero project mutation. Final correction adds 120 successful provider/SDK-double requests across four legacy-budget states and twelve consecutive browser Sends, proving cumulative daily/monthly ledger/lock removal while the `$0.15` per-request, 24k/4k token, 90s, zero-retry, two-job, 500-identity, 50-chat, local-only, no-tools and `store:false` boundaries remain. Automated live/paid calls and cost are zero. Original and prior correction seals/evidence remain intact.
- Phase 4: PASS/accepted. Immutable `output/spec-0012/phase-4/proof-manifest.json` SHA-256 `08ff725e2d9bc658e198462e171623b1290d7b7de0b82bb3da93d085e4cfd095`, validation receipt SHA-256 `3107a15f9193719fe3ef1b8461f1003187ae75157f2786956baca4096a528060`, source digest `073bc363b1ba26e6be035df69136f7288687df028ed92ec9701ab649c17517fd`; 27 source and 104 evidence bindings. Proof passes 47 deterministic-oracle, 23 Phase 4 browser, 27 corrupt-row, 20 fault, 90 inherited Assistant browser, 60 presentation, 21 protected-browser, 10 restart, 33 repeated-browser and 11 Animator-smoke assertions plus 13 protected oracles, TypeScript, focused lint/build and exact diff. It proves local-catalog precedence; real hosted-tool event mapping; the accepted inherited 1s bright/1s dark/1.75s pause cycle and reduced motion; source/citation binding; injection/malicious URL/social-video truth; two-tool/eight-processed/six-displayed/512-character/45-second limits; no scraping/download or mutation; and byte-preserving corrupt-row recovery/capacity behavior. Final authorized live search: one `gpt-5.6-terra` Medium request, one tool call, eight processed/three displayed sources, `$0.050754`, citations/reload/project-sentinel PASS. Provider cost of two earlier authorized failed searches is unknown. Full build retains only the inherited byte-identical dev AI-cost route failure. Physical devices/non-Chromium remain unproven. The strict executor validator is a pre-propagation seal bound to the old spec bytes/exact 27-path dirty set; after canonical edits, CPA validation checks every immutable technical/evidence/freeze/prior-seal hash and the exact 42-path publication-ready state without rewriting the seal.
- Phase 4 terminal correction: PASS/accepted under D-0127 and published/activated/preserved/cleaned under D-0128/GIT-093 product commit `99128d70f4320dcfc757d81c7bc146baf3467f86`. Immutable `output/spec-0012/phase-4-final-correction/proof-manifest.json` SHA-256 `a078d42e1b1ac131787c1f8b48aeb333c2263b119b3e2b2b9172a8b213908137`, source digest `6593a497cc93dd57fbde384071bdb6f84d8e555b4d7e8c0dec8bcd05f73712ce`; 14 source/five evidence bindings. It passes 57 deterministic, 23 finalization, 23 browser and four protected-regression groups, TypeScript, focused lint and diff checks. Live fixed-Terra proof used two requests/no retries: local guidance 8.611 seconds; current YouTube search 18.850 seconds, one tool, eight processed/two displayed official sources, 2.949-second Finalizing. It proves the 55/30-second whole-job/search bounds, terminal-slot reservation, lifecycle dedupe, removal of the temporary source-overflow failure, clean prose/Sources separation, reasoning selection, citation reload persistence, zero browser errors and unchanged project sentinel. Nine proof files/551,351 bytes are preserved at aggregate SHA-256 `b0b34be5cad8d1af0639c2a6f166fa8b33d478ad978251e21645a2c283f3cef2`. The live search is below the hard limit but above the preferred typical 10–15 seconds; physical devices/non-Chromium remain unproven.
- Phase 5: PASS/published under D-0131/GIT-095. Immutable `output/spec-0012/phase-5/proof-manifest.json` SHA-256 `3e37e42b2a402bbb50a9f6bc33fd6cc537f527791aee85664d0e23bd24a666ed`, source digest `e56ec8b7ff7eee3c0998d8f65b1ac95f9fa8f74160366d857f4e5bc6235e51d0`; 16 exact sources/355 evidence bindings; 33 deterministic, 71 Chrome, four route and five protected-regression groups pass.
- Phase 6: PASS/published under D-0133/D-0134/GIT-096 `20612c364686b5b855e85f0b12c28a61e84b1061`. Immutable manifest SHA-256 `a0e3eea7e973eb183ff274cfd9ff868d3e4b7712e60e431c9db1c67057702229`; exact GIT-095 base, 20 source/80 evidence bindings and twelve negative mutation classes validate. Real Chrome proves offline search and local-guidance submission, zero request/fake answer, explicit retry after reconnection, one-question/one-answer reload persistence and search-interruption recovery. Ninety inherited stress and ten restart assertions pass; 50 sessions/6,000 messages load in 700 ms and Jump to latest in 50 ms. Twenty-one protected-product and 11 AI Animator assertions, 14 inherited oracles, five Axe layouts with zero serious/critical findings, security/limits, TypeScript, focused lint/build/diff and exact manifest checks pass. Automated real/provider/paid calls are zero. Eighty-two files/4,888 KiB are preserved. Full build/full lint retain only inherited untouched failures. Physical devices, non-Chromium, public-beta controls and production readiness are unproven.
...
The oracle passed 35 assertions covering native plus all five supported legacy kinds, truthful states, deterministic poster/player data and maximum snapshot concurrency four. Real Chromium passed 60 assertions across eight operations/eight screenshots at 1440×900, 390×844 reduced motion, 320×568 and 720×450 200%-zoom equivalent. TypeScript, focused lint and production build passed. Full lint retains the inherited 5-error/81-warning baseline in untouched files. First usable list was 101.824875 ms; viewer first frame 126.470333 ms; seek acknowledgement/canvas update 2.672959/123.727459 ms; play acknowledgement 23.852834 ms; five-cycle settled heap delta 8,215,763 bytes; maximum long task 78 ms.

Official/recovery storage hashes were identical before/after the desktop library/viewer, Export shared-player and changed-source retry flows. Proof recorded zero external/provider/AI/paid requests, zero credit changes, zero official/recovery writes, zero page errors and zero console errors. Export Phase 1/2 oracles and recovery Phase 1/2/3 contracts passed. At Phase 1 closeout, the inherited SPEC-0009 browser replay still reached the frame-3 mismatch; the accepted Phase 2 evidence below resolves it as stale proof math rather than a product regression. Export Phase 3 reached its substantive checks and then stopped only at its historical exact-dirty-allowlist gate because the current Phase 1 paths are intentionally outside that older allowlist.

Phase 1 proves the real project library, truthful metadata/posters/failures, shared accepted evaluator/player factoring, Watch-versus-Edit routing, modal close/focus/scroll behavior and unchanged Export ownership. It does not prove physical-device/non-Chromium behavior or a fully hydrated 64-project collection. Fullscreen, synchronized audio and the complete accessibility/resource contract remain Phase 2; Search/Sort/Rename/Duplicate/Delete and cross-tab management remain Phase 3.

GIT-084 is exact 29-path commit `9a3c5733da8080e09ec93129285ec97a7aebc039`, parent `0169c09cc8dbede616fdf099b31925669ec35f6e`: 15 accepted technical paths plus 14 reviewed control-plane/tree paths. Canonical `main`, `origin/main` and live GitHub `main` synchronized at clean `0/0`. The complete 22-file/905,940-byte proof is preserved at `output/recovery/GIT-084-spec0011-phase1-9a3c573/phase-1`, with relative inventory SHA-256 `e2fc1d2fa98bcae461a59e9750a4eb104436bbbec5c7fb2e56a5fac4d9ba5d47`; `.env.local` and secrets are excluded. PID 13851/listener 13866 are stopped, port 57680 is closed, the obsolete `/3301/` worktree is absent/unregistered and the merged local publication branch is deleted.

Phase 2's immutable 29,132-byte manifest `output/spec-0011/phase-2/proof-manifest.json` has SHA-256 `ddf3b9acbbe5395d92bdeea0c09da9b8dbcfef3bae38c3e1593ee1220a79823d`. It binds exact base/HEAD/local-main/local-origin `e6f6b1d7887bbbfaed7a9b00b8b472c5b28fe834`, empty index, exactly 15 technical paths, 12 command receipts, 15 source artifacts and 15 evidence artifacts. Fresh unchanged-tree validation passed 22 assertions and rejected 16 mutation classes.

Real Chromium passed 146 assertions across 15 flows and seven screenshots: desktop, explicit fullscreen, compact reduced motion, narrow, 200%-zoom equivalent, forced high contrast and the Terra greeting. It proves one monotonic playback clock; saved-FPS frame selection; pause/resume/seek/overlap/trim; correct mid-clip audio offsets; completion and Replay to visible frame 1; hidden-page reconciliation; actual-state fullscreen/Escape; keyboard/frame-step/Home/End; focus order/trap/return; control reveal/hide; truthful audio/fullscreen failures; source invalidation; zero serious/critical Axe findings; and resource cleanup. Official/recovery hashes are identical before/after. Nine audio contexts were created and closed; 14 scheduled sources were started/stopped/disconnected; observed decode concurrency was one under the two ceiling.

The inherited SPEC-0009 mismatch is resolved without product change: old independent-axis expected X `0.8215350990452878` was stale, while uniform-contain expected X `0.7501221828399292` matches rendered `0.749406441925578` inside the unchanged `0.025` tolerance. The control strip is below the animation with no gradient and screenshots retain authored bottom-edge pixels. Viewer-open p95 is `111.473791 ms`; Play p95 `40.647 ms`; released-seek canvas p95 `30.32725 ms`; maximum long task `104 ms`; settled five-cycle heap delta about `134,943` bytes with transient maximum `134,739,602`.

The focused production build gate includes Home and `/api/ai-animator` and passes; deterministic GET 404 returns structured JSON. Deterministic POST/GET and non-JSON failure cases prove safe client handling and zero provider/paid calls. One separate authorized live Medium `gpt-5.6-terra` `hi` returned JSON `202/200`, a natural greeting, no animation mutation, 409 tokens and estimated cost `$0.001238`; it must not be repeated. The full repository build compiles and then reaches only the inherited untouched `app/dev/ai-costs/lifetime/page.tsx` `PageProps/searchParams` failure. Full lint remains the inherited five-error/81-warning baseline; focused checks pass. Physical-device/non-Chromium/native-audio/native-Finder and a fully hydrated 64-project run remain unproven. `.env.local` remains ignored/excluded and byte identity is not claimed.

Phase 2's accepted executor flags remain historical inside the immutable manifest: `humanAcceptance: "pending Arthur"`, `controlPlaneUpdated: false`, and `gitPublication: false`. D-0115 records later human acceptance/propagation and D-0116 records later publication without rewriting immutable evidence. GIT-086 is exact 29-path commit `faf2965cb51d47ebcd2b68c9378db8a39486915d`, parent `e6f6b1d7887bbbfaed7a9b00b8b472c5b28fe834`, message `Complete SPEC-0011 Phase 2 movie viewer`; canonical `main`, `origin/main` and live GitHub `main` synchronized. The 33-file/1,370,820-byte proof is preserved at `/Users/arthurcarlin/Projects/stick-animation-app/output/recovery/GIT-086-spec0011-phase2-faf2965/phase-2`; sibling inventory SHA-256 is `ee4861967a418098e0eae73be71a7108a0bf0f00ea704988a48c7bf4dbef03ac`, with empty source/destination checksum diff. PID 23010 is stopped, ports 57760/57730 are closed, and D-0054 cleanup removed only the obsolete review worktree/local branch. D-0117/GIT-087 require Phase 3 to bind its own immutable manifest to the exact synchronized activation SHA and exact authorized dirty-path allowlist. Its proof must cover both surfaces, all four sorts/search, native/legacy duplicate rules, exact Rename/Delete semantics, shared-asset/recovery/open-session protection, deterministic two-tab races, keyboard/context/dialog/focus/accessibility routes, performance ceilings, protected regressions and zero external/provider/AI/paid activity.

Phase 3's immutable 46,868-byte manifest `output/spec-0011/phase-3/proof-manifest.json` is PASS at SHA-256 `92ae122c227a36fd8a637b1922b1bca139224be4caf0e42d3a147f2a43147aaa`, source digest `05ee661120e7751658b9ea2e5269c7cc1cbc666645568af1db7b1ff1f08074d1`. It binds exact base/HEAD/local-main/local-origin `b57ff995df9bb351dacb9a6a79b8cbd23203e988`, empty index, exactly 14 technical paths and the executor's accepted receipts/artifacts. Fresh strict pre-propagation validation returned VALID with 18 assertions and 12 rejected mutation classes. The oracle passed 31 assertions. Real Chromium passed 47 assertions across nine flows and four screenshots, including both surfaces, local search/four sorts, native/legacy duplication, exact rename/delete safety, shared assets, recovery/open-session blocks, deterministic races, visible overflow, right-click, `Shift+F10`/Context Menu, arrow/Home/End/Escape, dialogs/focus, compact/reduced-motion/forced-colors/200%-zoom-equivalent and zero serious/critical Axe findings.

The compact 64-project shell completed in 215.432 ms; search p95 was 18.1 ms, sort p95 17.3 ms and menu p95 17.9 ms. TypeScript, focused lint, focused production build, Phase 1 oracle, Phase 2 player oracle and Phase 2 audio oracle pass. The full repository build still compiles and then stops only at the inherited untouched `app/dev/ai-costs/lifetime/page.tsx` `PageProps/searchParams` failure. Proof recorded zero external/provider/AI/paid requests. Physical devices and non-Chromium browsers remain unproven. Executor flags such as pending human acceptance/control-plane/publication remain immutable historical fields; D-0118 is the later canonical acceptance record. GIT-088 is exact 28-path commit `d0ec1b23d7e1d9ff13a0779c2758e33e858691f0`. Nineteen proof files/604,195 bytes are preserved under `output/recovery/GIT-088-spec0011-phase3-d0ec1b2/phase-3`, with checksum-inventory SHA-256 `196e1e7a5dd7af4b82eeff9630d535dd4ba3ae45b56f2bb3eec63bbb46fa4dac`. PID 32270 is stopped, port 57840 is closed, and D-0054 cleanup is complete.
...
Phase 2's immutable 8,685-byte manifest `output/spec-0010/phase-2/proof-manifest.json` is PASS/VALID at SHA-256 `444cf4695574a6d7653a628e4a3a2035db3305054d2a76905e73cd3fa0ccc2e2`, source digest `b11323e481074e18683bd838f48df0f664ca83365874716af9e39aeba898318d`. Fresh validation passed 19 assertions and rejected thirteen mutation classes. Bound proof passed 27 Phase 2 browser assertions across eight scenarios, 27 oracle assertions, 18 Phase 2 contract assertions, 17 inherited Phase 1 contract assertions and 29 inherited Phase 1 browser assertions, plus TypeScript, focused lint, production build, scope/diff/index gates and protected editor regressions. Deterministic proof made zero external/provider/AI/paid calls or credit changes. One separately authorized Terra greeting made exactly one POST and returned naturally with zero console errors; `.env.local` remained ignored and tracked Terra/Thinking source stayed unchanged. D-0107/GIT-082 close the exact 24-path publication; twelve proof files/127,498 bytes are preserved at relative checksum-inventory SHA-256 `b5717d6e803df1b2d96741128fd5428b6e6bbd95debc8494841afb375ef84ee7`.

Phase 3's rebound immutable 9,898-byte manifest `output/spec-0010/phase-3/proof-manifest.json` is PASS/VALID at SHA-256 `5dc275dc6d30da693ab14e861d7f12728038da0f6b3b1f30a66252880fdd23f5`, source digest `48ec146163f03d21015771597b1d31fd043f6aac35cf2c4f9c5abca37a548d60`. Fresh validation passed 21 assertions and rejected fourteen mutation classes. Bound proof passed 45 oracle assertions, 27 deterministic contract assertions and 55 real-Chromium assertions across nine startup/recovery/discard/fault/concurrency/compact scenarios, plus inherited Phase 1 browser and Phase 1/2 contract/oracle regressions, focused lint/build and exact scope. Startup measured 1,017.37 ms and 116,170,679 JS heap bytes. Deterministic proof recorded zero external/provider/AI/paid requests and zero official writes before explicit Save. The full repository build retains only the inherited out-of-scope `app/dev/ai-costs/lifetime/page.tsx` generated `PageProps` failure; the authorized Home/workspace production route passes with network denied. Arthur's real restart review passed recovery; the ignored environment was restored byte-identically and one separate Low Terra greeting used 388 tokens/estimated `$0.001196` without tracked AI/Thinking change. D-0109/GIT-083 close the exact 25-path publication; thirteen proof files/794,137 bytes are preserved at relative checksum-inventory SHA-256 `b1c42860225724bf29a4cc02aea45ad6315f73da66052d652a8c5b2a1ccd8ab5`.
...
D-0092 adds mandatory transaction proof for Phases 4–6: plan-only and discussion turns make no mutation; material ambiguity asks one focused question; destructive intent/target/registered-command rules remain closed; an explicit unambiguous create/edit turn binds the internal candidate and is sufficient authorization; no user-facing Preview, Apply, second confirmation or post-generation Cancel control appears; active work can still be cancelled before the final compare-and-swap; cancellation/commit races have one deterministic winner; failure, timeout, stale base, project switch and validation errors leave authored state/history unchanged; success creates exactly one global history entry, makes the result the visible current project and round-trips through exact Undo/Redo/Save/Open. Browser/source/accessibility tests must fail if the old approval gate remains reachable or if active-job cancellation disappears.
...
## Published SPEC-0009 Phase 1 proof

D-0096 accepts and technically verifies the exact 12-path Phase 1 result from unchanged base/HEAD `37cdb7203286c2ea333a3766ba2e81bc06830200`, empty index. Immutable 8,688-byte manifest `output/spec-0009/phase-1/proof-manifest.json` is PASS at SHA-256 `40af1b220958a5d99094a07c763194b4cb6e2338ee6e14f0b2674a671564c2fb`, aggregate source SHA-256 `982cd78ad9342bc59e44de45a6f7972c276e3d9255cc29a5ec772a0b4047e745`. Fresh pre-propagation validation returned VALID with 16 assertions and rejected mutations across status, base, dirty set, source, screenshot, oracle, correction-browser and check data.

The oracle passed 25 duration/owner/hold/tween/raster-transform/empty/stale-source assertions. The real-app correction proof passed 23 Save As, UI-authored raster/hold/keyframe, chooser/player, saved-FPS traversal and deterministic Terra-route assertions with zero external requests and zero console errors. TypeScript, focused lint and production build passed; focused lint retains three pre-existing `DrawingWorkspace.tsx` unused-variable warnings. After a server-only ignored mode-600 key was installed, one separate live Terra greeting returned `Hello — connection confirmed.` with zero console errors; no credential value enters proof or publication. GIT-076 publishes/integrates the result at `548063b9247708106c7c8c8a11978563d07d6597`; seven recovery files/159,644 bytes are preserved at aggregate SHA-256 `7137a1de4ad8a0be73c17b45699592a98ed876b4858e18df6a36cf8d4b509fbb`, and D-0054 cleanup is complete. Phase 1's manifest does not claim video encoding, Finder writing, destination presets, final export-background fidelity, physical-device/native-GPU behavior or Phase 2 completion.

## Published SPEC-0009 Phase 2 proof

D-0098 accepts and technically verifies the corrected exact 15-path result from unchanged base/HEAD `b45921262b57902ddbaea9519a03f7aa7289621c`, empty index. Immutable 11,229-byte manifest `output/spec-0009/phase-2/proof-manifest.json` is PASS/VALID at SHA-256 `4f141b18e4601ef1faca2cd4f2d325bd11cc3f06303dac09f2ac1f07d838c341`, source digest `354eaf6f0d924168a2e36b0e4ec5ed240e41e89a1b3dd577b9f85af9b9fdf733`. Fresh pre-propagation validation passed 20 assertions and rejected 13 mutations across status, base, dirty set, sources, spec/dependency/artifact/check/output/network/credit/Finder disclosures. The oracle passed 38 assertions; TypeScript and both diff checks passed.

Real local browser write/read/inspection passed at 1280×720 and 1920×1080, 12 FPS, one H.264 frame per tier, with non-zero validated files. Uniform centered rendering preserved the authored asymmetric shape within raster tolerance (`1.15385` authored; approximately `1.151–1.153` preview/decoded output) and rejected the old squeezed ratio. Contract/oracle proof covers persisted default-white project background, sharp tier sizing, saved cadence/duration, deterministic AAC when audio exists, truthful progress, cancellation, distinct failure, zero-byte partial cleanup and post-write validation. Home/navigation, Save As/Open, drawing, layer, onion and playback regressions passed.
...
## Published SPEC-0009 Phase 3 proof
...
Static proof passed 155 assertions for 40 runtime-used commands, all 11 destructive commands, sanctioned coordinator mappings and seven negative registry mutations. The browser proof passed 51 assertions with one injected coordinator-publication failure, 160 authored operations, 162/162 Undo/Redo, five warmed playback loops, 191 ms maximum long task, 139,535,920-byte settled heap, zero serious Axe findings, no compact overflow, zero external requests and zero browser errors. Phase 1 raster/coverage, Phase 2 Draw Rig, Phase 3 migration, the accepted Phase 4 browser receipt, SPEC-0006 migration/foundation/persistence and timeline/playback regressions passed.

The reproduced silent-loss failure is bound directly: after mutation but before successful publication, rollback now clears transient editing and repaints the exact last-good committed bitmap before releasing the pending authoring marker. Source TypeScript, focused lint and production Webpack compilation passed; generated type validation retains only the untouched inherited AI-cost route baseline. The earlier Phase 1 no-loss oracle's stale ten-command count, retired Phase 2 SVG harness and Phase 4 rerun harness render/GC heuristic remain explicit inherited baselines. Compact remains desktop Chromium emulation; physical-device/native-GPU behavior remains unproven. The complete proof is preserved under `output/recovery/GIT-066-phase-5-c193b8b/phase-5` at aggregate inventory SHA-256 `9ca574bfc4cca30466101b4fff997d6eed66276a358dd8ed63fe659fdfbb6c98`.

## Accepted SPEC-0007 Phase 4 Assets proof

D-0081 accepts and technically verifies the exact 11-path Phase 4 result from unchanged GIT-064 base `f16d36b454728b3e216ec738013366f0230ddbdb`; D-0082/GIT-065 publishes/integrates it at exact commit `0dc707ff249560f4f19b8359c6a44a383e8caf92` and records proof preservation/D-0054 cleanup. Immutable 5,851-byte manifest `output/spec-0007/phase-4/proof-manifest.json` is PASS at SHA-256 `36ad00d6bdbe9ebc2ab3640f2ab5a9987ab46780f910b5d470a9142f32f19c4c`, source digest `509dbde25762fdb358d0625d9bf151c95b00e5d260bc984ae3a4b9d432439421`.
...
Proof passed the production build, full no-emit TypeScript, 23 static retirement/isolation assertions, 21 real-browser Open/migrate/edit/Undo/Save/recovery/reopen assertions with 3,457 migrated pixels, 19,844 Phase 1 raster assertions, the inherited no-loss oracle, Phase 2 corridor/style proof with protected command sources byte-unchanged, and 1,117 inherited six-source persistence assertions across Drawing V1/V2, Stick V1/V2 and unified V1/V2. Independent manifest replay passed 11 assertions. The browser proof reports zero page/browser errors and no external/provider request.

The representative fixture proves active rig/Creator controls absent, historical rig pixels mounted as ordinary drawing, Eraser mutation and exact Undo digest restoration, old source unchanged on Open, first Save preserving exact revision 1 and creating drawing-only revision 2, rig-only symbol conversion to Drawing Symbol, versioned receipt/recovery identity, and exact migrated pixel digest after Save/Open. Static checks prove no active new-save/hydration/UI reachability for structured rig authoring. Historical parser/validator helpers remain only behind the migration boundary; physical-device/native-GPU behavior and exhaustive owner-supplied historical-project visuals beyond the representative fixture remain unproven.

## Accepted SPEC-0007 Phase 2 Draw Rig proof

D-0077 accepts and technically verifies the exact ten-path Phase 2 result from unchanged GIT-062 base `88721481a345d6dda3f17b5620111a9cda2ab799`; D-0078 records GIT-063 publication/integration and D-0054 cleanup at exact commit `fb10e6239fd4b1edf319b3137a883e1219645ef3`. Immutable manifest `output/spec-0007/phase-2/proof-manifest.json` is PASS at SHA-256 `21db2d920831240be7eeb18fb2ca37126197d762f7ff9a432a3912a0da5809bd`, source digest `f8d80225c16449afb0a20c6eff88197ec2d2bdf27349e3240211725ee459e8dc`.

The causal append-only corridor proof passed 801 assertions, including stronger wobble, biased start, fast/slow one-corner elbows, the accepted short-arc one-elbow correction, retained intentional nook, cadence-equivalent polygonal circle, O(n) 100,000-point work and bounded live state. Real-browser proof passed 195 assertions, ten evidence captures, all five freehand variants at four opacity levels, Draw Rig Off equivalence, immutable settled history, preview/release identity, Undo/Redo, Save/Open/Export, frame/layer/onion/playback transitions and 32 draw/undo cycles. Independent manifest validation passed 37 assertions. `DrawingCanvas.tsx` and `rasterGesture.ts` retain their accepted Phase 2 integration hashes through the final strength correction; only `drawRigCorridor.ts` runtime behavior changed from the backed-up preceding review version.

Production Webpack compilation reaches only the untouched inherited route-typing failure in `app/dev/ai-costs/lifetime/page.tsx`; repository lint retains only the exact five-error untouched baseline while focused Phase 2 lint and TypeScript pass. Compact remains desktop Chromium emulation; physical-device/stylus/native-GPU behavior is unproven.

## Published drawing-only SPEC-0007 Phase 1 proof

[`SPEC-0007`](specs/0007-manual-editor-completion-and-ai-ready-tools.md) is fully Verified/published/integrated/recorded/cleaned up through D-0083/D-0084/GIT-066. The Phase 1 immutable technical manifest is PASS/VALID at SHA-256 `511c778e83741b7dde420863769f68132146934f072c6203289bcbf0ea05d689`; independent validation is PASS at SHA-256 `61514dcb59275292b8f2d9e3b345552b3c8de5128290dde6ff9627b30dba7186` and rejects 99 deliberate mutations.
...
The accepted proof passed 126,771 oracle assertions and 18 production-browser groups containing 508 cases/6,746 assertions, with 26 fresh inspected screenshots. It covers the destructive-command matrix, no-loss, maximum coverage, smoothing/texture/Glow, stable preview/final identity, Sketch ownership-aware Knife movement, canonical onion tint, history, persistence, performance and protected regressions. Full lint remains the inherited five-error/131-warning baseline with zero changed/new Phase 1 findings; physical-device/native-GPU behavior and extreme projects beyond the fixtures remain unproven.
...
Phase 5 provides the machine-readable and human-readable matrix proving that every enabled manual project/document mutation resolves to one runtime-used validated command capability, every destructive command is explicitly classified with exact target/reference/confirmation semantics, and enabled controls enter the sanctioned coordinator/history owner. D-0083 accepts it and D-0084/GIT-066 records publication/cleanup. The `/3cd3/` predecessor remains rejected/unpublished/non-reusable and must not be counted.
...
The complete 24-command ledger passed. Phase 7 authority passed 30 assertions across nine ordinary flows and 12 regressions. Real-browser proof passed 1440×900 DPR1 and 390×844 DPR2 with only canonical V2 writes, no second coordinator mount, keyboard Creator round trip, 200% zoom, reduced motion, zero Axe critical/serious findings, and zero external/real API requests, page errors or console errors. TypeScript and scoped production build passed; focused lint reported zero errors/eight inherited warnings; full lint retained five errors/72 warnings with zero changed-line findings. Strict manifest validation passed 95 assertions and 12 mutation cases.

Phase 6 production browser evidence remains bound and PASS: 19 operations, two distinct 60,268,104-byte rasters, desktop open/reopen/save at 735.8/758.3/1507.5 ms, settled desktop heap 312,397,923 bytes, compact settled heap 11,204,437 bytes, 240 selection-settle samples and zero long tasks. Historical manifest revalidation is `PASS_WITH_RECORDED_GAPS`: preserved Phase 3/5/6 manifests fully revalidated; Phase 1/2/4A/4 manifest files are absent, so only their recorded identities and publication commits are reported. Compact is desktop Chromium emulation, not physical-phone proof; native/GPU memory remains unproven.

The strict Phase 7 validator was run before CPA record edits because it requires the exact 11-path executor dirty set. After propagation, CPA verified the immutable manifest SHA/size and all 11 source plus 16 evidence bindings directly, then proved the exact 25-path publication set and empty index. Required proof is preserved under `/Users/arthurcarlin/.codex/worktrees/2d14/stick-animation-app/output/recovery/GIT-061-phase-7-185f587`; PID 34120 is stopped and port 56770 is closed. Do not regenerate or rewrite the manifest/finalization merely to change `humanAcceptance: pending Arthur` or `controlPlaneUpdated: false`; D-0069/D-0070 are the canonical later lifecycle record.

## Historical current SPEC-0006 Phase 6 published evidence

Phase 6 is Arthur-accepted, Verified, published and integrated in GIT-060 `cbe16411a0f83d3b86136f41d0a66d1874d009aa`. Its immutable manifest is `output/spec-0006/phase-6/proof-manifest.json`, 43,794 bytes at SHA-256 `5883ea735bd741b2f14e45d2fa84669ea3bb78ad5ed23693011e0280e4070902`, PASS/VALID with 18 source and 13 evidence bindings. The deterministic persistence suite passed 1,117 assertions, 1,000 repeated cases, 48 history operations, all six source kinds and 16 fault families; the production browser result passed ten adoption flows plus native Save/Save As/reopen and remains bound into Phase 7 evidence.

## Historical current SPEC-0006 Phase 5 published evidence
...
D-0054 requires one active review app copy per milestone, never counting the active PM worktree as that copy. Preserve required proof before accepted-copy removal after publication; after rejection and choosing the replacement path, verify recovery backups of unique dirty bytes and remove the exact obsolete server/worktree/local branch before the next fresh executor. Follow AGENTS' ownership and exact-target checks, protect canonical main and the active PM worktree, and record cleanup/backup identity. No rejected-byte reuse or weakening of browser/human-review gates is allowed.
...
## Published SPEC-0006 Phase 2 proof
...
Quality evidence must use human-authored accepted examples, expected-unsupported cases, and adversarial mutations whose hashes are bound before the engine runs. The implementation under test may not generate both the result and its sole oracle; self-generated coordinates, digests, scores, and snapshots are secondary only. Each unsafe mutation must fail for its named reason and each independently safe case must survive to its supported owner boundary: one false accept or false reject fails the phase. Hard/schema/meaning/editability expected accept/reject checks pass `100%`. Each supported visible sample scores at least `85/100`, the supported-set mean is at least `90/100`, and Arthur must watch at least two uninterrupted ordinary-app loops, scrub named landmarks, and accept every required sample; automation cannot award professional quality.
...
### Accepted SPEC-0005 Phase 1 proof

D-0044 accepts the exact six-path Phase 1 proof-only result from activation/base `2b4f00e7a122c196b2c0600144cd638b461bbb2f`. GIT-039 published it with reviewed records in exact 20-path commit `2436a9414221e8ee7ef40151284cb8f4e069e828`. The accepted manifest is `output/spec-0005/phase-1/proof-manifest.json`, exactly 10,011 bytes at SHA-256 `af287680b7ae73fd4c543edf8076d9fbb7fb65474a5d4508f8b17dde56174e84`. Its preserved successful independent receipt records 102 validation checks, and the six accepted source hashes are immutable.

The required clean committed permanent tester also passed after publication: 40 operations, 13 screenshots, four driver messages, three negative cases, zero non-loopback attempts, zero real API-route requests, zero policy violations, zero production leaks, zero console errors, and cleanup. Its 84,506-byte result has SHA-256 `bc7d5c978926b1b55babc8aee92827a4baef94adbca9570741b5dcc0e88f881d`. GIT-043 published the distinct exact eight-path Phase 2 correction plus 13 records at `e52454354c39b962ac2710a8602a5306ffd62ad5`; its required clean tester result SHA-256 is `c2887be734fe073191aa7d81fc9ffcf2cd6009da0bd188b67ddd9ad77aaebb63` and revalidated this Phase 1 gate unchanged.

The quality validator binds the three published SPEC-0001 reference files plus the current transport sources, checks ready/inward/outward landmarks independently, protects nine unrelated body roles and all ten limb segments, and rejects all 13 required mutations. Real browser proof observed complete `0..11..0` cycles after one Play and before Pause at both `1440×900` and `390×844`, in 1,262.4 ms and 1,085.0 ms. It records 26 timestamped geometry samples, six landmark checks, 260 limb-length checks, four ordinary/time-based captures, zero external/API/provider requests, and zero actionable console/page errors. TypeScript, scoped lint, exact Git/diff/scope, the 11-case proof-manifest mutation contract, and the clean permanent tester passed; the latter recorded 40 operations and 13 screenshots with zero real API/non-loopback/provider traffic.

The live review server log is append-only. The manifest binds its first 294 bytes at SHA-256 `637d481e2da0de2923489e85b4c8cd35db6456360d20e86c275a9aeb67a392ae`; later successful Arthur/CPA loopback GETs appended 200 bytes, and normal process termination appended a seven-byte terminal-reset sequence, leaving 501 bytes total. CPA closeout revalidated that exact bound prefix, all other 12 artifact hashes/sizes, all six complete source bindings, and the preserved 102-check receipt before stopping PID/PGID `90076`, confirming port `58451` closed, and removing only the exact disposable copy. Re-running the unchanged validator after review traffic/cleanup is not expected to pass its exact live-log/liveness checks; durable closeout uses the preserved successful receipt plus this complete prefix/offline binding validation. No source/proof byte was corrected, and Phase 1 makes no runtime-motion claim.

### Rejected former SPEC-0005 Phase 2 evidence boundary

GIT-040 published only the former authorization record. Its later executor was technically green, but Arthur rejected the visible motion. None of its runtime, fixture, test, or proof bytes was accepted, propagated, committed, published, or integrated, and its disposable app/worktree was removed. The rejected result had no authoritative safe-frame definition, chose a fixed IK sign instead of enumerating valid branches, did not require recovery convergence toward rest, underconstrained unsolicited W-arms, omitted a final safety gate after interpolation/rounding/contact, and used an oracle that could pass unsafe branches, near-locks, unwanted movement, overshoot, unsafe in-betweens, and loop snaps. Automation did not and cannot replace Arthur's visible motion judgment. Do not rerun, correct, or reuse that result.

### Published SPEC-0005 Phase 2 v1 safety proof and required v2 correction

Published Phase 2 v1 implements only the planner-independent `humanoid-11-v1` Body Safety Gate/Foundation and its non-bypassable motion-engine/executor seam. Its public safety sequence has exactly two callable operations: checked immutable important-pose selection with no final frames/document, then final completion with original request/selection plus rounded/post-repair frames/document. The finalizer recomputes binding and selection and revalidates every frame/whole sequence; exactly one motion-engine final candidate door may expose Preview. Existing SPEC-0004 `phase-1-holds`, `phase-2-baked-motion`, and `phase-2.5-timed-motion` materializers remain frozen compatibility paths and may not become planner doors.

Its independent oracle may not import `stickFigureBodySafety.ts`, `stickFigureMotionEngine.ts`, or `stickFigureCommandExecutor.ts`. With fixed recorded seeds, it must generate at least 10,000 valid/invalid property cases plus at least 10,000 mirrored counterparts against the spec's exact coordinate, topology, bend, torso/head, crossing/clearance, support/contact, continuity, loop, unsolicited-motion, recovery, and balance rules. The integration proof must actually select checked poses, build test-local provisional in-betweens from those returned poses, and finalize/revalidate. The test-local builder is not Phase 3 or product motion. A stationary straight-knee exception is selection-qualified only from independently checked identical selected-pose/rest intervals and is rechecked across final frames. Source/AST checks reject direct Preview exposure, exported unchecked helpers, tampered/stale selection, unsafe rounded/repair frames, planner/action/fixture/trust/skip bypass, or legacy materializer reuse as a planner door.

Required explicit negative evidence includes impossible reach, zero-length and sub-two-pixel rounded segments, elbow and moving-knee near-locks, forbidden knee dead-corridor bends, bend-sign flips through tangent, head/torso inversion or over-rotation, hand-through-head/torso, unsupported or underground contact, foot slide/lift, unsafe inter-frame displacement/rotation, overshoot, loop snap, unsolicited W-arms or hip drop, nonconverging recovery, unbalanced grounded frames, invalid mirror asymmetry, tampered selection, stale binding, unsafe rounded frame, unsafe post-repair frame, selection-to-Preview, exported unchecked helper, and every legacy/trusted/skip/action/fixture bypass attempt. Safe left/right translation, role-swapped mirror, and grounded rise/lower cases are 2D placement evidence, not travel/jump proof. Phase 2's manifest records new-motion/full-playback human review as not applicable. The preserved 17,826-byte `ea7ab9c5…` manifest is historical non-acceptance evidence only; correction creates a new manifest without overwriting it. After technical gates pass, the correction manifest additionally binds exactly one ordinary root URL/port/process in `/7dfc/`. If the old process exited or corrected source requires restart, a later authorized executor may verify/stop it and then start one replacement in the same worktree; the two may never overlap and no second copy is allowed. Arthur's smoke result concerns only existing app behavior and is not safety evidence.

Inherited regression receipts come from the current live-tree focused validators: `validateStickMotionQualityBaseline.ts`, `validateStickFigureAiContracts.ts`, `validateStickFigureCommandTransaction.ts`, `validateStickFigureMotionEngine.ts`, `validateStickFigureActionTiming.ts`, `validateStickFigureAiUiAdapter.ts`, `validateStickHistoryPersistence.ts`, and `validateStickPoseTimeline.ts`. They protect SPEC-0005 Phase 1, SPEC-0004 Phases 1/2/2.5, Preview/Cancel/failure no-op, one atomic Apply, manual editability, Undo/Redo, Save/Open, onion, Creator, one-shot/no-post-Apply behavior, and zero provider/API/external traffic. Historical phase manifests/receipts retain their published hashes as immutable audit records; their activation-HEAD, former exact dirty-set, and removed live-process checks are not rerun or claimed current. The permanent tester runs in a tester-owned isolated temporary clean clone of the exact D-0047 correction-publication base and is cleaned up after protecting unrelated app behavior. Corrected Phase 2 safety/integration validators cover the dirty `/7dfc/` runtime because no normal route invokes it. Only after both technical categories pass may the separate single ordinary `/7dfc/` root exist for Arthur's smoke-only review.

The accepted D-0047 Phase 2 v1 manifest is `output/spec-0005/phase-2/d0047-correction/proof-manifest.json`, 17,520 bytes at SHA-256 `e8a3fbbbb1a1cdf63e5d3648422def4736a4a1bf212ecc27335d2aa842db7874`; independent validation passed 168 checks. Runtime integration passed 20,305 assertions, 81 named negatives, and 10,000 generated cases plus 10,000 mirrors. The separate oracle imports no runtime safety/engine/executor modules and passed its own 10,000 cases plus 10,000 mirrors and 68 negatives. TypeScript, scoped lint, full-lint non-regression (5 errors/72 warnings with zero changed-path findings), inherited validators, diff/scope checks, and the isolated permanent tester passed. This remains accepted evidence for the finite v1 contract, not proof of body-local anatomical direction or natural pose quality.

D-0050's first Phase 2 v2 plan is published in GIT-045 at `a4589664…`; GIT-046 published D-0051 at `55b05e2daad649ac1e0027722a75762a9714d281`; GIT-047 published D-0052 at `5d0299a00459d39d6c4bff5eeb345f72c5abde4e`; D-0053's accepted v2 result is Verified, published, and integrated through GIT-048 at `05faa59195c6d5f2d8a11ebcc9ab77fe1b6fdf14`. Its independent human-authored oracle must cover every per-landmark front/left/right facing, plane/guide/band, valid mirror and through-front turn, constant and future-changing foot/hand/pelvis contacts, grounded/airborne classification, neutral/non-neutral base completion, single/multiple active roles, final rounded context, forbidden extras, and paired false-accept/false-reject mutations. Explicit injury, deformation, or unusual-motion wording never bypasses anatomy. D-0052 §3.2.1 additionally requires independent front symmetric compression, asymmetric support, flexed non-neutral base/return, permitted near-extension, torso tilt/translation, both anatomical legs/IK branches and mirrors, guide-degeneracy/clearance/singularity boundaries, wrong-side and final-rounding/post-repair mutations. Safe front cases must survive anatomy qualification, not be blanket-rejected or falsely sent to a later owner. These are the Phase 2 runtime gates now covered by the accepted v2 fixture/oracle/integration proof below; D-0052's earlier analytical leg checks remain historical design evidence, not visible naturalness acceptance. It retains the v1 fixed-seed 10,000 cases plus 10,000 mirrors and adds a separate v2 10,000 plus 10,000 mirror corpus across those contexts. Hard failures stop before Preview; safe later-owner cases reach `unsupported_owner_phase` rather than a false anatomy rejection. The implementation ceiling remains exactly eight tracked paths plus ignored `output/spec-0005/phase-2-natural-safety-correction/**`; prior proof and rejected worktrees stay read-only.
