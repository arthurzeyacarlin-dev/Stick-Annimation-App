...
Status: D-0112 accepts and technically verifies Phase 1 after Arthur's visible PASS. Control-plane propagation is complete; publication/integration, proof preservation, server shutdown and cleanup remain pending. Phases 2–3 are Unauthorized/Not started.
