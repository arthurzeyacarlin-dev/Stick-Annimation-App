...
## Accepted SPEC-0011 Phase 1–2 proof and remaining lifecycle

Status: D-0112/D-0113/GIT-084 fully close Phase 1. D-0115 accepts and technically verifies Phase 2 after Arthur's visible PASS; control-plane propagation is complete and GIT-086 publication/integration, proof preservation and D-0054 cleanup remain pending. Phase 3 is Unauthorized/Not started.
...
Phase 2's accepted executor flags remain historical inside the immutable manifest: `humanAcceptance: "pending Arthur"`, `controlPlaneUpdated: false`, and `gitPublication: false`. D-0115 records later human acceptance and propagation without rewriting evidence. The accepted bytes remain unstaged/uncommitted/unpublished pending GIT-086. Phase 3 must bind its own later immutable manifest only after separate authorization and complete Phase 2 closeout.
