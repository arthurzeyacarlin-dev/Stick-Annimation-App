...
## SPEC-0012 proof contract — Phase 4 terminal correction accepted through D-0127; GIT-093 pending

Status: GIT-089 published D-0120 planning; D-0121–D-0123/GIT-090 fully close Phase 1. D-0124/GIT-091 close combined Phase 2/absorbed Phase 3. D-0125/D-0126/GIT-092 close Phase 4 hosted search plus corrupt-row correction. D-0127 accepts the final 14-path terminal/source correction; GIT-093 publication/integration is explicitly authorized and pending. Phase 5 remains Unauthorized/Not started; transcription, public exposure and deployment remain unauthorized.
...
- Phase 4 terminal correction: PASS/accepted under D-0127. Immutable `output/spec-0012/phase-4-final-correction/proof-manifest.json` SHA-256 `a078d42e1b1ac131787c1f8b48aeb333c2263b119b3e2b2b9172a8b213908137`, source digest `6593a497cc93dd57fbde384071bdb6f84d8e555b4d7e8c0dec8bcd05f73712ce`; 14 source/five evidence bindings. It passes 57 deterministic, 23 finalization, 23 browser and four protected-regression groups, TypeScript, focused lint and diff checks. Live fixed-Terra proof used two requests/no retries: local guidance 8.611 seconds; current YouTube search 18.850 seconds, one tool, eight processed/two displayed official sources, 2.949-second Finalizing. It proves the 55/30-second whole-job/search bounds, terminal-slot reservation, lifecycle dedupe, removal of the temporary source-overflow failure, clean prose/Sources separation, reasoning selection, citation reload persistence, zero browser errors and unchanged project sentinel. The live search is below the hard limit but above the preferred typical 10–15 seconds; physical devices/non-Chromium remain unproven.
