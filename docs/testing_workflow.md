...
D-0044 accepts the exact six-path Phase 1 proof-only result from activation/base `2b4f00e7a122c196b2c0600144cd638b461bbb2f`. The accepted manifest is `output/spec-0005/phase-1/proof-manifest.json`, exactly 10,011 bytes at SHA-256 `af287680b7ae73fd4c543edf8076d9fbb7fb65474a5d4508f8b17dde56174e84`. Its preserved successful independent receipt records 102 validation checks, and the six accepted source hashes are immutable through CPA propagation.
